  ...
  group('TrackCacheBloc', () {
    ...
    group('CacheTrackRequested', () {
      ...
      blocTest<TrackCacheBloc, TrackCacheState>(
        ...
        act: (bloc) => bloc.add(const CacheTrackRequested(
          trackId: trackId,
          audioUrl: audioUrl,
          policy: policy,
        )),
    ...
    group('CacheTrackWithReferenceRequested', () {
      ...
      blocTest<TrackCacheBloc, TrackCacheState>(
        ...
        build: () {
          when(mockCacheTrackUseCase.cacheWithReference(
            trackId: trackId,
            audioUrl: audioUrl,
        ...
        act: (bloc) => bloc.add(const CacheTrackWithReferenceRequested(
          trackId: trackId,
          audioUrl: audioUrl,
          referenceId: referenceId,
          policy: policy,
        ...
        verify: (_) {
          verify(mockCacheTrackUseCase.cacheWithReference(
            trackId: trackId,
            audioUrl: audioUrl,
            referenceId: referenceId,
            policy: policy,
    ...
    group('RemoveTrackCacheRequested', () {
      ...
      blocTest<TrackCacheBloc, TrackCacheState>(
        ...
        build: () {
          when(mockRemoveTrackCacheUseCase(
            trackId: trackId,
            referenceId: referenceId,
          )).thenAnswer((_) async => const Right(unit));
          return bloc;
        },
        act: (bloc) => bloc.add(const RemoveTrackCacheRequested(
          trackId: trackId,
          referenceId: referenceId,
        )),
        expect: () => [
        ...
        verify: (_) {
          verify(mockRemoveTrackCacheUseCase(
            trackId: trackId,
            referenceId: referenceId,
          )).called(1);
        },
    ...
    group('GetTrackCacheStatusRequested', () {
      ...
      blocTest<TrackCacheBloc, TrackCacheState>(
        ...
        build: () {
          when(mockGetTrackCacheStatusUseCase(
            trackId: trackId,
      ...
      blocTest<TrackCacheBloc, TrackCacheState>(
        ...
        act: (bloc) async {
          // Test not cached
          when(mockGetTrackCacheStatusUseCase(trackId: trackId))
    ...
    group('GetCachedTrackPathRequested', () {
      ...
      blocTest<TrackCacheBloc, TrackCacheState>(
        ...
        build: () {
          when(mockGetTrackCacheStatusUseCase.getCachedAudioPath(
            trackId: trackId,
        ...
        verify: (_) {
          verify(mockGetTrackCacheStatusUseCase.getCachedAudioPath(
            trackId: trackId,
          )).called(1);
        },
      );
    ...
    group('WatchTrackCacheStatusRequested', () {
      const trackId = 'track123';

      blocTest<TrackCacheBloc, TrackCacheState>(
        'should emit watching state and handle status stream',
        build: () {
          when(mockGetTrackCacheStatusUseCase.watchCacheStatus(trackId: trackId))
        ...
        act: (bloc) => bloc.add(const WatchTrackCacheStatusRequested(trackId)),
        expect: () => [
          const TrackCacheWatching(
            trackId: trackId,
            currentStatus: CacheStatus.notCached,
          ),
          const TrackCacheWatching(
            trackId: trackId,
            currentStatus: CacheStatus.notCached,
          ...
          const TrackCacheWatching(
            trackId: trackId,
            currentStatus: CacheStatus.downloading,
          ),
          const TrackCacheWatching(
            trackId: trackId,
            currentStatus: CacheStatus.cached,
          ),
        ],
        verify: (_) {
          verify(mockGetTrackCacheStatusUseCase.watchCacheStatus(
            trackId: trackId,
          )).called(1);
        },
      );
      ...
      blocTest<TrackCacheBloc, TrackCacheState>(
        ...
        expect: () => [
          ...
          const TrackCacheOperationFailure(
            trackId: trackId,
            error: 'Status watch error: Stream error',
          ),
        ],
      );
    ...
    group('StopWatchingTrackCacheStatus', () {
      blocTest<TrackCacheBloc, TrackCacheState>(
        'should stop watching and emit initial state',
        build: () => bloc,
        act: (bloc) => bloc.add(const StopWatchingTrackCacheStatus()),
        expect: () => [
    ...
    group('concurrent operations', () {
      blocTest<TrackCacheBloc, TrackCacheState>(
        ...
        build: () {
          when(mockGetTrackCacheStatusUseCase(trackId: 'track1'))
              .thenAnswer((_) async => const Right(CacheStatus.cached));
          when(mockGetTrackCacheStatusUseCase(trackId: 'track2'))
              .thenAnswer((_) async => const Right(CacheStatus.notCached));
          return bloc;
        },
        act: (bloc) async {
