...
@GenerateMocks([CacheTrackUseCase, GetTrackCacheStatusUseCase, RemoveTrackCacheUseCase])
void main() {
  group('TrackCacheBloc', () {
    ...
    group('CacheTrackRequested', () {
      blocTest<TrackCacheBloc, TrackCacheState>(
        ...
        build: () {
          when(mockCacheTrackUseCase.call(
    ...
    group('RemoveTrackCacheRequested', () {
      blocTest<TrackCacheBloc, TrackCacheState>(
        ...
        build: () {
          when(mockRemoveTrackCacheUseCase.call('test-track-id'))
              .thenAnswer((_) async => const Right(unit));
          return bloc;
        },
        act: (bloc) => bloc.add(const RemoveTrackCacheRequested(trackId: 'test-track-id')),
        expect: () => [
          const TrackCacheLoading(),
          isA<TrackCacheOperationSuccess>(),
        ],
    ...
    test('GetTrackCacheStatusRequested - TODO: implement with new architecture', () {
