class Dimensions {
  ...
  static const double chipMinWidth = 64.0;
  ...
  static const double screenMarginLarge = 32.0;
  ...
  static const double modalMinWidth = 320.0;
  static const double modalMaxHeight = 0.8; // 80% of screen height
  static const double modalPadding = 24.0;
  static const double modalPaddingSmall = 16.0;
  ...
  // Border radius (moved from app_borders.dart for convenience)
