...
import 'package:trackflow/core/app/startup_resource_manager.dart' as _i150;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i35.ProjectsRepository>(
      () => _i36.ProjectsRepositoryImpl(
    ...
    gh.factory<_i38.ResumeAudioUseCase>(
      () => _i38.ResumeAudioUseCase(
        playbackService: gh<_i3.AudioPlaybackService>(),
      ),
    );
    ...
    gh.factory<_i40.SeekAudioUseCase>(
      () => _i40.SeekAudioUseCase(
        playbackService: gh<_i3.AudioPlaybackService>(),
      ),
    );
    gh.factory<_i41.SetPlaybackSpeedUseCase>(
      () => _i41.SetPlaybackSpeedUseCase(
        playbackService: gh<_i3.AudioPlaybackService>(),
      ),
    );
    gh.factory<_i42.SetVolumeUseCase>(
      () => _i42.SetVolumeUseCase(
        playbackService: gh<_i3.AudioPlaybackService>(),
      ),
    );
    ...
    gh.factory<_i45.SkipToPreviousUseCase>(
      () => _i45.SkipToPreviousUseCase(
        playbackService: gh<_i3.AudioPlaybackService>(),
      ),
    );
    gh.factory<_i46.StopAudioUseCase>(
      () => _i46.StopAudioUseCase(
        playbackService: gh<_i3.AudioPlaybackService>(),
      ),
    );
    gh.factory<_i47.ToggleRepeatModeUseCase>(
      () => _i47.ToggleRepeatModeUseCase(
        playbackService: gh<_i3.AudioPlaybackService>(),
      ),
    );
    gh.factory<_i48.ToggleShuffleUseCase>(
      () => _i48.ToggleShuffleUseCase(
        playbackService: gh<_i3.AudioPlaybackService>(),
      ),
    );
    ...
    gh.lazySingleton<_i78.UpdateProjectUseCase>(
      () => _i78.UpdateProjectUseCase(
    ...
    gh.factory<_i112.GetCachedTrackPathUseCase>(
      () => _i112.GetCachedTrackPathUseCase(gh<_i95.AudioStorageRepository>()),
    );
    gh.factory<_i113.GetPlaylistCacheStatusUseCase>(
      () => _i113.GetPlaylistCacheStatusUseCase(
        gh<_i95.AudioStorageRepository>(),
      ),
    );
    gh.lazySingleton<_i114.GoogleSignInUseCase>(
      () => _i114.GoogleSignInUseCase(gh<_i97.AuthRepository>()),
    );
    gh.lazySingleton<_i115.JoinProjectWithIdUseCase>(
      () => _i115.JoinProjectWithIdUseCase(
        gh<_i35.ProjectsRepository>(),
        gh<_i105.CollaboratorRepository>(),
        gh<_i73.SessionStorage>(),
      ),
    );
    gh.lazySingleton<_i116.LeaveProjectUseCase>(
      () => _i116.LeaveProjectUseCase(
        gh<_i105.CollaboratorRepository>(),
        gh<_i73.SessionStorage>(),
      ),
    );
    gh.factory<_i117.LoadTrackContextUseCase>(
      () => _i117.LoadTrackContextUseCase(gh<_i91.AudioContextService>()),
    );
    gh.factory<_i118.MagicLinkBloc>(
      () => _i118.MagicLinkBloc(
        ...
        joinProjectWithId: gh<_i115.JoinProjectWithIdUseCase>(),
        authRepository: gh<_i97.AuthRepository>(),
      ),
    );
    gh.lazySingleton<_i119.OnboardingRepository>(
      () => _i120.OnboardingRepositoryImpl(
        gh<_i71.OnboardingStateLocalDataSource>(),
      ),
    );
    gh.lazySingleton<_i121.OnboardingUseCase>(
      () => _i121.OnboardingUseCase(
        gh<_i119.OnboardingRepository>(),
        gh<_i88.WelcomeScreenRepository>(),
      ),
    );
    gh.factory<_i122.PlayAudioUseCase>(
      () => _i122.PlayAudioUseCase(
        audioTrackRepository: gh<_i61.AudioTrackRepository>(),
        audioStorageRepository: gh<_i95.AudioStorageRepository>(),
        playbackService: gh<_i3.AudioPlaybackService>(),
      ),
    );
    gh.factory<_i123.PlayPlaylistUseCase>(
      () => _i123.PlayPlaylistUseCase(
    ...
    gh.factory<_i124.ProjectDetailBloc>(
      () => _i124.ProjectDetailBloc(
        watchProjectDetail: gh<_i84.WatchProjectDetailUseCase>(),
      ),
    );
    gh.lazySingleton<_i125.ProjectTrackService>(
      () => _i125.ProjectTrackService(
        gh<_i61.AudioTrackRepository>(),
        gh<_i95.AudioStorageRepository>(),
      ),
    );
    ...
    gh.factory<_i128.RemovePlaylistCacheUseCase>(
      () => _i128.RemovePlaylistCacheUseCase(gh<_i95.AudioStorageRepository>()),
    );
    gh.factory<_i129.RemoveTrackCacheUseCase>(
      () => _i129.RemoveTrackCacheUseCase(gh<_i95.AudioStorageRepository>()),
    );
    ...
    gh.lazySingleton<_i131.SignInUseCase>(
      () => _i131.SignInUseCase(gh<_i97.AuthRepository>()),
    );
    gh.lazySingleton<_i132.SignOutUseCase>(
      () => _i132.SignOutUseCase(gh<_i97.AuthRepository>()),
    );
    gh.lazySingleton<_i133.SignUpUseCase>(
      () => _i133.SignUpUseCase(gh<_i97.AuthRepository>()),
    );
    ...
    gh.lazySingleton<_i136.UploadAudioTrackUseCase>(
      () => _i136.UploadAudioTrackUseCase(
        gh<_i125.ProjectTrackService>(),
        gh<_i35.ProjectsRepository>(),
        gh<_i73.SessionStorage>(),
      ),
    );
    ...
    gh.factory<_i138.WatchTrackCacheStatusUseCase>(
      () =>
          _i138.WatchTrackCacheStatusUseCase(gh<_i95.AudioStorageRepository>()),
    );
    ...
    gh.factory<_i140.AudioCommentBloc>(
      () => _i140.AudioCommentBloc(
    ...
    gh.factory<_i141.AudioContextBloc>(
      () => _i141.AudioContextBloc(
        loadTrackContextUseCase: gh<_i117.LoadTrackContextUseCase>(),
      ),
    );
    gh.factory<_i142.AudioPlayerService>(
      () => _i142.AudioPlayerService(
        initializeAudioPlayerUseCase: gh<_i17.InitializeAudioPlayerUseCase>(),
        playAudioUseCase: gh<_i122.PlayAudioUseCase>(),
        playPlaylistUseCase: gh<_i123.PlayPlaylistUseCase>(),
    ...
    gh.factory<_i143.AudioSourceResolver>(
      () => _i144.AudioSourceResolverImpl(
        gh<_i95.AudioStorageRepository>(),
        gh<_i93.AudioDownloadRepository>(),
      ),
    );
    gh.factory<_i145.AudioWaveformBloc>(
      () => _i145.AudioWaveformBloc(
        audioPlaybackService: gh<_i3.AudioPlaybackService>(),
        getCachedTrackPathUseCase: gh<_i112.GetCachedTrackPathUseCase>(),
      ),
    );
    gh.factory<_i146.AuthBloc>(
      () => _i146.AuthBloc(
        ...
        googleSignIn: gh<_i114.GoogleSignInUseCase>(),
        getAuthState: gh<_i111.GetAuthStateUseCase>(),
        onboarding: gh<_i121.OnboardingUseCase>(),
      ),
    );
    gh.lazySingleton<_i147.DeleteAudioTrack>(
      () => _i147.DeleteAudioTrack(
        gh<_i73.SessionStorage>(),
        gh<_i35.ProjectsRepository>(),
        gh<_i125.ProjectTrackService>(),
      ),
    );
    gh.lazySingleton<_i148.EditAudioTrackUseCase>(
      () => _i148.EditAudioTrackUseCase(
        gh<_i125.ProjectTrackService>(),
        gh<_i35.ProjectsRepository>(),
      ),
    );
    gh.factory<_i149.PlaylistCacheBloc>(
      () => _i149.PlaylistCacheBloc(
    ...
    gh.lazySingleton<_i150.StartupResourceManager>(
      () => _i150.StartupResourceManager(
    ...
    gh.factory<_i151.TrackCacheBloc>(
      () => _i151.TrackCacheBloc(
        cacheTrackUseCase: gh<_i104.CacheTrackUseCase>(),
        watchTrackCacheStatusUseCase: gh<_i138.WatchTrackCacheStatusUseCase>(),
        removeTrackCacheUseCase: gh<_i129.RemoveTrackCacheUseCase>(),
        getCachedTrackPathUseCase: gh<_i112.GetCachedTrackPathUseCase>(),
      ),
    );
    gh.lazySingleton<_i152.AddCollaboratorAndSyncProfileService>(
      () => _i152.AddCollaboratorAndSyncProfileService(
        gh<_i139.AddCollaboratorToProjectUseCase>(),
        gh<_i80.UserProfileCacheRepository>(),
      ),
    );
    gh.factory<_i153.AudioPlayerBloc>(
      () => _i153.AudioPlayerBloc(
        audioPlayerService: gh<_i142.AudioPlayerService>(),
      ),
    );
    gh.factory<_i154.AudioTrackBloc>(
      () => _i154.AudioTrackBloc(
        watchAudioTracksByProject: gh<_i85.WatchTracksByProjectIdUseCase>(),
        deleteAudioTrack: gh<_i147.DeleteAudioTrack>(),
        uploadAudioTrackUseCase: gh<_i136.UploadAudioTrackUseCase>(),
        editAudioTrackUseCase: gh<_i148.EditAudioTrackUseCase>(),
      ),
    );
    gh.factory<_i155.ManageCollaboratorsBloc>(
      () => _i155.ManageCollaboratorsBloc(
        addCollaboratorAndSyncProfileService:
            gh<_i152.AddCollaboratorAndSyncProfileService>(),
        removeCollaboratorUseCase: gh<_i127.RemoveCollaboratorUseCase>(),
        updateCollaboratorRoleUseCase:
            gh<_i135.UpdateCollaboratorRoleUseCase>(),
        leaveProjectUseCase: gh<_i116.LeaveProjectUseCase>(),
