...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i25.PauseAudioUseCase>(() => _i25.PauseAudioUseCase(
        playbackService: gh<_i3.AudioPlaybackService>()));
    gh.factory<_i26.PlayPlaylistUseCase>(() => _i26.PlayPlaylistUseCase(
          audioContentRepository: gh<InvalidType>(),
          playbackService: gh<_i3.AudioPlaybackService>(),
        ));
    ...
    gh.lazySingleton<_i29.PlaylistLocalDataSource>(
        () => _i29.PlaylistLocalDataSourceImpl(gh<_i18.Isar>()));
    gh.lazySingleton<_i30.PlaylistRemoteDataSource>(
        () => _i30.PlaylistRemoteDataSourceImpl(gh<_i12.FirebaseFirestore>()));
    ...
    gh.lazySingleton<_i34.ProjectsLocalDataSource>(
        () => _i34.ProjectsLocalDataSourceImpl(gh<_i18.Isar>()));
    ...
    gh.lazySingleton<_i37.ResendMagicLinkUseCase>(
        () => _i37.ResendMagicLinkUseCase(gh<_i21.MagicLinkRepository>()));
    ...
    gh.lazySingleton<_i49.UserProfileLocalDataSource>(
        () => _i49.IsarUserProfileLocalDataSource(gh<_i18.Isar>()));
    ...
    gh.lazySingleton<_i54.WatchUserProfilesUseCase>(
        () => _i54.WatchUserProfilesUseCase(gh<_i51.UserProfileRepository>()));
    ...
    gh.lazySingleton<_i63.AuthLocalDataSource>(
        () => _i63.AuthLocalDataSourceImpl(gh<_i43.SharedPreferences>()));
    ...
    gh.lazySingleton<_i65.CacheStorageLocalDataSource>(
        () => _i65.CacheStorageLocalDataSourceImpl(gh<_i18.Isar>()));
    gh.lazySingleton<_i66.CacheStorageRemoteDataSource>(() =>
        _i66.CacheStorageRemoteDataSourceImpl(gh<_i13.FirebaseStorage>()));
    gh.lazySingleton<_i67.CacheStorageRepository>(
        () => _i68.CacheStorageRepositoryImpl(
              localDataSource: gh<_i65.CacheStorageLocalDataSource>(),
              remoteDataSource: gh<_i66.CacheStorageRemoteDataSource>(),
            ));
    gh.factory<_i69.CacheTrackUseCase>(
        () => _i69.CacheTrackUseCase(gh<_i67.CacheStorageRepository>()));
    gh.lazySingleton<_i70.ConsumeMagicLinkUseCase>(
        () => _i70.ConsumeMagicLinkUseCase(gh<_i21.MagicLinkRepository>()));
    gh.lazySingleton<_i71.GetMagicLinkStatusUseCase>(
        () => _i71.GetMagicLinkStatusUseCase(gh<_i21.MagicLinkRepository>()));
    gh.factory<_i72.GetPlaylistCacheStatusUseCase>(() =>
        _i72.GetPlaylistCacheStatusUseCase(gh<_i67.CacheStorageRepository>()));
    gh.lazySingleton<_i73.GetProjectByIdUseCase>(
        () => _i73.GetProjectByIdUseCase(gh<_i35.ProjectsRepository>()));
    gh.factory<_i74.GetTrackCacheStatusUseCase>(() =>
        _i74.GetTrackCacheStatusUseCase(gh<_i67.CacheStorageRepository>()));
    ...
    gh.lazySingleton<_i77.ManageCollaboratorsRepository>(
        () => _i78.ManageCollaboratorsRepositoryImpl(
              remoteDataSourceManageCollaborators:
                  gh<_i76.ManageCollaboratorsRemoteDataSource>(),
              localDataSourceManageCollaborators:
                  gh<_i75.ManageCollaboratorsLocalDataSource>(),
              networkInfo: gh<_i24.NetworkInfo>(),
            ));
    gh.factory<_i79.PlayAudioUseCase>(() => _i79.PlayAudioUseCase(
          audioTrackRepository: gh<_i61.AudioTrackRepository>(),
          cacheStorageRepository: gh<_i67.CacheStorageRepository>(),
          playbackService: gh<_i3.AudioPlaybackService>(),
        ));
    gh.lazySingleton<_i80.ProjectCommentService>(
        () => _i80.ProjectCommentService(gh<_i57.AudioCommentRepository>()));
    gh.lazySingleton<_i81.ProjectTrackService>(
        () => _i81.ProjectTrackService(gh<_i61.AudioTrackRepository>()));
    gh.factory<_i82.RemovePlaylistCacheUseCase>(() =>
        _i82.RemovePlaylistCacheUseCase(gh<_i67.CacheStorageRepository>()));
    gh.factory<_i83.RemoveTrackCacheUseCase>(
        () => _i83.RemoveTrackCacheUseCase(gh<_i67.CacheStorageRepository>()));
    ...
    gh.lazySingleton<_i85.SessionStorage>(
        () => _i85.SessionStorage(prefs: gh<_i43.SharedPreferences>()));
    ...
    gh.factory<_i91.TrackCacheBloc>(() => _i91.TrackCacheBloc(
          cacheTrackUseCase: gh<_i69.CacheTrackUseCase>(),
          getTrackCacheStatusUseCase: gh<_i74.GetTrackCacheStatusUseCase>(),
    ...
    gh.lazySingleton<_i92.UpdateCollaboratorRoleUseCase>(
        () => _i92.UpdateCollaboratorRoleUseCase(
              ...
              gh<_i77.ManageCollaboratorsRepository>(),
              gh<_i85.SessionStorage>(),
            ));
    ...
    gh.lazySingleton<_i99.WatchTracksByProjectIdUseCase>(() =>
        _i99.WatchTracksByProjectIdUseCase(gh<_i61.AudioTrackRepository>()));
    ...
    gh.factory<_i103.AudioPlayerBloc>(() => _i103.AudioPlayerBloc(
          ...
          playAudioUseCase: gh<_i79.PlayAudioUseCase>(),
          playPlaylistUseCase: gh<_i26.PlayPlaylistUseCase>(),
    ...
    gh.factory<_i108.CachePlaylistUseCase>(
        () => _i108.CachePlaylistUseCase(gh<_i67.CacheStorageRepository>()));
    ...
    gh.factory<_i121.PlaylistCacheBloc>(() => _i121.PlaylistCacheBloc(
          ...
          getPlaylistCacheStatusUseCase:
              gh<_i72.GetPlaylistCacheStatusUseCase>(),
