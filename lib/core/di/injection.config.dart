...
import 'package:trackflow/core/app/startup_resource_manager.dart' as _i152;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i105.CheckProfileCompletenessUseCase>(
        () => _i105.CheckProfileCompletenessUseCase(
              gh<_i51.UserProfileRepository>(),
              gh<_i73.SessionStorage>(),
            ));
    gh.lazySingleton<_i106.CollaboratorRepository>(
        () => _i107.CollaboratorRepositoryImpl(
              remoteDataSource: gh<_i70.ManageCollaboratorsRemoteDataSource>(),
              localDataSource: gh<_i69.ManageCollaboratorsLocalDataSource>(),
              networkInfo: gh<_i25.NetworkInfo>(),
            ));
    gh.lazySingleton<_i108.CreateProjectUseCase>(
        () => _i108.CreateProjectUseCase(
              gh<_i35.ProjectsRepository>(),
              gh<_i73.SessionStorage>(),
            ));
    gh.lazySingleton<_i109.DeleteAudioCommentUseCase>(
        () => _i109.DeleteAudioCommentUseCase(
              gh<_i72.ProjectCommentService>(),
              gh<_i35.ProjectsRepository>(),
              gh<_i73.SessionStorage>(),
            ));
    ...
    gh.lazySingleton<_i111.GenerateMagicLinkUseCase>(
        () => _i111.GenerateMagicLinkUseCase(
              gh<_i22.MagicLinkRepository>(),
              gh<_i97.AuthRepository>(),
            ));
    gh.lazySingleton<_i112.GetAuthStateUseCase>(
        () => _i112.GetAuthStateUseCase(gh<_i97.AuthRepository>()));
    gh.factory<_i113.GetCachedTrackPathUseCase>(() =>
        _i113.GetCachedTrackPathUseCase(gh<_i95.AudioStorageRepository>()));
    gh.factory<_i114.GetPlaylistCacheStatusUseCase>(() =>
        _i114.GetPlaylistCacheStatusUseCase(gh<_i95.AudioStorageRepository>()));
    gh.lazySingleton<_i115.GoogleSignInUseCase>(
        () => _i115.GoogleSignInUseCase(gh<_i97.AuthRepository>()));
    gh.lazySingleton<_i116.JoinProjectWithIdUseCase>(
        () => _i116.JoinProjectWithIdUseCase(
              gh<_i35.ProjectsRepository>(),
              gh<_i106.CollaboratorRepository>(),
              gh<_i73.SessionStorage>(),
            ));
    gh.lazySingleton<_i117.LeaveProjectUseCase>(() => _i117.LeaveProjectUseCase(
          gh<_i106.CollaboratorRepository>(),
          gh<_i73.SessionStorage>(),
        ));
    gh.factory<_i118.LoadTrackContextUseCase>(
        () => _i118.LoadTrackContextUseCase(gh<_i91.AudioContextService>()));
    gh.factory<_i119.MagicLinkBloc>(() => _i119.MagicLinkBloc(
          generateMagicLink: gh<_i111.GenerateMagicLinkUseCase>(),
          ...
          joinProjectWithId: gh<_i116.JoinProjectWithIdUseCase>(),
    ...
    gh.factory<_i124.PlayPlaylistUseCase>(() => _i124.PlayPlaylistUseCase(
    ...
    gh.lazySingleton<_i126.ProjectTrackService>(() => _i126.ProjectTrackService(
          gh<_i61.AudioTrackRepository>(),
          gh<_i95.AudioStorageRepository>(),
        ));
    ...
    gh.factory<_i129.RemovePlaylistCacheUseCase>(() =>
        _i129.RemovePlaylistCacheUseCase(gh<_i95.AudioStorageRepository>()));
    ...
    gh.lazySingleton<_i132.SignInUseCase>(
        () => _i132.SignInUseCase(gh<_i97.AuthRepository>()));
    gh.lazySingleton<_i133.SignOutUseCase>(
        () => _i133.SignOutUseCase(gh<_i97.AuthRepository>()));
    gh.lazySingleton<_i134.SignUpUseCase>(
        () => _i134.SignUpUseCase(gh<_i97.AuthRepository>()));
    ...
    gh.lazySingleton<_i137.UploadAudioTrackUseCase>(
        () => _i137.UploadAudioTrackUseCase(
              gh<_i126.ProjectTrackService>(),
              gh<_i35.ProjectsRepository>(),
              gh<_i73.SessionStorage>(),
            ));
    ...
    gh.factory<_i139.WatchTrackCacheStatusUseCase>(() =>
        _i139.WatchTrackCacheStatusUseCase(gh<_i95.AudioStorageRepository>()));
    gh.lazySingleton<_i140.AddCollaboratorToProjectUseCase>(
        () => _i140.AddCollaboratorToProjectUseCase(
              gh<_i35.ProjectsRepository>(),
              gh<_i106.CollaboratorRepository>(),
              gh<_i73.SessionStorage>(),
            ));
    gh.factory<_i141.AudioCommentBloc>(() => _i141.AudioCommentBloc(
    ...
    gh.factory<_i142.AudioContextBloc>(() => _i142.AudioContextBloc(
        loadTrackContextUseCase: gh<_i118.LoadTrackContextUseCase>()));
    gh.factory<_i143.AudioPlayerService>(() => _i143.AudioPlayerService(
          initializeAudioPlayerUseCase: gh<_i17.InitializeAudioPlayerUseCase>(),
          playAudioUseCase: gh<_i123.PlayAudioUseCase>(),
          playPlaylistUseCase: gh<_i124.PlayPlaylistUseCase>(),
    ...
    gh.factory<_i144.AudioSourceResolver>(() => _i145.AudioSourceResolverImpl(
          gh<_i95.AudioStorageRepository>(),
          gh<_i93.AudioDownloadRepository>(),
        ));
    gh.factory<_i146.AudioWaveformBloc>(() => _i146.AudioWaveformBloc(
          audioPlaybackService: gh<_i3.AudioPlaybackService>(),
          getCachedTrackPathUseCase: gh<_i113.GetCachedTrackPathUseCase>(),
        ));
    gh.factory<_i147.AuthBloc>(() => _i147.AuthBloc(
          ...
          googleSignIn: gh<_i115.GoogleSignInUseCase>(),
          getAuthState: gh<_i112.GetAuthStateUseCase>(),
    ...
    gh.lazySingleton<_i149.EditAudioTrackUseCase>(
        () => _i149.EditAudioTrackUseCase(
              gh<_i126.ProjectTrackService>(),
              gh<_i35.ProjectsRepository>(),
            ));
    gh.factory<_i150.ManageCollaboratorsBloc>(() =>
        _i150.ManageCollaboratorsBloc(
          addCollaboratorUseCase: gh<_i140.AddCollaboratorToProjectUseCase>(),
          removeCollaboratorUseCase: gh<_i128.RemoveCollaboratorUseCase>(),
          updateCollaboratorRoleUseCase:
              gh<_i136.UpdateCollaboratorRoleUseCase>(),
          leaveProjectUseCase: gh<_i117.LeaveProjectUseCase>(),
          watchUserProfilesUseCase: gh<_i87.WatchUserProfilesUseCase>(),
        ));
    gh.factory<_i151.PlaylistCacheBloc>(() => _i151.PlaylistCacheBloc(
    ...
    gh.lazySingleton<_i152.StartupResourceManager>(
        () => _i152.StartupResourceManager(
    ...
    gh.factory<_i153.TrackCacheBloc>(() => _i153.TrackCacheBloc(
    ...
    gh.factory<_i154.AudioPlayerBloc>(() => _i154.AudioPlayerBloc(
        audioPlayerService: gh<_i143.AudioPlayerService>()));
    gh.factory<_i155.AudioTrackBloc>(() => _i155.AudioTrackBloc(
          ...
          uploadAudioTrackUseCase: gh<_i137.UploadAudioTrackUseCase>(),
          editAudioTrackUseCase: gh<_i149.EditAudioTrackUseCase>(),
        ));
    return this;
  }
}
