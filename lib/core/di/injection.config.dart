...
import 'package:trackflow/core/app/services/audio_background_initializer.dart'
    as _i3;
import 'package:trackflow/core/app_flow/data/session_storage.dart' as _i95;
...
import 'package:trackflow/core/notifications/presentation/blocs/watcher/notification_watcher_bloc.dart'
    as _i132;
import 'package:trackflow/core/services/database_health_monitor.dart' as _i78;
...
import 'package:trackflow/core/services/performance_metrics_collector.dart'
    as _i40;
import 'package:trackflow/core/session/current_user_service.dart' as _i123;
  ...
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i68.WaveformRemoteDataSource>(() =>
        _i68.FirebaseStorageWaveformRemoteDataSource(
            gh<_i17.FirebaseStorage>()));
    gh.lazySingleton<_i69.AppleAuthService>(
        () => _i69.AppleAuthService(gh<_i15.FirebaseAuth>()));
    gh.lazySingleton<_i70.AudioCommentLocalDataSource>(
        () => _i70.IsarAudioCommentLocalDataSource(gh<_i23.Isar>()));
    gh.lazySingleton<_i71.AudioCommentRemoteDataSource>(() =>
        _i71.FirebaseAudioCommentRemoteDataSource(
            gh<_i16.FirebaseFirestore>()));
    gh.lazySingleton<_i72.AudioTrackLocalDataSource>(
        () => _i72.IsarAudioTrackLocalDataSource(gh<_i23.Isar>()));
    gh.lazySingleton<_i73.AudioTrackRemoteDataSource>(() =>
        _i73.AudioTrackRemoteDataSourceImpl(gh<_i16.FirebaseFirestore>()));
    gh.lazySingleton<_i74.CacheStorageLocalDataSource>(
        () => _i74.CacheStorageLocalDataSourceImpl(gh<_i23.Isar>()));
    gh.lazySingleton<_i75.CacheStorageRemoteDataSource>(() =>
        _i75.CacheStorageRemoteDataSourceImpl(gh<_i17.FirebaseStorage>()));
    gh.lazySingleton<_i76.ConsumeMagicLinkUseCase>(
        () => _i76.ConsumeMagicLinkUseCase(gh<_i26.MagicLinkRepository>()));
    gh.factory<_i77.CreateNotificationUseCase>(() =>
        _i77.CreateNotificationUseCase(gh<_i32.NotificationRepository>()));
    gh.factory<_i78.DatabaseHealthMonitor>(
        () => _i78.DatabaseHealthMonitor(gh<_i23.Isar>()));
    gh.factory<_i79.DeleteNotificationUseCase>(() =>
        _i79.DeleteNotificationUseCase(gh<_i32.NotificationRepository>()));
    gh.lazySingleton<_i80.GetMagicLinkStatusUseCase>(
        () => _i80.GetMagicLinkStatusUseCase(gh<_i26.MagicLinkRepository>()));
    ...
    gh.lazySingleton<_i83.InvitationLocalDataSource>(
        () => _i83.IsarInvitationLocalDataSource(gh<_i23.Isar>()));
    gh.lazySingleton<_i84.InvitationRepository>(
        () => _i85.InvitationRepositoryImpl(
              localDataSource: gh<_i83.InvitationLocalDataSource>(),
              remoteDataSource: gh<_i22.InvitationRemoteDataSource>(),
              networkStateManager: gh<_i29.NetworkStateManager>(),
            ));
    gh.factory<_i86.MarkAsUnreadUseCase>(
        () => _i86.MarkAsUnreadUseCase(gh<_i32.NotificationRepository>()));
    gh.lazySingleton<_i87.MarkNotificationAsReadUseCase>(() =>
        _i87.MarkNotificationAsReadUseCase(gh<_i32.NotificationRepository>()));
    gh.lazySingleton<_i88.ObservePendingInvitationsUseCase>(() =>
        _i88.ObservePendingInvitationsUseCase(gh<_i84.InvitationRepository>()));
    gh.lazySingleton<_i89.ObserveSentInvitationsUseCase>(() =>
        _i89.ObserveSentInvitationsUseCase(gh<_i84.InvitationRepository>()));
    gh.lazySingleton<_i90.OnboardingStateLocalDataSource>(() =>
        _i90.OnboardingStateLocalDataSourceImpl(gh<_i53.SharedPreferences>()));
    gh.lazySingleton<_i91.PendingOperationsManager>(
        () => _i91.PendingOperationsManager(
              gh<_i39.PendingOperationsRepository>(),
              gh<_i29.NetworkStateManager>(),
              gh<_i36.OperationExecutorFactory>(),
            ));
    gh.factory<_i92.PlaylistOperationExecutor>(() =>
        _i92.PlaylistOperationExecutor(gh<_i44.PlaylistRemoteDataSource>()));
    gh.lazySingleton<_i93.ProjectIncrementalSyncService>(
        () => _i93.ProjectIncrementalSyncService(
              gh<_i45.ProjectRemoteDataSource>(),
              gh<_i46.ProjectsLocalDataSource>(),
            ));
    gh.factory<_i94.ProjectOperationExecutor>(() =>
        _i94.ProjectOperationExecutor(gh<_i45.ProjectRemoteDataSource>()));
    gh.lazySingleton<_i95.SessionStorage>(
        () => _i95.SessionStorageImpl(prefs: gh<_i53.SharedPreferences>()));
    gh.lazySingleton<_i96.SyncAudioCommentsUseCase>(
        () => _i96.SyncAudioCommentsUseCase(
              gh<_i71.AudioCommentRemoteDataSource>(),
              gh<_i70.AudioCommentLocalDataSource>(),
              gh<_i45.ProjectRemoteDataSource>(),
              gh<_i95.SessionStorage>(),
              gh<_i73.AudioTrackRemoteDataSource>(),
            ));
    gh.lazySingleton<_i97.SyncNotificationsUseCase>(
        () => _i97.SyncNotificationsUseCase(
              gh<_i32.NotificationRepository>(),
              gh<_i95.SessionStorage>(),
            ));
    gh.lazySingleton<_i98.SyncProjectsUsingSimpleServiceUseCase>(
        () => _i98.SyncProjectsUsingSimpleServiceUseCase(
              gh<_i93.ProjectIncrementalSyncService>(),
              gh<_i95.SessionStorage>(),
            ));
    gh.lazySingleton<_i99.SyncUserProfileUseCase>(
        () => _i99.SyncUserProfileUseCase(
              gh<_i63.UserProfileRemoteDataSource>(),
              gh<_i62.UserProfileLocalDataSource>(),
              gh<_i95.SessionStorage>(),
            ));
    gh.lazySingleton<_i100.SyncWaveformsUseCase>(
        () => _i100.SyncWaveformsUseCase(
              gh<_i95.SessionStorage>(),
              gh<_i45.ProjectRemoteDataSource>(),
              gh<_i73.AudioTrackRemoteDataSource>(),
              gh<_i60.TrackVersionLocalDataSource>(),
              gh<_i67.WaveformLocalDataSource>(),
              gh<_i68.WaveformRemoteDataSource>(),
            ));
    gh.lazySingleton<_i101.TrackVersionIncrementalSyncService>(
        () => _i101.TrackVersionIncrementalSyncService(
    ...
    gh.lazySingleton<_i106.WatchTrackUploadStatusUseCase>(() =>
        _i106.WatchTrackUploadStatusUseCase(
            gh<_i91.PendingOperationsManager>()));
    ...
    gh.factory<_i108.WaveformOperationExecutor>(() =>
        _i108.WaveformOperationExecutor(gh<_i68.WaveformRemoteDataSource>()));
    ...
    gh.lazySingleton<_i110.AudioDownloadRepository>(
        () => _i111.AudioDownloadRepositoryImpl(
              remoteDataSource: gh<_i75.CacheStorageRemoteDataSource>(),
              localDataSource: gh<_i74.CacheStorageLocalDataSource>(),
            ));
    ...
    gh.lazySingleton<_i117.AuthRepository>(() => _i118.AuthRepositoryImpl(
          ...
          sessionStorage: gh<_i95.SessionStorage>(),
          networkStateManager: gh<_i29.NetworkStateManager>(),
          googleAuthService: gh<_i82.GoogleAuthService>(),
          appleAuthService: gh<_i69.AppleAuthService>(),
        ));
    gh.lazySingleton<_i119.CacheManagementLocalDataSource>(() =>
        _i119.CacheManagementLocalDataSourceImpl(
            local: gh<_i74.CacheStorageLocalDataSource>()));
    gh.factory<_i120.CacheTrackUseCase>(() => _i120.CacheTrackUseCase(
          gh<_i110.AudioDownloadRepository>(),
          gh<_i112.AudioStorageRepository>(),
        ));
    gh.lazySingleton<_i121.CancelInvitationUseCase>(
        () => _i121.CancelInvitationUseCase(gh<_i84.InvitationRepository>()));
    gh.factory<_i122.CheckAuthenticationStatusUseCase>(() =>
        _i122.CheckAuthenticationStatusUseCase(gh<_i117.AuthRepository>()));
    gh.factory<_i123.CurrentUserService>(
        () => _i123.CurrentUserService(gh<_i95.SessionStorage>()));
    gh.factory<_i124.DeleteCachedAudioUseCase>(() =>
        _i124.DeleteCachedAudioUseCase(gh<_i112.AudioStorageRepository>()));
    gh.lazySingleton<_i125.GenerateMagicLinkUseCase>(
        () => _i125.GenerateMagicLinkUseCase(
              gh<_i26.MagicLinkRepository>(),
              gh<_i117.AuthRepository>(),
            ));
    gh.lazySingleton<_i126.GetAuthStateUseCase>(
        () => _i126.GetAuthStateUseCase(gh<_i117.AuthRepository>()));
    gh.factory<_i127.GetCachedTrackPathUseCase>(() =>
        _i127.GetCachedTrackPathUseCase(gh<_i112.AudioStorageRepository>()));
    gh.factory<_i128.GetCurrentUserUseCase>(
        () => _i128.GetCurrentUserUseCase(gh<_i117.AuthRepository>()));
    gh.lazySingleton<_i129.GetPendingInvitationsCountUseCase>(() =>
        _i129.GetPendingInvitationsCountUseCase(
            gh<_i84.InvitationRepository>()));
    gh.factory<_i130.MarkAllNotificationsAsReadUseCase>(
        () => _i130.MarkAllNotificationsAsReadUseCase(
              notificationRepository: gh<_i32.NotificationRepository>(),
              currentUserService: gh<_i123.CurrentUserService>(),
            ));
    gh.factory<_i131.NotificationActorBloc>(() => _i131.NotificationActorBloc(
          createNotificationUseCase: gh<_i77.CreateNotificationUseCase>(),
          markAsReadUseCase: gh<_i87.MarkNotificationAsReadUseCase>(),
          markAsUnreadUseCase: gh<_i86.MarkAsUnreadUseCase>(),
          markAllAsReadUseCase: gh<_i130.MarkAllNotificationsAsReadUseCase>(),
          deleteNotificationUseCase: gh<_i79.DeleteNotificationUseCase>(),
        ));
    gh.factory<_i132.NotificationWatcherBloc>(
        () => _i132.NotificationWatcherBloc(
              notificationRepository: gh<_i32.NotificationRepository>(),
              currentUserService: gh<_i123.CurrentUserService>(),
            ));
    gh.lazySingleton<_i133.OnboardingRepository>(() =>
        _i134.OnboardingRepositoryImpl(
            gh<_i90.OnboardingStateLocalDataSource>()));
    gh.lazySingleton<_i135.OnboardingUseCase>(
        () => _i135.OnboardingUseCase(gh<_i133.OnboardingRepository>()));
    gh.factory<_i136.ProjectInvitationWatcherBloc>(
        () => _i136.ProjectInvitationWatcherBloc(
              invitationRepository: gh<_i84.InvitationRepository>(),
              currentUserService: gh<_i123.CurrentUserService>(),
            ));
    gh.factory<_i137.RemoveTrackCacheUseCase>(() =>
        _i137.RemoveTrackCacheUseCase(gh<_i112.AudioStorageRepository>()));
    gh.lazySingleton<_i138.SignOutUseCase>(
        () => _i138.SignOutUseCase(gh<_i117.AuthRepository>()));
    gh.lazySingleton<_i139.SignUpUseCase>(
        () => _i139.SignUpUseCase(gh<_i117.AuthRepository>()));
    gh.lazySingleton<_i140.SyncAudioTracksUsingSimpleServiceUseCase>(
        () => _i140.SyncAudioTracksUsingSimpleServiceUseCase(
              gh<_i114.AudioTrackIncrementalSyncService>(),
              gh<_i95.SessionStorage>(),
            ));
    gh.lazySingleton<_i141.SyncTrackVersionsUseCase>(
        () => _i141.SyncTrackVersionsUseCase(
              gh<_i101.TrackVersionIncrementalSyncService>(),
              gh<_i95.SessionStorage>(),
            ));
    ...
    gh.factory<_i144.WatchCachedAudiosUseCase>(() =>
        _i144.WatchCachedAudiosUseCase(gh<_i112.AudioStorageRepository>()));
    gh.factory<_i145.WatchStorageUsageUseCase>(() =>
        _i145.WatchStorageUsageUseCase(gh<_i112.AudioStorageRepository>()));
    gh.factory<_i146.WatchTrackCacheStatusUseCase>(() =>
        _i146.WatchTrackCacheStatusUseCase(gh<_i112.AudioStorageRepository>()));
    gh.lazySingleton<_i147.AppleSignInUseCase>(
        () => _i147.AppleSignInUseCase(gh<_i117.AuthRepository>()));
    gh.factory<_i148.AudioSourceResolver>(() => _i149.AudioSourceResolverImpl(
          gh<_i112.AudioStorageRepository>(),
          gh<_i110.AudioDownloadRepository>(),
        ));
    gh.lazySingleton<_i150.CacheMaintenanceService>(() =>
        _i151.CacheMaintenanceServiceImpl(
            gh<_i119.CacheManagementLocalDataSource>()));
    ...
    gh.factory<_i154.OnboardingBloc>(() => _i154.OnboardingBloc(
          onboardingUseCase: gh<_i135.OnboardingUseCase>(),
          getCurrentUserUseCase: gh<_i128.GetCurrentUserUseCase>(),
        ));
    gh.factory<_i155.SyncDataManager>(() => _i155.SyncDataManager(
          syncProjects: gh<_i98.SyncProjectsUsingSimpleServiceUseCase>(),
          syncAudioTracks: gh<_i140.SyncAudioTracksUsingSimpleServiceUseCase>(),
          syncAudioComments: gh<_i96.SyncAudioCommentsUseCase>(),
          syncUserProfile: gh<_i99.SyncUserProfileUseCase>(),
          syncUserProfileCollaborators:
              gh<_i142.SyncUserProfileCollaboratorsUseCase>(),
          syncNotifications: gh<_i97.SyncNotificationsUseCase>(),
          syncTrackVersions: gh<_i141.SyncTrackVersionsUseCase>(),
          syncWaveforms: gh<_i100.SyncWaveformsUseCase>(),
        ));
    gh.factory<_i156.SyncStatusProvider>(() => _i156.SyncStatusProvider(
          syncDataManager: gh<_i155.SyncDataManager>(),
          pendingOperationsManager: gh<_i91.PendingOperationsManager>(),
        ));
    gh.factory<_i157.TrackCacheBloc>(() => _i157.TrackCacheBloc(
          cacheTrackUseCase: gh<_i120.CacheTrackUseCase>(),
          watchTrackCacheStatusUseCase:
              gh<_i146.WatchTrackCacheStatusUseCase>(),
          removeTrackCacheUseCase: gh<_i137.RemoveTrackCacheUseCase>(),
          getCachedTrackPathUseCase: gh<_i127.GetCachedTrackPathUseCase>(),
        ));
    gh.lazySingleton<_i158.BackgroundSyncCoordinator>(
        () => _i158.BackgroundSyncCoordinator(
              gh<_i29.NetworkStateManager>(),
              gh<_i155.SyncDataManager>(),
              gh<_i91.PendingOperationsManager>(),
            ));
    gh.lazySingleton<_i159.PlaylistRepository>(
        () => _i160.PlaylistRepositoryImpl(
              localDataSource: gh<_i43.PlaylistLocalDataSource>(),
              backgroundSyncCoordinator: gh<_i158.BackgroundSyncCoordinator>(),
              pendingOperationsManager: gh<_i91.PendingOperationsManager>(),
            ));
    gh.lazySingleton<_i161.ProjectsRepository>(
        () => _i162.ProjectsRepositoryImpl(
              localDataSource: gh<_i46.ProjectsLocalDataSource>(),
              backgroundSyncCoordinator: gh<_i158.BackgroundSyncCoordinator>(),
              pendingOperationsManager: gh<_i91.PendingOperationsManager>(),
            ));
    gh.lazySingleton<_i163.RemoveCollaboratorUseCase>(
        () => _i163.RemoveCollaboratorUseCase(
              gh<_i161.ProjectsRepository>(),
              gh<_i95.SessionStorage>(),
            ));
    gh.lazySingleton<_i164.TrackVersionRepository>(
        () => _i165.TrackVersionRepositoryImpl(
              gh<_i60.TrackVersionLocalDataSource>(),
              gh<_i158.BackgroundSyncCoordinator>(),
              gh<_i91.PendingOperationsManager>(),
            ));
    ...
    gh.lazySingleton<_i173.WatchTrackVersionsUseCase>(() =>
        _i173.WatchTrackVersionsUseCase(gh<_i164.TrackVersionRepository>()));
    gh.lazySingleton<_i174.WatchUserProfileUseCase>(
        () => _i174.WatchUserProfileUseCase(
              gh<_i169.UserProfileRepository>(),
              gh<_i95.SessionStorage>(),
            ));
    gh.factory<_i175.WaveformRepository>(() => _i176.WaveformRepositoryImpl(
          localDataSource: gh<_i67.WaveformLocalDataSource>(),
          remoteDataSource: gh<_i68.WaveformRemoteDataSource>(),
          backgroundSyncCoordinator: gh<_i158.BackgroundSyncCoordinator>(),
          pendingOperationsManager: gh<_i91.PendingOperationsManager>(),
        ));
    gh.lazySingleton<_i177.AcceptInvitationUseCase>(
        () => _i177.AcceptInvitationUseCase(
              invitationRepository: gh<_i84.InvitationRepository>(),
              projectRepository: gh<_i161.ProjectsRepository>(),
              userProfileRepository: gh<_i169.UserProfileRepository>(),
              notificationService: gh<_i34.NotificationService>(),
            ));
    gh.lazySingleton<_i178.AddCollaboratorToProjectUseCase>(
        () => _i178.AddCollaboratorToProjectUseCase(
              gh<_i161.ProjectsRepository>(),
              gh<_i95.SessionStorage>(),
            ));
    gh.lazySingleton<_i179.AudioCommentRepository>(
        () => _i180.AudioCommentRepositoryImpl(
              remoteDataSource: gh<_i71.AudioCommentRemoteDataSource>(),
              localDataSource: gh<_i70.AudioCommentLocalDataSource>(),
              networkStateManager: gh<_i29.NetworkStateManager>(),
              backgroundSyncCoordinator: gh<_i158.BackgroundSyncCoordinator>(),
              pendingOperationsManager: gh<_i91.PendingOperationsManager>(),
              trackVersionRepository: gh<_i164.TrackVersionRepository>(),
            ));
    ...
    gh.lazySingleton<_i187.DeleteTrackVersionUseCase>(
        () => _i187.DeleteTrackVersionUseCase(
              gh<_i164.TrackVersionRepository>(),
              gh<_i175.WaveformRepository>(),
              gh<_i179.AudioCommentRepository>(),
              gh<_i112.AudioStorageRepository>(),
            ));
    gh.lazySingleton<_i188.FindUserByEmailUseCase>(
        () => _i188.FindUserByEmailUseCase(gh<_i169.UserProfileRepository>()));
    gh.factory<_i189.GenerateAndStoreWaveform>(
        () => _i189.GenerateAndStoreWaveform(
              gh<_i175.WaveformRepository>(),
              gh<_i65.WaveformGeneratorService>(),
            ));
    gh.lazySingleton<_i190.GetActiveVersionUseCase>(() =>
        _i190.GetActiveVersionUseCase(gh<_i164.TrackVersionRepository>()));
    gh.lazySingleton<_i191.GetProjectByIdUseCase>(
        () => _i191.GetProjectByIdUseCase(gh<_i161.ProjectsRepository>()));
    gh.lazySingleton<_i192.GetVersionByIdUseCase>(
        () => _i192.GetVersionByIdUseCase(gh<_i164.TrackVersionRepository>()));
    gh.factory<_i193.GetWaveformByVersion>(
        () => _i193.GetWaveformByVersion(gh<_i175.WaveformRepository>()));
    ...
    gh.factory<_i197.MagicLinkBloc>(() => _i197.MagicLinkBloc(
          generateMagicLink: gh<_i125.GenerateMagicLinkUseCase>(),
          validateMagicLink: gh<_i64.ValidateMagicLinkUseCase>(),
          consumeMagicLink: gh<_i76.ConsumeMagicLinkUseCase>(),
    ...
    gh.factory<_i198.PlayPlaylistUseCase>(() => _i198.PlayPlaylistUseCase(
          playlistRepository: gh<_i159.PlaylistRepository>(),
    ...
    gh.lazySingleton<_i200.ProjectCommentService>(
        () => _i200.ProjectCommentService(gh<_i179.AudioCommentRepository>()));
    gh.lazySingleton<_i201.ProjectTrackService>(
        () => _i201.ProjectTrackService(gh<_i181.AudioTrackRepository>()));
    gh.lazySingleton<_i202.RenameTrackVersionUseCase>(() =>
        _i202.RenameTrackVersionUseCase(gh<_i164.TrackVersionRepository>()));
    ...
    gh.factory<_i205.SessionCleanupService>(() => _i205.SessionCleanupService(
          userProfileRepository: gh<_i169.UserProfileRepository>(),
          projectsRepository: gh<_i161.ProjectsRepository>(),
          audioTrackRepository: gh<_i181.AudioTrackRepository>(),
          ...
          waveformRepository: gh<_i175.WaveformRepository>(),
          trackVersionRepository: gh<_i164.TrackVersionRepository>(),
        ));
    ...
    gh.factory<_i211.UserProfileBloc>(() => _i211.UserProfileBloc(
          updateUserProfileUseCase: gh<_i210.UpdateUserProfileUseCase>(),
    ...
    gh.lazySingleton<_i212.WatchAudioCommentsBundleUseCase>(
        () => _i212.WatchAudioCommentsBundleUseCase(
              gh<_i181.AudioTrackRepository>(),
              gh<_i179.AudioCommentRepository>(),
              gh<_i103.UserProfileCacheRepository>(),
            ));
    gh.factory<_i213.WatchCachedTrackBundlesUseCase>(
        () => _i213.WatchCachedTrackBundlesUseCase(
    ...
    gh.lazySingleton<_i214.WatchProjectDetailUseCase>(
        () => _i214.WatchProjectDetailUseCase(
              gh<_i161.ProjectsRepository>(),
              gh<_i181.AudioTrackRepository>(),
              gh<_i103.UserProfileCacheRepository>(),
              gh<_i164.TrackVersionRepository>(),
            ));
    gh.lazySingleton<_i215.WatchTrackVersionsBundleUseCase>(
        () => _i215.WatchTrackVersionsBundleUseCase(
              gh<_i181.AudioTrackRepository>(),
              gh<_i164.TrackVersionRepository>(),
            ));
    gh.lazySingleton<_i216.WatchTracksByProjectIdUseCase>(() =>
        _i216.WatchTracksByProjectIdUseCase(gh<_i181.AudioTrackRepository>()));
    gh.factory<_i217.WaveformBloc>(() => _i217.WaveformBloc(
          waveformRepository: gh<_i175.WaveformRepository>(),
          audioPlaybackService: gh<_i5.AudioPlaybackService>(),
        ));
    gh.lazySingleton<_i218.AddAudioCommentUseCase>(
        () => _i218.AddAudioCommentUseCase(
              gh<_i200.ProjectCommentService>(),
              gh<_i161.ProjectsRepository>(),
              gh<_i95.SessionStorage>(),
            ));
    gh.lazySingleton<_i219.AddCollaboratorByEmailUseCase>(
        () => _i219.AddCollaboratorByEmailUseCase(
              gh<_i188.FindUserByEmailUseCase>(),
              gh<_i178.AddCollaboratorToProjectUseCase>(),
              gh<_i34.NotificationService>(),
            ));
    gh.lazySingleton<_i220.AddTrackVersionUseCase>(
        () => _i220.AddTrackVersionUseCase(
              gh<_i95.SessionStorage>(),
              gh<_i164.TrackVersionRepository>(),
              gh<_i4.AudioMetadataService>(),
              gh<_i112.AudioStorageRepository>(),
              gh<_i189.GenerateAndStoreWaveform>(),
            ));
    gh.factory<_i221.AppBootstrap>(() => _i221.AppBootstrap(
          ...
          databaseHealthMonitor: gh<_i78.DatabaseHealthMonitor>(),
        ));
    gh.factory<_i222.AppFlowBloc>(() => _i222.AppFlowBloc(
          appBootstrap: gh<_i221.AppBootstrap>(),
          backgroundSyncCoordinator: gh<_i158.BackgroundSyncCoordinator>(),
          getAuthStateUseCase: gh<_i126.GetAuthStateUseCase>(),
          sessionCleanupService: gh<_i205.SessionCleanupService>(),
        ));
    gh.lazySingleton<_i223.AudioContextService>(
        () => _i224.AudioContextServiceImpl(
              userProfileRepository: gh<_i169.UserProfileRepository>(),
              audioTrackRepository: gh<_i181.AudioTrackRepository>(),
              projectsRepository: gh<_i161.ProjectsRepository>(),
            ));
    ...
    gh.factory<_i226.AuthBloc>(() => _i226.AuthBloc(
          signIn: gh<_i208.SignInUseCase>(),
          signUp: gh<_i139.SignUpUseCase>(),
          googleSignIn: gh<_i194.GoogleSignInUseCase>(),
          appleSignIn: gh<_i147.AppleSignInUseCase>(),
          signOut: gh<_i138.SignOutUseCase>(),
        ));
    gh.factory<_i227.CacheManagementBloc>(() => _i227.CacheManagementBloc(
          deleteOne: gh<_i124.DeleteCachedAudioUseCase>(),
          ...
          watchBundles: gh<_i213.WatchCachedTrackBundlesUseCase>(),
        ));
    gh.lazySingleton<_i228.DeleteAudioCommentUseCase>(
        () => _i228.DeleteAudioCommentUseCase(
              gh<_i200.ProjectCommentService>(),
              gh<_i161.ProjectsRepository>(),
              gh<_i95.SessionStorage>(),
            ));
    gh.lazySingleton<_i229.DeleteAudioTrack>(() => _i229.DeleteAudioTrack(
          gh<_i95.SessionStorage>(),
          gh<_i161.ProjectsRepository>(),
    ...
    gh.lazySingleton<_i230.DeleteProjectUseCase>(
        () => _i230.DeleteProjectUseCase(
              gh<_i161.ProjectsRepository>(),
              gh<_i95.SessionStorage>(),
              gh<_i201.ProjectTrackService>(),
            ));
    gh.lazySingleton<_i231.EditAudioTrackUseCase>(
        () => _i231.EditAudioTrackUseCase(
              gh<_i201.ProjectTrackService>(),
              gh<_i161.ProjectsRepository>(),
            ));
    gh.factory<_i232.LoadTrackContextUseCase>(
        () => _i232.LoadTrackContextUseCase(gh<_i223.AudioContextService>()));
    gh.factory<_i233.ManageCollaboratorsBloc>(
        () => _i233.ManageCollaboratorsBloc(
              removeCollaboratorUseCase: gh<_i163.RemoveCollaboratorUseCase>(),
              ...
              addCollaboratorByEmailUseCase:
                  gh<_i219.AddCollaboratorByEmailUseCase>(),
              watchCollaboratorsBundleUseCase:
                  gh<_i172.WatchCollaboratorsBundleUseCase>(),
            ));
    gh.factory<_i234.ProjectDetailBloc>(() => _i234.ProjectDetailBloc(
        watchProjectDetail: gh<_i214.WatchProjectDetailUseCase>()));
    gh.factory<_i235.ProjectInvitationActorBloc>(
        () => _i235.ProjectInvitationActorBloc(
              sendInvitationUseCase: gh<_i204.SendInvitationUseCase>(),
              acceptInvitationUseCase: gh<_i177.AcceptInvitationUseCase>(),
              declineInvitationUseCase: gh<_i186.DeclineInvitationUseCase>(),
              cancelInvitationUseCase: gh<_i121.CancelInvitationUseCase>(),
              findUserByEmailUseCase: gh<_i188.FindUserByEmailUseCase>(),
            ));
    gh.factory<_i236.ProjectsBloc>(() => _i236.ProjectsBloc(
          createProject: gh<_i184.CreateProjectUseCase>(),
          updateProject: gh<_i168.UpdateProjectUseCase>(),
          deleteProject: gh<_i230.DeleteProjectUseCase>(),
          watchAllProjects: gh<_i171.WatchAllProjectsUseCase>(),
        ));
    gh.factory<_i237.TrackVersionsBloc>(() => _i237.TrackVersionsBloc(
          gh<_i215.WatchTrackVersionsBundleUseCase>(),
          gh<_i207.SetActiveTrackVersionUseCase>(),
          gh<_i220.AddTrackVersionUseCase>(),
          gh<_i202.RenameTrackVersionUseCase>(),
          gh<_i187.DeleteTrackVersionUseCase>(),
        ));
    gh.lazySingleton<_i238.UploadAudioTrackUseCase>(
        () => _i238.UploadAudioTrackUseCase(
              gh<_i201.ProjectTrackService>(),
              gh<_i161.ProjectsRepository>(),
              gh<_i95.SessionStorage>(),
              gh<_i220.AddTrackVersionUseCase>(),
    ...
    gh.factory<_i239.AudioCommentBloc>(() => _i239.AudioCommentBloc(
          addAudioCommentUseCase: gh<_i218.AddAudioCommentUseCase>(),
          deleteAudioCommentUseCase: gh<_i228.DeleteAudioCommentUseCase>(),
          watchAudioCommentsBundleUseCase:
              gh<_i212.WatchAudioCommentsBundleUseCase>(),
        ));
    gh.factory<_i240.AudioContextBloc>(() => _i240.AudioContextBloc(
        loadTrackContextUseCase: gh<_i232.LoadTrackContextUseCase>()));
    gh.factory<_i241.AudioPlayerBloc>(() => _i241.AudioPlayerBloc(
        audioPlayerService: gh<_i225.AudioPlayerService>()));
    gh.factory<_i242.AudioTrackBloc>(() => _i242.AudioTrackBloc(
          watchAudioTracksByProject: gh<_i216.WatchTracksByProjectIdUseCase>(),
          deleteAudioTrack: gh<_i229.DeleteAudioTrack>(),
          uploadAudioTrackUseCase: gh<_i238.UploadAudioTrackUseCase>(),
          editAudioTrackUseCase: gh<_i231.EditAudioTrackUseCase>(),
        ));
    return this;
  }
}
