...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i65.CheckProfileCompletenessUseCase>(
      () => _i65.CheckProfileCompletenessUseCase(
    ...
    gh.lazySingleton<_i74.SyncProjectsUseCase>(
      () => _i74.SyncProjectsUseCase(
        gh<_i33.ProjectRemoteDataSource>(),
    ...
    gh.lazySingleton<_i77.UpdateProjectUseCase>(
      () => _i77.UpdateProjectUseCase(
        gh<_i35.ProjectsRepository>(),
        gh<_i71.SessionStorage>(),
      ),
    );
    ...
    gh.lazySingleton<_i95.AuthRepository>(
      () => _i96.AuthRepositoryImpl(
        remote: gh<_i62.AuthRemoteDataSource>(),
        sessionStorage: gh<_i71.SessionStorage>(),
        networkInfo: gh<_i25.NetworkInfo>(),
      ),
    );
    gh.lazySingleton<_i97.CacheKeyRepository>(
      () => _i98.CacheKeyRepositoryImpl(
        localDataSource: gh<_i63.CacheStorageLocalDataSource>(),
      ),
    );
    ...
    gh.factory<_i101.CachePlaylistUseCase>(
      () => _i101.CachePlaylistUseCase(
        gh<_i91.AudioDownloadRepository>(),
        gh<_i60.AudioTrackRepository>(),
      ),
    );
    gh.factory<_i102.CacheTrackUseCase>(
      () => _i102.CacheTrackUseCase(
        gh<_i91.AudioDownloadRepository>(),
    ...
    gh.factory<_i112.GetPlaylistCacheStatusUseCase>(
      () => _i112.GetPlaylistCacheStatusUseCase(
        gh<_i93.AudioStorageRepository>(),
      ),
    );
    gh.lazySingleton<_i113.GoogleSignInUseCase>(
      () => _i113.GoogleSignInUseCase(
        gh<_i95.AuthRepository>(),
        gh<_i51.UserProfileRepository>(),
      ),
    );
    ...
    gh.lazySingleton<_i115.LeaveProjectUseCase>(
      () => _i115.LeaveProjectUseCase(
        gh<_i35.ProjectsRepository>(),
        gh<_i71.SessionStorage>(),
      ),
    );
    ...
    gh.factory<_i117.MagicLinkBloc>(
      () => _i117.MagicLinkBloc(
    ...
    gh.factory<_i121.PlayAudioUseCase>(
      () => _i121.PlayAudioUseCase(
        audioTrackRepository: gh<_i60.AudioTrackRepository>(),
        audioStorageRepository: gh<_i93.AudioStorageRepository>(),
        playbackService: gh<_i3.AudioPlaybackService>(),
      ),
    );
    gh.factory<_i122.PlayPlaylistUseCase>(
      () => _i122.PlayPlaylistUseCase(
    ...
    gh.factory<_i123.ProjectDetailBloc>(
      () => _i123.ProjectDetailBloc(
        watchProjectDetail: gh<_i83.WatchProjectDetailUseCase>(),
      ),
    );
    gh.lazySingleton<_i124.ProjectTrackService>(
      () => _i124.ProjectTrackService(
        gh<_i60.AudioTrackRepository>(),
        gh<_i93.AudioStorageRepository>(),
      ),
    );
    gh.factory<_i125.ProjectsBloc>(
      () => _i125.ProjectsBloc(
    ...
    gh.factory<_i135.UserProfileBloc>(
      () => _i135.UserProfileBloc(
    ...
    gh.factory<_i137.AudioCommentBloc>(
      () => _i137.AudioCommentBloc(
    ...
    gh.factory<_i138.AudioContextBloc>(
      () => _i138.AudioContextBloc(
        loadTrackContextUseCase: gh<_i116.LoadTrackContextUseCase>(),
      ),
    );
    gh.factory<_i139.AudioPlayerService>(
      () => _i139.AudioPlayerService(
    ...
    gh.factory<_i140.AudioSourceResolver>(
      () => _i141.AudioSourceResolverImpl(
        gh<_i93.AudioStorageRepository>(),
        gh<_i91.AudioDownloadRepository>(),
      ),
    );
    gh.factory<_i142.AudioWaveformBloc>(
      () => _i142.AudioWaveformBloc(
        audioPlaybackService: gh<_i3.AudioPlaybackService>(),
        getCachedTrackPathUseCase: gh<_i109.GetCachedTrackPathUseCase>(),
      ),
    );
    gh.factory<_i143.AuthBloc>(
      () => _i143.AuthBloc(
    ...
    gh.lazySingleton<_i144.DeleteAudioTrack>(
      () => _i144.DeleteAudioTrack(
        gh<_i71.SessionStorage>(),
        gh<_i35.ProjectsRepository>(),
        gh<_i124.ProjectTrackService>(),
      ),
    ...
    gh.factory<_i146.ManageCollaboratorsBloc>(
      () => _i146.ManageCollaboratorsBloc(
        ...
        updateCollaboratorRoleUseCase: gh<_i76.UpdateCollaboratorRoleUseCase>(),
        leaveProjectUseCase: gh<_i115.LeaveProjectUseCase>(),
        watchUserProfilesUseCase: gh<_i86.WatchUserProfilesUseCase>(),
      ),
    );
    gh.factory<_i147.OnboardingBloc>(
      () => _i147.OnboardingBloc(
        onboardingUseCase: gh<_i120.OnboardingUseCase>(),
        getCurrentUserIdUseCase: gh<_i110.GetCurrentUserIdUseCase>(),
      ),
    );
    gh.factory<_i148.PlaylistCacheBloc>(
      () => _i148.PlaylistCacheBloc(
    ...
    gh.factory<_i151.TrackCacheBloc>(
      () => _i151.TrackCacheBloc(
        ...
        watchTrackCacheStatusUseCase: gh<_i136.WatchTrackCacheStatusUseCase>(),
        removeTrackCacheUseCase: gh<_i128.RemoveTrackCacheUseCase>(),
        getCachedTrackPathUseCase: gh<_i109.GetCachedTrackPathUseCase>(),
      ),
    );
    gh.factory<_i152.AppSessionService>(
      () => _i152.AppSessionService(
