...
import 'package:trackflow/core/app_flow/presentation/bloc/app_flow_bloc.dart'
    as _i225;
import 'package:trackflow/core/di/app_module.dart' as _i244;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i202.ProjectCommentService>(
        () => _i202.ProjectCommentService(gh<_i180.AudioCommentRepository>()));
    gh.lazySingleton<_i203.ProjectTrackService>(
        () => _i203.ProjectTrackService(gh<_i182.AudioTrackRepository>()));
    gh.lazySingleton<_i204.RenameTrackVersionUseCase>(() =>
        _i204.RenameTrackVersionUseCase(gh<_i165.TrackVersionRepository>()));
    ...
    gh.lazySingleton<_i209.SetActiveTrackVersionUseCase>(() =>
        _i209.SetActiveTrackVersionUseCase(gh<_i182.AudioTrackRepository>()));
    ...
    gh.lazySingleton<_i219.WatchTracksByProjectIdUseCase>(() =>
        _i219.WatchTracksByProjectIdUseCase(gh<_i182.AudioTrackRepository>()));
    ...
    gh.factory<_i224.AppBootstrap>(() => _i224.AppBootstrap(
    ...
    gh.factory<_i225.AppFlowBloc>(() => _i225.AppFlowBloc(
          appBootstrap: gh<_i224.AppBootstrap>(),
          backgroundSyncCoordinator: gh<_i159.BackgroundSyncCoordinator>(),
    ...
    gh.factory<_i235.PlaylistBloc>(
        () => _i235.PlaylistBloc(gh<_i217.WatchProjectPlaylistUseCase>()));
    ...
    gh.factory<_i239.TrackVersionsBloc>(() => _i239.TrackVersionsBloc(
    ...
    gh.lazySingleton<_i240.UploadAudioTrackUseCase>(
        () => _i240.UploadAudioTrackUseCase(
              gh<_i203.ProjectTrackService>(),
              gh<_i162.ProjectsRepository>(),
              gh<_i96.SessionStorage>(),
              gh<_i223.AddTrackVersionUseCase>(),
    ...
    gh.factory<_i241.AudioCommentBloc>(() => _i241.AudioCommentBloc(
    ...
    gh.factory<_i242.AudioPlayerBloc>(() => _i242.AudioPlayerBloc(
        audioPlayerService: gh<_i227.AudioPlayerService>()));
    gh.factory<_i243.AudioTrackBloc>(() => _i243.AudioTrackBloc(
          watchAudioTracksByProject: gh<_i219.WatchTracksByProjectIdUseCase>(),
          deleteAudioTrack: gh<_i231.DeleteAudioTrack>(),
          uploadAudioTrackUseCase: gh<_i240.UploadAudioTrackUseCase>(),
