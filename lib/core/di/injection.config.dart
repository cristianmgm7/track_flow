...
import 'package:trackflow/core/app_flow/presentation/bloc/app_flow_bloc.dart'
    as _i200;
import 'package:trackflow/core/di/app_module.dart' as _i216;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i119.GenerateMagicLinkUseCase>(
        () => _i119.GenerateMagicLinkUseCase(
              gh<_i29.MagicLinkRepository>(),
              gh<_i109.AuthRepository>(),
            ));
    gh.lazySingleton<_i120.GetAuthStateUseCase>(
        () => _i120.GetAuthStateUseCase(gh<_i109.AuthRepository>()));
    gh.factory<_i121.GetCachedTrackPathUseCase>(() =>
        _i121.GetCachedTrackPathUseCase(gh<_i104.AudioStorageRepository>()));
    gh.factory<_i122.GetCurrentUserUseCase>(
        () => _i122.GetCurrentUserUseCase(gh<_i109.AuthRepository>()));
    gh.lazySingleton<_i123.GetPendingInvitationsCountUseCase>(() =>
        _i123.GetPendingInvitationsCountUseCase(
            gh<_i80.InvitationRepository>()));
    gh.factory<_i124.GetPlaylistCacheStatusUseCase>(() =>
        _i124.GetPlaylistCacheStatusUseCase(
            gh<_i104.AudioStorageRepository>()));
    gh.factory<_i125.MarkAllNotificationsAsReadUseCase>(
        () => _i125.MarkAllNotificationsAsReadUseCase(
    ...
    gh.factory<_i126.NotificationActorBloc>(() => _i126.NotificationActorBloc(
          ...
          markAllAsReadUseCase: gh<_i125.MarkAllNotificationsAsReadUseCase>(),
          deleteNotificationUseCase: gh<_i75.DeleteNotificationUseCase>(),
        ));
    gh.factory<_i127.NotificationWatcherBloc>(
        () => _i127.NotificationWatcherBloc(
              notificationRepository: gh<_i35.NotificationRepository>(),
              currentUserService: gh<_i118.CurrentUserService>(),
            ));
    gh.lazySingleton<_i128.OnboardingRepository>(() =>
        _i129.OnboardingRepositoryImpl(
            gh<_i86.OnboardingStateLocalDataSource>()));
    gh.lazySingleton<_i130.OnboardingUseCase>(
        () => _i130.OnboardingUseCase(gh<_i128.OnboardingRepository>()));
    gh.factory<_i131.ProjectInvitationWatcherBloc>(
        () => _i131.ProjectInvitationWatcherBloc(
              invitationRepository: gh<_i80.InvitationRepository>(),
              currentUserService: gh<_i118.CurrentUserService>(),
            ));
    gh.factory<_i132.RemovePlaylistCacheUseCase>(() =>
        _i132.RemovePlaylistCacheUseCase(gh<_i104.AudioStorageRepository>()));
    gh.factory<_i133.RemoveTrackCacheUseCase>(() =>
        _i133.RemoveTrackCacheUseCase(gh<_i104.AudioStorageRepository>()));
    gh.lazySingleton<_i134.SignOutUseCase>(
        () => _i134.SignOutUseCase(gh<_i109.AuthRepository>()));
    gh.lazySingleton<_i135.SignUpUseCase>(
        () => _i135.SignUpUseCase(gh<_i109.AuthRepository>()));
    gh.lazySingleton<_i136.SyncAudioTracksUsingSimpleServiceUseCase>(
        () => _i136.SyncAudioTracksUsingSimpleServiceUseCase(
              gh<_i106.AudioTrackIncrementalSyncService>(),
              gh<_i91.SessionStorage>(),
            ));
    gh.lazySingleton<_i137.SyncUserProfileCollaboratorsUseCase>(
        () => _i137.SyncUserProfileCollaboratorsUseCase(
              gh<_i49.ProjectsLocalDataSource>(),
              gh<_i96.UserProfileCacheRepository>(),
            ));
    gh.factory<_i138.TrackUploadStatusCubit>(() =>
        _i138.TrackUploadStatusCubit(gh<_i99.WatchTrackUploadStatusUseCase>()));
    gh.factory<_i139.WatchTrackCacheStatusUseCase>(() =>
        _i139.WatchTrackCacheStatusUseCase(gh<_i104.AudioStorageRepository>()));
    ...
    gh.factory<_i142.AudioWaveformBloc>(() => _i142.AudioWaveformBloc(
          ...
          getCachedTrackPathUseCase: gh<_i121.GetCachedTrackPathUseCase>(),
        ));
    gh.factory<_i143.OnboardingBloc>(() => _i143.OnboardingBloc(
          onboardingUseCase: gh<_i130.OnboardingUseCase>(),
          getCurrentUserUseCase: gh<_i122.GetCurrentUserUseCase>(),
        ));
    gh.factory<_i144.SyncDataManager>(() => _i144.SyncDataManager(
          syncProjects: gh<_i94.SyncProjectsUsingSimpleServiceUseCase>(),
          syncAudioTracks: gh<_i136.SyncAudioTracksUsingSimpleServiceUseCase>(),
          ...
          syncUserProfileCollaborators:
              gh<_i137.SyncUserProfileCollaboratorsUseCase>(),
          syncNotifications: gh<_i93.SyncNotificationsUseCase>(),
        ));
    gh.factory<_i145.SyncStatusProvider>(() => _i145.SyncStatusProvider(
          syncDataManager: gh<_i144.SyncDataManager>(),
          pendingOperationsManager: gh<_i87.PendingOperationsManager>(),
        ));
    gh.factory<_i146.TrackCacheBloc>(() => _i146.TrackCacheBloc(
          cacheTrackUseCase: gh<_i115.CacheTrackUseCase>(),
          watchTrackCacheStatusUseCase:
              gh<_i139.WatchTrackCacheStatusUseCase>(),
          removeTrackCacheUseCase: gh<_i133.RemoveTrackCacheUseCase>(),
          getCachedTrackPathUseCase: gh<_i121.GetCachedTrackPathUseCase>(),
        ));
    gh.lazySingleton<_i147.BackgroundSyncCoordinator>(
        () => _i147.BackgroundSyncCoordinator(
              gh<_i32.NetworkStateManager>(),
              gh<_i144.SyncDataManager>(),
              gh<_i87.PendingOperationsManager>(),
            ));
    gh.lazySingleton<_i148.PlaylistRepository>(
        () => _i149.PlaylistRepositoryImpl(
              localDataSource: gh<_i46.PlaylistLocalDataSource>(),
              backgroundSyncCoordinator: gh<_i147.BackgroundSyncCoordinator>(),
              pendingOperationsManager: gh<_i87.PendingOperationsManager>(),
            ));
    ...
    gh.lazySingleton<_i153.TriggerUpstreamSyncUseCase>(() =>
        _i153.TriggerUpstreamSyncUseCase(
            gh<_i147.BackgroundSyncCoordinator>()));
    gh.lazySingleton<_i154.UpdateCollaboratorRoleUseCase>(
        () => _i154.UpdateCollaboratorRoleUseCase(
              gh<_i150.ProjectsRepository>(),
              gh<_i91.SessionStorage>(),
            ));
    gh.lazySingleton<_i155.UpdateProjectUseCase>(
        () => _i155.UpdateProjectUseCase(
              gh<_i150.ProjectsRepository>(),
              gh<_i91.SessionStorage>(),
            ));
    gh.lazySingleton<_i156.UserProfileRepository>(
        () => _i157.UserProfileRepositoryImpl(
    ...
    gh.lazySingleton<_i158.WatchAllProjectsUseCase>(
        () => _i158.WatchAllProjectsUseCase(
              gh<_i150.ProjectsRepository>(),
              gh<_i91.SessionStorage>(),
            ));
    gh.lazySingleton<_i159.WatchCollaboratorsBundleUseCase>(
        () => _i159.WatchCollaboratorsBundleUseCase(
              gh<_i150.ProjectsRepository>(),
              gh<_i100.WatchUserProfilesUseCase>(),
            ));
    gh.lazySingleton<_i160.WatchUserProfileUseCase>(
        () => _i160.WatchUserProfileUseCase(
              gh<_i156.UserProfileRepository>(),
              gh<_i91.SessionStorage>(),
            ));
    gh.lazySingleton<_i161.AcceptInvitationUseCase>(
        () => _i161.AcceptInvitationUseCase(
              invitationRepository: gh<_i80.InvitationRepository>(),
              projectRepository: gh<_i150.ProjectsRepository>(),
              userProfileRepository: gh<_i156.UserProfileRepository>(),
              notificationService: gh<_i37.NotificationService>(),
            ));
    gh.lazySingleton<_i162.AddCollaboratorToProjectUseCase>(
        () => _i162.AddCollaboratorToProjectUseCase(
              gh<_i150.ProjectsRepository>(),
              gh<_i91.SessionStorage>(),
            ));
    gh.lazySingleton<_i163.AudioCommentRepository>(
        () => _i164.AudioCommentRepositoryImpl(
    ...
    gh.lazySingleton<_i165.AudioTrackRepository>(
        () => _i166.AudioTrackRepositoryImpl(
              gh<_i68.AudioTrackLocalDataSource>(),
              gh<_i147.BackgroundSyncCoordinator>(),
              gh<_i87.PendingOperationsManager>(),
            ));
    gh.factory<_i167.CachePlaylistUseCase>(() => _i167.CachePlaylistUseCase(
          gh<_i102.AudioDownloadRepository>(),
          gh<_i165.AudioTrackRepository>(),
        ));
    gh.factory<_i168.CheckProfileCompletenessUseCase>(() =>
        _i168.CheckProfileCompletenessUseCase(
            gh<_i156.UserProfileRepository>()));
    gh.lazySingleton<_i169.CreateProjectUseCase>(
        () => _i169.CreateProjectUseCase(
              gh<_i150.ProjectsRepository>(),
              gh<_i91.SessionStorage>(),
            ));
    gh.factory<_i170.CreateUserProfileUseCase>(
        () => _i170.CreateUserProfileUseCase(
              gh<_i156.UserProfileRepository>(),
              gh<_i91.SessionStorage>(),
            ));
    gh.lazySingleton<_i171.DeclineInvitationUseCase>(
        () => _i171.DeclineInvitationUseCase(
              invitationRepository: gh<_i80.InvitationRepository>(),
              projectRepository: gh<_i150.ProjectsRepository>(),
              userProfileRepository: gh<_i156.UserProfileRepository>(),
              notificationService: gh<_i37.NotificationService>(),
            ));
    gh.lazySingleton<_i172.DeleteProjectUseCase>(
        () => _i172.DeleteProjectUseCase(
              gh<_i150.ProjectsRepository>(),
              gh<_i91.SessionStorage>(),
            ));
    gh.lazySingleton<_i173.FindUserByEmailUseCase>(
        () => _i173.FindUserByEmailUseCase(gh<_i156.UserProfileRepository>()));
    gh.lazySingleton<_i174.GetProjectByIdUseCase>(
        () => _i174.GetProjectByIdUseCase(gh<_i150.ProjectsRepository>()));
    gh.lazySingleton<_i175.GoogleSignInUseCase>(() => _i175.GoogleSignInUseCase(
          gh<_i109.AuthRepository>(),
          gh<_i156.UserProfileRepository>(),
        ));
    gh.lazySingleton<_i176.JoinProjectWithIdUseCase>(
        () => _i176.JoinProjectWithIdUseCase(
              gh<_i150.ProjectsRepository>(),
              gh<_i91.SessionStorage>(),
            ));
    gh.lazySingleton<_i177.LeaveProjectUseCase>(() => _i177.LeaveProjectUseCase(
          gh<_i150.ProjectsRepository>(),
          gh<_i91.SessionStorage>(),
        ));
    gh.factory<_i178.MagicLinkBloc>(() => _i178.MagicLinkBloc(
          generateMagicLink: gh<_i119.GenerateMagicLinkUseCase>(),
          ...
          joinProjectWithId: gh<_i176.JoinProjectWithIdUseCase>(),
          authRepository: gh<_i109.AuthRepository>(),
        ));
    gh.factory<_i179.PlayAudioUseCase>(() => _i179.PlayAudioUseCase(
          audioTrackRepository: gh<_i165.AudioTrackRepository>(),
          audioStorageRepository: gh<_i104.AudioStorageRepository>(),
          playbackService: gh<_i4.AudioPlaybackService>(),
        ));
    gh.factory<_i180.PlayPlaylistUseCase>(() => _i180.PlayPlaylistUseCase(
          playlistRepository: gh<_i148.PlaylistRepository>(),
          audioTrackRepository: gh<_i165.AudioTrackRepository>(),
          playbackService: gh<_i4.AudioPlaybackService>(),
          audioStorageRepository: gh<_i104.AudioStorageRepository>(),
        ));
    gh.factory<_i181.PlaylistCacheBloc>(() => _i181.PlaylistCacheBloc(
          cachePlaylistUseCase: gh<_i167.CachePlaylistUseCase>(),
          getPlaylistCacheStatusUseCase:
              gh<_i124.GetPlaylistCacheStatusUseCase>(),
          removePlaylistCacheUseCase: gh<_i132.RemovePlaylistCacheUseCase>(),
        ));
    gh.lazySingleton<_i182.ProjectCommentService>(
        () => _i182.ProjectCommentService(gh<_i163.AudioCommentRepository>()));
    gh.lazySingleton<_i183.ProjectTrackService>(() => _i183.ProjectTrackService(
          gh<_i165.AudioTrackRepository>(),
          gh<_i104.AudioStorageRepository>(),
        ));
    gh.factory<_i184.ProjectsBloc>(() => _i184.ProjectsBloc(
          createProject: gh<_i169.CreateProjectUseCase>(),
          updateProject: gh<_i155.UpdateProjectUseCase>(),
          deleteProject: gh<_i172.DeleteProjectUseCase>(),
          watchAllProjects: gh<_i158.WatchAllProjectsUseCase>(),
        ));
    gh.factory<_i185.RestorePlaybackStateUseCase>(
        () => _i185.RestorePlaybackStateUseCase(
              persistenceRepository: gh<_i44.PlaybackPersistenceRepository>(),
              audioTrackRepository: gh<_i165.AudioTrackRepository>(),
              audioStorageRepository: gh<_i104.AudioStorageRepository>(),
              playbackService: gh<_i4.AudioPlaybackService>(),
            ));
    gh.lazySingleton<_i186.SendInvitationUseCase>(
        () => _i186.SendInvitationUseCase(
              invitationRepository: gh<_i80.InvitationRepository>(),
              notificationService: gh<_i37.NotificationService>(),
              findUserByEmail: gh<_i173.FindUserByEmailUseCase>(),
              magicLinkRepository: gh<_i29.MagicLinkRepository>(),
              currentUserService: gh<_i118.CurrentUserService>(),
            ));
    gh.factory<_i187.SessionCleanupService>(() => _i187.SessionCleanupService(
          userProfileRepository: gh<_i156.UserProfileRepository>(),
          projectsRepository: gh<_i150.ProjectsRepository>(),
          audioTrackRepository: gh<_i165.AudioTrackRepository>(),
          audioCommentRepository: gh<_i163.AudioCommentRepository>(),
          invitationRepository: gh<_i80.InvitationRepository>(),
    ...
    gh.factory<_i188.SessionService>(() => _i188.SessionService(
          checkAuthUseCase: gh<_i117.CheckAuthenticationStatusUseCase>(),
          getCurrentUserUseCase: gh<_i122.GetCurrentUserUseCase>(),
          onboardingUseCase: gh<_i130.OnboardingUseCase>(),
          profileUseCase: gh<_i168.CheckProfileCompletenessUseCase>(),
        ));
    gh.lazySingleton<_i189.SignInUseCase>(() => _i189.SignInUseCase(
          gh<_i109.AuthRepository>(),
          gh<_i156.UserProfileRepository>(),
        ));
    gh.factory<_i190.SyncStatusCubit>(() => _i190.SyncStatusCubit(
          gh<_i145.SyncStatusProvider>(),
          gh<_i87.PendingOperationsManager>(),
          gh<_i153.TriggerUpstreamSyncUseCase>(),
        ));
    gh.factory<_i191.UpdateUserProfileUseCase>(
        () => _i191.UpdateUserProfileUseCase(
              gh<_i156.UserProfileRepository>(),
              gh<_i91.SessionStorage>(),
            ));
    gh.lazySingleton<_i192.UploadAudioTrackUseCase>(
        () => _i192.UploadAudioTrackUseCase(
              gh<_i183.ProjectTrackService>(),
              gh<_i150.ProjectsRepository>(),
              gh<_i91.SessionStorage>(),
            ));
    gh.factory<_i193.UserProfileBloc>(() => _i193.UserProfileBloc(
          updateUserProfileUseCase: gh<_i191.UpdateUserProfileUseCase>(),
          createUserProfileUseCase: gh<_i170.CreateUserProfileUseCase>(),
          watchUserProfileUseCase: gh<_i160.WatchUserProfileUseCase>(),
          checkProfileCompletenessUseCase:
              gh<_i168.CheckProfileCompletenessUseCase>(),
          getCurrentUserUseCase: gh<_i122.GetCurrentUserUseCase>(),
        ));
    gh.lazySingleton<_i194.WatchAudioCommentsBundleUseCase>(
        () => _i194.WatchAudioCommentsBundleUseCase(
              gh<_i165.AudioTrackRepository>(),
              gh<_i163.AudioCommentRepository>(),
              gh<_i96.UserProfileCacheRepository>(),
            ));
    gh.lazySingleton<_i195.WatchProjectDetailUseCase>(
        () => _i195.WatchProjectDetailUseCase(
              gh<_i150.ProjectsRepository>(),
              gh<_i165.AudioTrackRepository>(),
              gh<_i96.UserProfileCacheRepository>(),
            ));
    gh.lazySingleton<_i196.WatchTracksByProjectIdUseCase>(() =>
        _i196.WatchTracksByProjectIdUseCase(gh<_i165.AudioTrackRepository>()));
    gh.lazySingleton<_i197.AddAudioCommentUseCase>(
        () => _i197.AddAudioCommentUseCase(
              gh<_i182.ProjectCommentService>(),
              gh<_i150.ProjectsRepository>(),
              gh<_i91.SessionStorage>(),
            ));
    gh.lazySingleton<_i198.AddCollaboratorByEmailUseCase>(
        () => _i198.AddCollaboratorByEmailUseCase(
              gh<_i173.FindUserByEmailUseCase>(),
              gh<_i162.AddCollaboratorToProjectUseCase>(),
              gh<_i37.NotificationService>(),
            ));
    gh.factory<_i199.AppBootstrap>(() => _i199.AppBootstrap(
          sessionService: gh<_i188.SessionService>(),
    ...
    gh.factory<_i200.AppFlowBloc>(() => _i200.AppFlowBloc(
          ...
          backgroundSyncCoordinator: gh<_i147.BackgroundSyncCoordinator>(),
          getAuthStateUseCase: gh<_i120.GetAuthStateUseCase>(),
          sessionCleanupService: gh<_i187.SessionCleanupService>(),
        ));
    gh.lazySingleton<_i201.AudioContextService>(
        () => _i202.AudioContextServiceImpl(
              userProfileRepository: gh<_i156.UserProfileRepository>(),
              audioTrackRepository: gh<_i165.AudioTrackRepository>(),
              projectsRepository: gh<_i150.ProjectsRepository>(),
            ));
    gh.factory<_i203.AudioPlayerService>(() => _i203.AudioPlayerService(
          initializeAudioPlayerUseCase: gh<_i23.InitializeAudioPlayerUseCase>(),
          playAudioUseCase: gh<_i179.PlayAudioUseCase>(),
          playPlaylistUseCase: gh<_i180.PlayPlaylistUseCase>(),
          ...
          restorePlaybackStateUseCase: gh<_i185.RestorePlaybackStateUseCase>(),
          playbackService: gh<_i4.AudioPlaybackService>(),
        ));
    gh.factory<_i204.AuthBloc>(() => _i204.AuthBloc(
          signIn: gh<_i189.SignInUseCase>(),
          signUp: gh<_i135.SignUpUseCase>(),
          googleSignIn: gh<_i175.GoogleSignInUseCase>(),
          signOut: gh<_i134.SignOutUseCase>(),
        ));
    gh.lazySingleton<_i205.DeleteAudioCommentUseCase>(
        () => _i205.DeleteAudioCommentUseCase(
              gh<_i182.ProjectCommentService>(),
              gh<_i150.ProjectsRepository>(),
              gh<_i91.SessionStorage>(),
            ));
    gh.lazySingleton<_i206.DeleteAudioTrack>(() => _i206.DeleteAudioTrack(
          gh<_i91.SessionStorage>(),
          gh<_i150.ProjectsRepository>(),
          gh<_i183.ProjectTrackService>(),
        ));
    gh.lazySingleton<_i207.EditAudioTrackUseCase>(
        () => _i207.EditAudioTrackUseCase(
              gh<_i183.ProjectTrackService>(),
              gh<_i150.ProjectsRepository>(),
            ));
    gh.factory<_i208.LoadTrackContextUseCase>(
        () => _i208.LoadTrackContextUseCase(gh<_i201.AudioContextService>()));
    gh.factory<_i209.ManageCollaboratorsBloc>(
        () => _i209.ManageCollaboratorsBloc(
              removeCollaboratorUseCase: gh<_i152.RemoveCollaboratorUseCase>(),
              updateCollaboratorRoleUseCase:
                  gh<_i154.UpdateCollaboratorRoleUseCase>(),
              leaveProjectUseCase: gh<_i177.LeaveProjectUseCase>(),
              findUserByEmailUseCase: gh<_i173.FindUserByEmailUseCase>(),
              addCollaboratorByEmailUseCase:
                  gh<_i198.AddCollaboratorByEmailUseCase>(),
              watchCollaboratorsBundleUseCase:
                  gh<_i159.WatchCollaboratorsBundleUseCase>(),
            ));
    gh.factory<_i210.ProjectDetailBloc>(() => _i210.ProjectDetailBloc(
        watchProjectDetail: gh<_i195.WatchProjectDetailUseCase>()));
    gh.factory<_i211.ProjectInvitationActorBloc>(
        () => _i211.ProjectInvitationActorBloc(
              sendInvitationUseCase: gh<_i186.SendInvitationUseCase>(),
              acceptInvitationUseCase: gh<_i161.AcceptInvitationUseCase>(),
              declineInvitationUseCase: gh<_i171.DeclineInvitationUseCase>(),
              cancelInvitationUseCase: gh<_i116.CancelInvitationUseCase>(),
              findUserByEmailUseCase: gh<_i173.FindUserByEmailUseCase>(),
            ));
    gh.factory<_i212.AudioCommentBloc>(() => _i212.AudioCommentBloc(
          addAudioCommentUseCase: gh<_i197.AddAudioCommentUseCase>(),
          deleteAudioCommentUseCase: gh<_i205.DeleteAudioCommentUseCase>(),
          watchAudioCommentsBundleUseCase:
              gh<_i194.WatchAudioCommentsBundleUseCase>(),
        ));
    gh.factory<_i213.AudioContextBloc>(() => _i213.AudioContextBloc(
        loadTrackContextUseCase: gh<_i208.LoadTrackContextUseCase>()));
    gh.factory<_i214.AudioPlayerBloc>(() => _i214.AudioPlayerBloc(
        audioPlayerService: gh<_i203.AudioPlayerService>()));
    gh.factory<_i215.AudioTrackBloc>(() => _i215.AudioTrackBloc(
          watchAudioTracksByProject: gh<_i196.WatchTracksByProjectIdUseCase>(),
          deleteAudioTrack: gh<_i206.DeleteAudioTrack>(),
          uploadAudioTrackUseCase: gh<_i192.UploadAudioTrackUseCase>(),
          editAudioTrackUseCase: gh<_i207.EditAudioTrackUseCase>(),
        ));
    return this;
  }
}
