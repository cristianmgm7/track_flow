...
import 'package:trackflow/core/app/startup_resource_manager.dart' as _i142;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i100.AudioSourceResolver>(() => _i101.AudioSourceResolverImpl(
          gh<_i64.GetCachedAudioPath>(),
          gh<_i40.AudioCacheRepository>(),
          gh<_i71.OfflineModeService>(),
        ));
    gh.lazySingleton<_i102.AuthRepository>(() => _i103.AuthRepositoryImpl(
    ...
    gh.lazySingleton<_i104.CacheOrchestrationService>(
        () => _i105.CacheOrchestrationServiceImpl(
              metadataRepository: gh<_i53.CacheMetadataRepository>(),
              storageRepository: gh<_i56.CacheStorageRepository>(),
            ));
    gh.factory<_i106.CachePlaylistUseCase>(() =>
        _i106.CachePlaylistUseCase(gh<_i104.CacheOrchestrationService>()));
    gh.factory<_i107.CacheTrackUseCase>(
        () => _i107.CacheTrackUseCase(gh<_i104.CacheOrchestrationService>()));
    gh.factory<_i108.CheckCacheStatusUseCase>(
        () => _i108.CheckCacheStatusUseCase(gh<_i100.AudioSourceResolver>()));
    gh.factory<_i109.CleanupCacheUseCase>(
        () => _i109.CleanupCacheUseCase(gh<_i104.CacheOrchestrationService>()));
    gh.lazySingleton<_i110.CreateProjectUseCase>(
        () => _i110.CreateProjectUseCase(
              gh<_i25.ProjectsRepository>(),
              gh<_i80.SessionStorage>(),
            ));
    gh.lazySingleton<_i111.DeleteAudioCommentUseCase>(
        () => _i111.DeleteAudioCommentUseCase(
              gh<_i76.ProjectCommentService>(),
              gh<_i21.ProjectDetailRepository>(),
              gh<_i80.SessionStorage>(),
            ));
    gh.lazySingleton<_i112.DeleteAudioTrack>(() => _i112.DeleteAudioTrack(
          gh<_i80.SessionStorage>(),
          gh<_i21.ProjectDetailRepository>(),
          gh<_i77.ProjectTrackService>(),
        ));
    gh.lazySingleton<_i113.DeleteProjectUseCase>(
        () => _i113.DeleteProjectUseCase(
              gh<_i25.ProjectsRepository>(),
              gh<_i80.SessionStorage>(),
            ));
    gh.factory<_i114.DownloadManagementService>(
        () => _i115.DownloadManagementServiceImpl(
              gh<_i40.AudioCacheRepository>(),
              gh<_i64.GetCachedAudioPath>(),
            ));
    gh.factory<_i116.DownloadTrackManagedUseCase>(() =>
        _i116.DownloadTrackManagedUseCase(
            gh<_i114.DownloadManagementService>()));
    gh.lazySingleton<_i117.EditAudioTrackUseCase>(
        () => _i117.EditAudioTrackUseCase(
              gh<_i77.ProjectTrackService>(),
              gh<_i21.ProjectDetailRepository>(),
            ));
    ...
    gh.lazySingleton<_i119.GetAuthStateUseCase>(
        () => _i119.GetAuthStateUseCase(gh<_i102.AuthRepository>()));
    gh.factory<_i120.GetCacheStorageStatsUseCase>(() =>
        _i120.GetCacheStorageStatsUseCase(
            gh<_i104.CacheOrchestrationService>()));
    gh.factory<_i121.GetDownloadProgressUseCase>(() =>
        _i121.GetDownloadProgressUseCase(
            gh<_i114.DownloadManagementService>()));
    gh.factory<_i122.GetPlaylistCacheStatusUseCase>(() =>
        _i122.GetPlaylistCacheStatusUseCase(
            gh<_i104.CacheOrchestrationService>()));
    gh.factory<_i123.GetTrackCacheStatusUseCase>(() =>
        _i123.GetTrackCacheStatusUseCase(
            gh<_i104.CacheOrchestrationService>()));
    gh.lazySingleton<_i124.GoogleSignInUseCase>(
        () => _i124.GoogleSignInUseCase(gh<_i102.AuthRepository>()));
    gh.lazySingleton<_i125.JoinProjectWithIdUseCase>(
        () => _i125.JoinProjectWithIdUseCase(
              gh<_i21.ProjectDetailRepository>(),
              gh<_i69.ManageCollaboratorsRepository>(),
              gh<_i80.SessionStorage>(),
            ));
    gh.lazySingleton<_i126.LeaveProjectUseCase>(() => _i126.LeaveProjectUseCase(
          gh<_i69.ManageCollaboratorsRepository>(),
          gh<_i80.SessionStorage>(),
        ));
    gh.factory<_i127.MagicLinkBloc>(() => _i127.MagicLinkBloc(
          ...
          joinProjectWithId: gh<_i125.JoinProjectWithIdUseCase>(),
          authRepository: gh<_i102.AuthRepository>(),
        ));
    gh.lazySingleton<_i128.OnboardingUseCase>(
        () => _i128.OnboardingUseCase(gh<_i102.AuthRepository>()));
    gh.lazySingleton<_i129.PlayAudioUseCase>(() => _i129.PlayAudioUseCase(
          gh<_i18.PlaybackService>(),
          gh<_i35.UserProfileRepository>(),
          gh<_i100.AudioSourceResolver>(),
        ));
    gh.lazySingleton<_i130.PlayPlaylistUseCase>(() => _i130.PlayPlaylistUseCase(
          gh<_i18.PlaybackService>(),
          gh<_i48.AudioTrackRepository>(),
          gh<_i35.UserProfileRepository>(),
          gh<_i100.AudioSourceResolver>(),
        ));
    gh.factory<_i131.ProjectDetailBloc>(() => _i131.ProjectDetailBloc(
        watchProjectDetail: gh<_i95.WatchProjectDetailUseCase>()));
    gh.factory<_i132.ProjectsBloc>(() => _i132.ProjectsBloc(
          createProject: gh<_i110.CreateProjectUseCase>(),
          updateProject: gh<_i90.UpdateProjectUseCase>(),
          deleteProject: gh<_i113.DeleteProjectUseCase>(),
    ...
    gh.factory<_i134.RemoveFromCacheUseCase>(() =>
        _i134.RemoveFromCacheUseCase(gh<_i82.StorageManagementService>()));
    gh.factory<_i135.RemovePlaylistCacheUseCase>(() =>
        _i135.RemovePlaylistCacheUseCase(
            gh<_i104.CacheOrchestrationService>()));
    gh.factory<_i136.RemoveTrackCacheUseCase>(() =>
        _i136.RemoveTrackCacheUseCase(gh<_i104.CacheOrchestrationService>()));
    gh.lazySingleton<_i137.SignInUseCase>(
        () => _i137.SignInUseCase(gh<_i102.AuthRepository>()));
    gh.lazySingleton<_i138.SignOutUseCase>(
        () => _i138.SignOutUseCase(gh<_i102.AuthRepository>()));
    gh.lazySingleton<_i139.SignUpUseCase>(
        () => _i139.SignUpUseCase(gh<_i102.AuthRepository>()));
    gh.lazySingleton<_i140.SkipToNextUseCase>(() => _i140.SkipToNextUseCase(
          gh<_i18.PlaybackService>(),
          gh<_i48.AudioTrackRepository>(),
          gh<_i35.UserProfileRepository>(),
          gh<_i100.AudioSourceResolver>(),
        ));
    gh.lazySingleton<_i141.SkipToPreviousUseCase>(
        () => _i141.SkipToPreviousUseCase(
              gh<_i18.PlaybackService>(),
              gh<_i48.AudioTrackRepository>(),
              gh<_i35.UserProfileRepository>(),
              gh<_i100.AudioSourceResolver>(),
            ));
    gh.lazySingleton<_i142.StartupResourceManager>(
        () => _i142.StartupResourceManager(
    ...
    gh.factory<_i143.TrackCacheBloc>(() => _i143.TrackCacheBloc(
          gh<_i107.CacheTrackUseCase>(),
          gh<_i123.GetTrackCacheStatusUseCase>(),
          gh<_i136.RemoveTrackCacheUseCase>(),
        ));
    ...
    gh.lazySingleton<_i145.AddCollaboratorAndSyncProfileService>(
        () => _i145.AddCollaboratorAndSyncProfileService(
              gh<_i99.AddCollaboratorToProjectUseCase>(),
              gh<_i35.UserProfileRepository>(),
            ));
    gh.factory<_i146.AudioCommentBloc>(() => _i146.AudioCommentBloc(
          watchCommentsByTrackUseCase: gh<_i94.WatchCommentsByTrackUseCase>(),
          addAudioCommentUseCase: gh<_i98.AddAudioCommentUseCase>(),
          deleteAudioCommentUseCase: gh<_i111.DeleteAudioCommentUseCase>(),
        ));
    gh.factory<_i147.AudioPlayerBloc>(() => _i147.AudioPlayerBloc(
          gh<_i18.PlaybackService>(),
          gh<_i129.PlayAudioUseCase>(),
          gh<_i73.PauseAudioUseCase>(),
          gh<_i28.ResumeAudioUseCase>(),
          gh<_i81.StopAudioUseCase>(),
          gh<_i130.PlayPlaylistUseCase>(),
          gh<_i140.SkipToNextUseCase>(),
          gh<_i141.SkipToPreviousUseCase>(),
    ...
    gh.factory<_i148.AudioTrackBloc>(() => _i148.AudioTrackBloc(
          watchAudioTracksByProject: gh<_i96.WatchTracksByProjectIdUseCase>(),
          deleteAudioTrack: gh<_i112.DeleteAudioTrack>(),
          uploadAudioTrackUseCase: gh<_i92.UploadAudioTrackUseCase>(),
          editAudioTrackUseCase: gh<_i117.EditAudioTrackUseCase>(),
        ));
    gh.factory<_i149.AuthBloc>(() => _i149.AuthBloc(
          signIn: gh<_i137.SignInUseCase>(),
          signUp: gh<_i139.SignUpUseCase>(),
          signOut: gh<_i138.SignOutUseCase>(),
          googleSignIn: gh<_i124.GoogleSignInUseCase>(),
          getAuthState: gh<_i119.GetAuthStateUseCase>(),
          onboarding: gh<_i128.OnboardingUseCase>(),
        ));
    gh.factory<_i150.CancelDownloadUseCase>(() =>
        _i150.CancelDownloadUseCase(gh<_i114.DownloadManagementService>()));
    gh.factory<_i151.ManageCollaboratorsBloc>(
        () => _i151.ManageCollaboratorsBloc(
              addCollaboratorAndSyncProfileService:
                  gh<_i145.AddCollaboratorAndSyncProfileService>(),
              removeCollaboratorUseCase: gh<_i133.RemoveCollaboratorUseCase>(),
              updateCollaboratorRoleUseCase:
                  gh<_i89.UpdateCollaboratorRoleUseCase>(),
              leaveProjectUseCase: gh<_i126.LeaveProjectUseCase>(),
              watchUserProfilesUseCase: gh<_i38.WatchUserProfilesUseCase>(),
            ));
    gh.factory<_i152.PlaylistCacheBloc>(() => _i152.PlaylistCacheBloc(
          gh<_i106.CachePlaylistUseCase>(),
          gh<_i122.GetPlaylistCacheStatusUseCase>(),
          gh<_i135.RemovePlaylistCacheUseCase>(),
        ));
    gh.factory<_i153.AudioCacheBloc>(() => _i153.AudioCacheBloc(
          gh<_i59.DownloadTrackUseCase>(),
          gh<_i116.DownloadTrackManagedUseCase>(),
          gh<_i150.CancelDownloadUseCase>(),
          gh<_i134.RemoveFromCacheUseCase>(),
          gh<_i108.CheckCacheStatusUseCase>(),
          gh<_i121.GetDownloadProgressUseCase>(),
        ));
    return this;
  }
}
