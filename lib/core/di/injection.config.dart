...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i167.FindUserByEmailUseCase>(
        () => _i167.FindUserByEmailUseCase(gh<_i152.UserProfileRepository>()));
    gh.lazySingleton<_i168.GetProjectByIdUseCase>(
        () => _i168.GetProjectByIdUseCase(gh<_i147.ProjectsRepository>()));
    ...
    gh.factory<_i178.ProjectsBloc>(() => _i178.ProjectsBloc(
          ...
          syncStatusProvider: gh<_i142.SyncStatusProvider>(),
        ));
    ...
    gh.lazySingleton<_i184.SignOutUseCase>(() => _i184.SignOutUseCase(
          gh<_i107.AuthRepository>(),
          gh<_i181.SessionCleanupService>(),
        ));
    ...
    gh.lazySingleton<_i188.WatchCommentsByTrackUseCase>(() =>
        _i188.WatchCommentsByTrackUseCase(gh<_i176.ProjectCommentService>()));
    ...
    gh.factory<_i197.AuthBloc>(() => _i197.AuthBloc(
          ...
          signOut: gh<_i184.SignOutUseCase>(),
        ));
    ...
    gh.factory<_i202.ManageCollaboratorsBloc>(() =>
        _i202.ManageCollaboratorsBloc(
          addCollaboratorUseCase: gh<_i157.AddCollaboratorToProjectUseCase>(),
