...
import 'package:trackflow/core/coordination/startup_resource_manager.dart'
    as _i150;
import 'package:trackflow/core/coordination/sync_state_manager.dart' as _i151;
import 'package:trackflow/core/di/app_module.dart' as _i157;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i97.AuthUseCase>(
        () => _i97.AuthUseCase(gh<_i95.AuthRepository>()));
    ...
    gh.factory<_i104.CheckAuthenticationStatusUseCase>(() =>
        _i104.CheckAuthenticationStatusUseCase(gh<_i95.AuthRepository>()));
    gh.lazySingleton<_i105.CreateProjectUseCase>(
        () => _i105.CreateProjectUseCase(
              gh<_i35.ProjectsRepository>(),
              gh<_i71.SessionStorage>(),
            ));
    gh.lazySingleton<_i106.DeleteAudioCommentUseCase>(
        () => _i106.DeleteAudioCommentUseCase(
              gh<_i70.ProjectCommentService>(),
              gh<_i35.ProjectsRepository>(),
              gh<_i71.SessionStorage>(),
            ));
    ...
    gh.lazySingleton<_i109.GetAuthStateUseCase>(
        () => _i109.GetAuthStateUseCase(gh<_i95.AuthRepository>()));
    gh.factory<_i110.GetCachedTrackPathUseCase>(() =>
        _i110.GetCachedTrackPathUseCase(gh<_i93.AudioStorageRepository>()));
    gh.factory<_i111.GetCurrentUserIdUseCase>(
        () => _i111.GetCurrentUserIdUseCase(gh<_i95.AuthRepository>()));
    gh.factory<_i112.GetCurrentUserUseCase>(
        () => _i112.GetCurrentUserUseCase(gh<_i95.AuthRepository>()));
    gh.factory<_i113.GetPlaylistCacheStatusUseCase>(() =>
        _i113.GetPlaylistCacheStatusUseCase(gh<_i93.AudioStorageRepository>()));
    gh.lazySingleton<_i114.GoogleSignInUseCase>(() => _i114.GoogleSignInUseCase(
          gh<_i95.AuthRepository>(),
          gh<_i51.UserProfileRepository>(),
        ));
    ...
    gh.lazySingleton<_i116.LeaveProjectUseCase>(() => _i116.LeaveProjectUseCase(
          gh<_i35.ProjectsRepository>(),
          gh<_i71.SessionStorage>(),
        ));
    gh.factory<_i117.LoadTrackContextUseCase>(
        () => _i117.LoadTrackContextUseCase(gh<_i89.AudioContextService>()));
    gh.factory<_i118.MagicLinkBloc>(() => _i118.MagicLinkBloc(
    ...
    gh.lazySingleton<_i121.OnboardingUseCase>(
        () => _i121.OnboardingUseCase(gh<_i119.OnboardingRepository>()));
    gh.factory<_i122.PlayAudioUseCase>(() => _i122.PlayAudioUseCase(
          audioTrackRepository: gh<_i60.AudioTrackRepository>(),
          audioStorageRepository: gh<_i93.AudioStorageRepository>(),
          playbackService: gh<_i3.AudioPlaybackService>(),
        ));
    gh.factory<_i123.PlayPlaylistUseCase>(() => _i123.PlayPlaylistUseCase(
    ...
    gh.lazySingleton<_i125.ProjectTrackService>(() => _i125.ProjectTrackService(
          gh<_i60.AudioTrackRepository>(),
          gh<_i93.AudioStorageRepository>(),
        ));
    gh.factory<_i126.ProjectsBloc>(() => _i126.ProjectsBloc(
          createProject: gh<_i105.CreateProjectUseCase>(),
    ...
    gh.factory<_i128.RemovePlaylistCacheUseCase>(() =>
        _i128.RemovePlaylistCacheUseCase(gh<_i93.AudioStorageRepository>()));
    gh.factory<_i129.RemoveTrackCacheUseCase>(
        () => _i129.RemoveTrackCacheUseCase(gh<_i93.AudioStorageRepository>()));
    ...
    gh.lazySingleton<_i131.SignInUseCase>(() => _i131.SignInUseCase(
          gh<_i95.AuthRepository>(),
          gh<_i51.UserProfileRepository>(),
        ));
    gh.lazySingleton<_i132.SignOutUseCase>(() => _i132.SignOutUseCase(
          gh<_i95.AuthRepository>(),
          gh<_i51.UserProfileRepository>(),
        ));
    gh.lazySingleton<_i133.SignUpUseCase>(
        () => _i133.SignUpUseCase(gh<_i95.AuthRepository>()));
    ...
    gh.factory<_i137.WatchTrackCacheStatusUseCase>(() =>
        _i137.WatchTrackCacheStatusUseCase(gh<_i93.AudioStorageRepository>()));
    gh.factory<_i138.AudioCommentBloc>(() => _i138.AudioCommentBloc(
          ...
          deleteAudioCommentUseCase: gh<_i106.DeleteAudioCommentUseCase>(),
          watchUserProfilesUseCase: gh<_i86.WatchUserProfilesUseCase>(),
        ));
    gh.factory<_i139.AudioContextBloc>(() => _i139.AudioContextBloc(
    ...
    gh.factory<_i143.AudioWaveformBloc>(() => _i143.AudioWaveformBloc(
          audioPlaybackService: gh<_i3.AudioPlaybackService>(),
          getCachedTrackPathUseCase: gh<_i110.GetCachedTrackPathUseCase>(),
        ));
    ...
    gh.factory<_i147.ManageCollaboratorsBloc>(() =>
        _i147.ManageCollaboratorsBloc(
    ...
    gh.factory<_i148.OnboardingBloc>(() => _i148.OnboardingBloc(
          onboardingUseCase: gh<_i121.OnboardingUseCase>(),
    ...
    gh.lazySingleton<_i151.SyncStateManager>(
        () => _i151.SyncStateManager(gh<_i150.StartupResourceManager>()));
    gh.factory<_i152.TrackCacheBloc>(() => _i152.TrackCacheBloc(
    ...
    gh.factory<_i153.AppSessionService>(() => _i153.AppSessionService(
          checkAuthUseCase: gh<_i104.CheckAuthenticationStatusUseCase>(),
          getCurrentUserUseCase: gh<_i112.GetCurrentUserUseCase>(),
          onboardingUseCase: gh<_i121.OnboardingUseCase>(),
          profileUseCase: gh<_i65.CheckProfileCompletenessUseCase>(),
          signOutUseCase: gh<_i132.SignOutUseCase>(),
          syncStateManager: gh<_i151.SyncStateManager>(),
        ));
    gh.factory<_i154.AudioPlayerBloc>(() => _i154.AudioPlayerBloc(
        audioPlayerService: gh<_i140.AudioPlayerService>()));
    gh.factory<_i155.AudioTrackBloc>(() => _i155.AudioTrackBloc(
    ...
    gh.factory<_i156.AppFlowBloc>(
        () => _i156.AppFlowBloc(sessionService: gh<_i153.AppSessionService>()));
    return this;
  }
}
