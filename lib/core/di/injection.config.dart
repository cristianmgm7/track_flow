...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i21.IncrementalSyncService<_i89.UserProfileDTO>>(
        () => _i90.UserProfileIncrementalSyncService(
    ...
    gh.lazySingleton<_i21.IncrementalSyncService<_i95.AudioTrackDTO>>(
        () => _i96.AudioTrackIncrementalSyncService(
              gh<_i80.AudioTrackRemoteDataSource>(),
              gh<_i79.AudioTrackLocalDataSource>(),
              gh<_i49.ProjectsLocalDataSource>(),
            ));
    gh.lazySingleton<_i97.InvitationLocalDataSource>(
        () => _i97.IsarInvitationLocalDataSource(gh<_i27.Isar>()));
    ...
    gh.factory<_i100.MarkAsUnreadUseCase>(
        () => _i100.MarkAsUnreadUseCase(gh<_i36.NotificationRepository>()));
    gh.lazySingleton<_i101.MarkNotificationAsReadUseCase>(() =>
        _i101.MarkNotificationAsReadUseCase(gh<_i36.NotificationRepository>()));
    ...
    gh.lazySingleton<_i104.OnboardingStateLocalDataSource>(() =>
        _i104.OnboardingStateLocalDataSourceImpl(gh<_i58.SharedPreferences>()));
    ...
    gh.factory<_i106.PlaylistOperationExecutor>(() =>
        _i106.PlaylistOperationExecutor(gh<_i47.PlaylistRemoteDataSource>()));
    gh.factory<_i107.ProjectOperationExecutor>(() =>
        _i107.ProjectOperationExecutor(gh<_i48.ProjectRemoteDataSource>()));
    ...
    gh.lazySingleton<_i109.SessionStorage>(
        () => _i109.SessionStorageImpl(prefs: gh<_i58.SharedPreferences>()));
    ...
    gh.lazySingleton<_i113.UserProfileCollaboratorIncrementalSyncService>(
        () => _i113.UserProfileCollaboratorIncrementalSyncService(
              gh<_i70.UserProfileRemoteDataSource>(),
              gh<_i69.UserProfileLocalDataSource>(),
              gh<_i49.ProjectsLocalDataSource>(),
            ));
    gh.factory<_i114.UserProfileOperationExecutor>(() =>
        _i114.UserProfileOperationExecutor(
            gh<_i70.UserProfileRemoteDataSource>()));
    gh.lazySingleton<_i115.WatchTrackUploadStatusUseCase>(() =>
        _i115.WatchTrackUploadStatusUseCase(
            gh<_i105.PendingOperationsManager>()));
    gh.lazySingleton<_i116.WatchUserProfilesUseCase>(() =>
        _i116.WatchUserProfilesUseCase(gh<_i111.UserProfileCacheRepository>()));
    gh.lazySingleton<_i117.WaveformIncrementalSyncService>(
        () => _i117.WaveformIncrementalSyncService(
              gh<_i68.TrackVersionLocalDataSource>(),
    ...
    gh.factory<_i156.TrackUploadStatusCubit>(() => _i156.TrackUploadStatusCubit(
        gh<_i115.WatchTrackUploadStatusUseCase>()));
    ...
    gh.lazySingleton<_i167.WatchCollaboratorsBundleUseCase>(
        () => _i167.WatchCollaboratorsBundleUseCase(
              gh<_i150.ProjectsRepository>(),
              gh<_i116.WatchUserProfilesUseCase>(),
            ));
    ...
    gh.factory<_i254.AudioCommentBloc>(() => _i254.AudioCommentBloc(
          ...
          getCachedAudioCommentUseCase:
              gh<_i137.GetCachedAudioCommentUseCase>(),
        ));
