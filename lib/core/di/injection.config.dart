...
import 'package:trackflow/core/app_flow/data/session_storage.dart' as _i81;
...
import 'package:trackflow/core/app_flow/presentation/bloc/app_flow_bloc.dart'
    as _i186;
import 'package:trackflow/core/di/app_module.dart' as _i193;
...
import 'package:trackflow/core/notifications/domain/usecases/observe_notifications_usecase.dart'
    as _i33;
import 'package:trackflow/core/services/database_health_monitor.dart' as _i68;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i17.GetUnreadNotificationsCountUseCase>(() =>
        _i17.GetUnreadNotificationsCountUseCase(
    ...
    gh.lazySingleton<_i22.InvitationRemoteDataSource>(() =>
        _i22.FirestoreInvitationRemoteDataSource(gh<_i14.FirebaseFirestore>()));
    ...
    gh.lazySingleton<_i28.MarkAllNotificationsAsReadUseCase>(() =>
        _i28.MarkAllNotificationsAsReadUseCase(
            gh<_i18.NotificationRepository>()));
    gh.lazySingleton<_i29.MarkNotificationAsReadUseCase>(() =>
        _i29.MarkNotificationAsReadUseCase(gh<_i18.NotificationRepository>()));
    ...
    gh.lazySingleton<_i32.NotificationService>(
        () => _i32.NotificationService(gh<_i18.NotificationRepository>()));
    gh.lazySingleton<_i33.ObserveNotificationsUseCase>(() =>
        _i33.ObserveNotificationsUseCase(gh<_i18.NotificationRepository>()));
    ...
    gh.lazySingleton<_i36.PendingOperationsLocalDataSource>(
        () => _i36.IsarPendingOperationsLocalDataSource(gh<_i23.Isar>()));
    ...
    gh.lazySingleton<_i41.PlaylistLocalDataSource>(
        () => _i41.PlaylistLocalDataSourceImpl(gh<_i23.Isar>()));
    ...
    gh.lazySingleton<_i44.ProjectsLocalDataSource>(
        () => _i44.ProjectsLocalDataSourceImpl(gh<_i23.Isar>()));
    gh.lazySingleton<_i45.ResendMagicLinkUseCase>(
        () => _i45.ResendMagicLinkUseCase(gh<_i26.MagicLinkRepository>()));
    ...
    gh.lazySingleton<_i58.UserProfileLocalDataSource>(
        () => _i58.IsarUserProfileLocalDataSource(gh<_i23.Isar>()));
    ...
    gh.lazySingleton<_i60.ValidateMagicLinkUseCase>(
        () => _i60.ValidateMagicLinkUseCase(gh<_i26.MagicLinkRepository>()));
    gh.lazySingleton<_i61.AudioCommentLocalDataSource>(
        () => _i61.IsarAudioCommentLocalDataSource(gh<_i23.Isar>()));
    ...
    gh.lazySingleton<_i63.AudioTrackLocalDataSource>(
        () => _i63.IsarAudioTrackLocalDataSource(gh<_i23.Isar>()));
    ...
    gh.lazySingleton<_i65.CacheStorageLocalDataSource>(
        () => _i65.CacheStorageLocalDataSourceImpl(gh<_i23.Isar>()));
    ...
    gh.lazySingleton<_i67.ConsumeMagicLinkUseCase>(
        () => _i67.ConsumeMagicLinkUseCase(gh<_i26.MagicLinkRepository>()));
    gh.factory<_i68.DatabaseHealthMonitor>(
        () => _i68.DatabaseHealthMonitor(gh<_i23.Isar>()));
    gh.lazySingleton<_i69.GetMagicLinkStatusUseCase>(
        () => _i69.GetMagicLinkStatusUseCase(gh<_i26.MagicLinkRepository>()));
    gh.lazySingleton<_i70.GoogleAuthService>(() => _i70.GoogleAuthService(
          gh<_i19.GoogleSignIn>(),
          gh<_i13.FirebaseAuth>(),
        ));
    gh.lazySingleton<_i71.InvitationLocalDataSource>(
        () => _i71.IsarInvitationLocalDataSource(gh<_i23.Isar>()));
    gh.lazySingleton<_i72.InvitationRepository>(
        () => _i73.InvitationRepositoryImpl(
              localDataSource: gh<_i71.InvitationLocalDataSource>(),
              remoteDataSource: gh<_i22.InvitationRemoteDataSource>(),
              networkStateManager: gh<_i31.NetworkStateManager>(),
            ));
    gh.lazySingleton<_i74.ObservePendingInvitationsUseCase>(() =>
        _i74.ObservePendingInvitationsUseCase(gh<_i72.InvitationRepository>()));
    gh.lazySingleton<_i75.ObserveSentInvitationsUseCase>(() =>
        _i75.ObserveSentInvitationsUseCase(gh<_i72.InvitationRepository>()));
    gh.lazySingleton<_i76.OnboardingStateLocalDataSource>(() =>
        _i76.OnboardingStateLocalDataSourceImpl(gh<_i51.SharedPreferences>()));
    gh.lazySingleton<_i77.PendingOperationsManager>(
        () => _i77.PendingOperationsManager(
              gh<_i37.PendingOperationsRepository>(),
              gh<_i31.NetworkStateManager>(),
              gh<_i34.OperationExecutorFactory>(),
            ));
    gh.factory<_i78.PlaylistOperationExecutor>(() =>
        _i78.PlaylistOperationExecutor(gh<_i42.PlaylistRemoteDataSource>()));
    gh.lazySingleton<_i79.ProjectIncrementalSyncService>(
        () => _i79.ProjectIncrementalSyncService(
              gh<_i43.ProjectRemoteDataSource>(),
              gh<_i44.ProjectsLocalDataSource>(),
            ));
    gh.factory<_i80.ProjectOperationExecutor>(() =>
        _i80.ProjectOperationExecutor(gh<_i43.ProjectRemoteDataSource>()));
    gh.lazySingleton<_i81.SessionStorage>(
        () => _i81.SessionStorageImpl(prefs: gh<_i51.SharedPreferences>()));
    ...
    gh.lazySingleton<_i83.SyncProjectsUsingSimpleServiceUseCase>(
        () => _i83.SyncProjectsUsingSimpleServiceUseCase(
              gh<_i79.ProjectIncrementalSyncService>(),
              gh<_i81.SessionStorage>(),
            ));
    ...
    gh.lazySingleton<_i85.UserProfileCacheRepository>(
        () => _i86.UserProfileCacheRepositoryImpl(
              gh<_i59.UserProfileRemoteDataSource>(),
              gh<_i58.UserProfileLocalDataSource>(),
              gh<_i31.NetworkStateManager>(),
            ));
    gh.factory<_i87.UserProfileOperationExecutor>(() =>
        _i87.UserProfileOperationExecutor(
            gh<_i59.UserProfileRemoteDataSource>()));
    ...
    gh.lazySingleton<_i89.WatchUserProfilesUseCase>(() =>
        _i89.WatchUserProfilesUseCase(gh<_i85.UserProfileCacheRepository>()));
    gh.factory<_i90.AudioCommentOperationExecutor>(() =>
        _i90.AudioCommentOperationExecutor(
            gh<_i62.AudioCommentRemoteDataSource>()));
    ...
    gh.lazySingleton<_i95.AudioTrackIncrementalSyncService>(
        () => _i95.AudioTrackIncrementalSyncService(
              gh<_i64.AudioTrackRemoteDataSource>(),
              gh<_i63.AudioTrackLocalDataSource>(),
              gh<_i43.ProjectRemoteDataSource>(),
            ));
    gh.factory<_i96.AudioTrackOperationExecutor>(() =>
        _i96.AudioTrackOperationExecutor(
            gh<_i64.AudioTrackRemoteDataSource>()));
    gh.lazySingleton<_i97.AuthRemoteDataSource>(
        () => _i97.AuthRemoteDataSourceImpl(
              gh<_i13.FirebaseAuth>(),
              gh<_i19.GoogleSignIn>(),
              gh<_i70.GoogleAuthService>(),
            ));
    gh.lazySingleton<_i98.AuthRepository>(() => _i99.AuthRepositoryImpl(
          remote: gh<_i97.AuthRemoteDataSource>(),
          sessionStorage: gh<_i81.SessionStorage>(),
          networkStateManager: gh<_i31.NetworkStateManager>(),
          googleAuthService: gh<_i70.GoogleAuthService>(),
        ));
    gh.lazySingleton<_i100.CacheKeyRepository>(() =>
        _i101.CacheKeyRepositoryImpl(
            localDataSource: gh<_i65.CacheStorageLocalDataSource>()));
    gh.lazySingleton<_i102.CacheMaintenanceRepository>(() =>
        _i103.CacheMaintenanceRepositoryImpl(
            localDataSource: gh<_i65.CacheStorageLocalDataSource>()));
    gh.factory<_i104.CacheTrackUseCase>(() => _i104.CacheTrackUseCase(
          gh<_i91.AudioDownloadRepository>(),
          gh<_i93.AudioStorageRepository>(),
        ));
    gh.lazySingleton<_i105.CancelInvitationUseCase>(
        () => _i105.CancelInvitationUseCase(gh<_i72.InvitationRepository>()));
    gh.factory<_i106.CheckAuthenticationStatusUseCase>(() =>
        _i106.CheckAuthenticationStatusUseCase(gh<_i98.AuthRepository>()));
    ...
    gh.lazySingleton<_i108.GetAuthStateUseCase>(
        () => _i108.GetAuthStateUseCase(gh<_i98.AuthRepository>()));
    ...
    gh.factory<_i110.GetCurrentUserIdUseCase>(
        () => _i110.GetCurrentUserIdUseCase(gh<_i98.AuthRepository>()));
    gh.factory<_i111.GetCurrentUserUseCase>(
        () => _i111.GetCurrentUserUseCase(gh<_i98.AuthRepository>()));
    gh.lazySingleton<_i112.GetPendingInvitationsCountUseCase>(() =>
        _i112.GetPendingInvitationsCountUseCase(
            gh<_i72.InvitationRepository>()));
    gh.factory<_i113.GetPlaylistCacheStatusUseCase>(() =>
        _i113.GetPlaylistCacheStatusUseCase(gh<_i93.AudioStorageRepository>()));
    gh.lazySingleton<_i114.OnboardingRepository>(() =>
        _i115.OnboardingRepositoryImpl(
            gh<_i76.OnboardingStateLocalDataSource>()));
    gh.lazySingleton<_i116.OnboardingUseCase>(
        () => _i116.OnboardingUseCase(gh<_i114.OnboardingRepository>()));
    ...
    gh.factory<_i118.RemovePlaylistCacheUseCase>(() =>
        _i118.RemovePlaylistCacheUseCase(gh<_i93.AudioStorageRepository>()));
    gh.factory<_i119.RemoveTrackCacheUseCase>(
        () => _i119.RemoveTrackCacheUseCase(gh<_i93.AudioStorageRepository>()));
    gh.lazySingleton<_i120.SignUpUseCase>(
        () => _i120.SignUpUseCase(gh<_i98.AuthRepository>()));
    gh.lazySingleton<_i121.SyncAudioTracksUsingSimpleServiceUseCase>(
        () => _i121.SyncAudioTracksUsingSimpleServiceUseCase(
              gh<_i95.AudioTrackIncrementalSyncService>(),
              gh<_i81.SessionStorage>(),
            ));
    gh.lazySingleton<_i122.SyncUserProfileCollaboratorsUseCase>(
        () => _i122.SyncUserProfileCollaboratorsUseCase(
              gh<_i44.ProjectsLocalDataSource>(),
              gh<_i85.UserProfileCacheRepository>(),
            ));
    gh.factory<_i123.WatchTrackCacheStatusUseCase>(() =>
        _i123.WatchTrackCacheStatusUseCase(gh<_i93.AudioStorageRepository>()));
    gh.factory<_i124.AudioSourceResolver>(() => _i125.AudioSourceResolverImpl(
          gh<_i93.AudioStorageRepository>(),
          gh<_i91.AudioDownloadRepository>(),
        ));
    gh.factory<_i126.AudioWaveformBloc>(() => _i126.AudioWaveformBloc(
    ...
    gh.factory<_i127.OnboardingBloc>(() => _i127.OnboardingBloc(
          onboardingUseCase: gh<_i116.OnboardingUseCase>(),
          getCurrentUserIdUseCase: gh<_i110.GetCurrentUserIdUseCase>(),
        ));
    gh.factory<_i128.SyncDataManager>(() => _i128.SyncDataManager(
          syncProjects: gh<_i83.SyncProjectsUsingSimpleServiceUseCase>(),
          syncAudioTracks: gh<_i121.SyncAudioTracksUsingSimpleServiceUseCase>(),
          syncAudioComments: gh<_i82.SyncAudioCommentsUseCase>(),
          syncUserProfile: gh<_i84.SyncUserProfileUseCase>(),
          syncUserProfileCollaborators:
              gh<_i122.SyncUserProfileCollaboratorsUseCase>(),
        ));
    gh.factory<_i129.SyncStatusProvider>(() => _i129.SyncStatusProvider(
          syncDataManager: gh<_i128.SyncDataManager>(),
          pendingOperationsManager: gh<_i77.PendingOperationsManager>(),
        ));
    gh.factory<_i130.TrackCacheBloc>(() => _i130.TrackCacheBloc(
          ...
          watchTrackCacheStatusUseCase:
              gh<_i123.WatchTrackCacheStatusUseCase>(),
          removeTrackCacheUseCase: gh<_i119.RemoveTrackCacheUseCase>(),
          getCachedTrackPathUseCase: gh<_i109.GetCachedTrackPathUseCase>(),
        ));
    gh.lazySingleton<_i131.BackgroundSyncCoordinator>(
        () => _i131.BackgroundSyncCoordinator(
              gh<_i31.NetworkStateManager>(),
              gh<_i128.SyncDataManager>(),
              gh<_i77.PendingOperationsManager>(),
            ));
    gh.lazySingleton<_i132.PlaylistRepository>(
        () => _i133.PlaylistRepositoryImpl(
              localDataSource: gh<_i41.PlaylistLocalDataSource>(),
              backgroundSyncCoordinator: gh<_i131.BackgroundSyncCoordinator>(),
              pendingOperationsManager: gh<_i77.PendingOperationsManager>(),
            ));
    ...
    gh.lazySingleton<_i139.UserProfileRepository>(
        () => _i140.UserProfileRepositoryImpl(
    ...
    gh.lazySingleton<_i142.WatchUserProfileUseCase>(
        () => _i142.WatchUserProfileUseCase(
              gh<_i139.UserProfileRepository>(),
              gh<_i81.SessionStorage>(),
            ));
    gh.lazySingleton<_i143.AcceptInvitationUseCase>(
        () => _i143.AcceptInvitationUseCase(
              invitationRepository: gh<_i72.InvitationRepository>(),
              projectRepository: gh<_i134.ProjectsRepository>(),
              userProfileRepository: gh<_i139.UserProfileRepository>(),
              notificationService: gh<_i32.NotificationService>(),
            ));
    gh.lazySingleton<_i144.AddCollaboratorToProjectUseCase>(
        () => _i144.AddCollaboratorToProjectUseCase(
              gh<_i134.ProjectsRepository>(),
              gh<_i81.SessionStorage>(),
            ));
    gh.lazySingleton<_i145.AudioCommentRepository>(
        () => _i146.AudioCommentRepositoryImpl(
    ...
    gh.lazySingleton<_i147.AudioTrackRepository>(
        () => _i148.AudioTrackRepositoryImpl(
              gh<_i63.AudioTrackLocalDataSource>(),
              gh<_i131.BackgroundSyncCoordinator>(),
              gh<_i77.PendingOperationsManager>(),
            ));
    gh.factory<_i149.CachePlaylistUseCase>(() => _i149.CachePlaylistUseCase(
          gh<_i91.AudioDownloadRepository>(),
          gh<_i147.AudioTrackRepository>(),
        ));
    gh.factory<_i150.CheckProfileCompletenessUseCase>(() =>
        _i150.CheckProfileCompletenessUseCase(
            gh<_i139.UserProfileRepository>()));
    gh.lazySingleton<_i151.CreateProjectUseCase>(
        () => _i151.CreateProjectUseCase(
              gh<_i134.ProjectsRepository>(),
              gh<_i81.SessionStorage>(),
            ));
    gh.lazySingleton<_i152.DeclineInvitationUseCase>(
        () => _i152.DeclineInvitationUseCase(
              invitationRepository: gh<_i72.InvitationRepository>(),
              projectRepository: gh<_i134.ProjectsRepository>(),
              userProfileRepository: gh<_i139.UserProfileRepository>(),
              notificationService: gh<_i32.NotificationService>(),
            ));
    gh.lazySingleton<_i153.DeleteProjectUseCase>(
        () => _i153.DeleteProjectUseCase(
              gh<_i134.ProjectsRepository>(),
              gh<_i81.SessionStorage>(),
            ));
    gh.lazySingleton<_i154.FindUserByEmailUseCase>(
        () => _i154.FindUserByEmailUseCase(gh<_i139.UserProfileRepository>()));
    gh.lazySingleton<_i155.GetProjectByIdUseCase>(
        () => _i155.GetProjectByIdUseCase(gh<_i134.ProjectsRepository>()));
    gh.lazySingleton<_i156.GoogleSignInUseCase>(() => _i156.GoogleSignInUseCase(
          gh<_i98.AuthRepository>(),
          gh<_i139.UserProfileRepository>(),
        ));
    gh.lazySingleton<_i157.JoinProjectWithIdUseCase>(
        () => _i157.JoinProjectWithIdUseCase(
              gh<_i134.ProjectsRepository>(),
              gh<_i81.SessionStorage>(),
            ));
    gh.lazySingleton<_i158.LeaveProjectUseCase>(() => _i158.LeaveProjectUseCase(
          gh<_i134.ProjectsRepository>(),
          gh<_i81.SessionStorage>(),
        ));
    gh.factory<_i159.MagicLinkBloc>(() => _i159.MagicLinkBloc(
          ...
          joinProjectWithId: gh<_i157.JoinProjectWithIdUseCase>(),
          authRepository: gh<_i98.AuthRepository>(),
        ));
    gh.factory<_i160.ManageCollaboratorsBloc>(() =>
        _i160.ManageCollaboratorsBloc(
          addCollaboratorUseCase: gh<_i144.AddCollaboratorToProjectUseCase>(),
          removeCollaboratorUseCase: gh<_i136.RemoveCollaboratorUseCase>(),
          updateCollaboratorRoleUseCase:
              gh<_i137.UpdateCollaboratorRoleUseCase>(),
          leaveProjectUseCase: gh<_i158.LeaveProjectUseCase>(),
          watchUserProfilesUseCase: gh<_i89.WatchUserProfilesUseCase>(),
        ));
    gh.factory<_i161.PlayAudioUseCase>(() => _i161.PlayAudioUseCase(
          audioTrackRepository: gh<_i147.AudioTrackRepository>(),
          audioStorageRepository: gh<_i93.AudioStorageRepository>(),
          playbackService: gh<_i3.AudioPlaybackService>(),
        ));
    gh.factory<_i162.PlayPlaylistUseCase>(() => _i162.PlayPlaylistUseCase(
          playlistRepository: gh<_i132.PlaylistRepository>(),
          audioTrackRepository: gh<_i147.AudioTrackRepository>(),
          playbackService: gh<_i3.AudioPlaybackService>(),
          audioStorageRepository: gh<_i93.AudioStorageRepository>(),
        ));
    gh.factory<_i163.PlaylistCacheBloc>(() => _i163.PlaylistCacheBloc(
          cachePlaylistUseCase: gh<_i149.CachePlaylistUseCase>(),
          getPlaylistCacheStatusUseCase:
              gh<_i113.GetPlaylistCacheStatusUseCase>(),
          removePlaylistCacheUseCase: gh<_i118.RemovePlaylistCacheUseCase>(),
        ));
    gh.lazySingleton<_i164.ProjectCommentService>(
        () => _i164.ProjectCommentService(gh<_i145.AudioCommentRepository>()));
    gh.lazySingleton<_i165.ProjectTrackService>(() => _i165.ProjectTrackService(
          gh<_i147.AudioTrackRepository>(),
          gh<_i93.AudioStorageRepository>(),
        ));
    gh.factory<_i166.ProjectsBloc>(() => _i166.ProjectsBloc(
          createProject: gh<_i151.CreateProjectUseCase>(),
          updateProject: gh<_i138.UpdateProjectUseCase>(),
          deleteProject: gh<_i153.DeleteProjectUseCase>(),
          watchAllProjects: gh<_i141.WatchAllProjectsUseCase>(),
          syncStatusProvider: gh<_i129.SyncStatusProvider>(),
        ));
    gh.factory<_i167.RestorePlaybackStateUseCase>(
        () => _i167.RestorePlaybackStateUseCase(
              persistenceRepository: gh<_i39.PlaybackPersistenceRepository>(),
              audioTrackRepository: gh<_i147.AudioTrackRepository>(),
              audioStorageRepository: gh<_i93.AudioStorageRepository>(),
              playbackService: gh<_i3.AudioPlaybackService>(),
            ));
    gh.lazySingleton<_i168.SendInvitationUseCase>(
        () => _i168.SendInvitationUseCase(
              invitationRepository: gh<_i72.InvitationRepository>(),
              notificationService: gh<_i32.NotificationService>(),
              findUserByEmail: gh<_i154.FindUserByEmailUseCase>(),
              magicLinkRepository: gh<_i26.MagicLinkRepository>(),
            ));
    gh.lazySingleton<_i169.SignInUseCase>(() => _i169.SignInUseCase(
          gh<_i98.AuthRepository>(),
          gh<_i139.UserProfileRepository>(),
        ));
    gh.lazySingleton<_i170.SignOutUseCase>(() => _i170.SignOutUseCase(
          gh<_i98.AuthRepository>(),
          gh<_i139.UserProfileRepository>(),
        ));
    gh.factory<_i171.UpdateUserProfileUseCase>(
        () => _i171.UpdateUserProfileUseCase(
              gh<_i139.UserProfileRepository>(),
              gh<_i81.SessionStorage>(),
            ));
    gh.lazySingleton<_i172.UploadAudioTrackUseCase>(
        () => _i172.UploadAudioTrackUseCase(
              gh<_i165.ProjectTrackService>(),
              gh<_i134.ProjectsRepository>(),
              gh<_i81.SessionStorage>(),
            ));
    gh.lazySingleton<_i173.WatchCommentsByTrackUseCase>(() =>
        _i173.WatchCommentsByTrackUseCase(gh<_i164.ProjectCommentService>()));
    gh.lazySingleton<_i174.WatchTracksByProjectIdUseCase>(() =>
        _i174.WatchTracksByProjectIdUseCase(gh<_i147.AudioTrackRepository>()));
    gh.lazySingleton<_i175.AddAudioCommentUseCase>(
        () => _i175.AddAudioCommentUseCase(
              gh<_i164.ProjectCommentService>(),
              gh<_i134.ProjectsRepository>(),
              gh<_i81.SessionStorage>(),
            ));
    gh.lazySingleton<_i176.AudioContextService>(
        () => _i177.AudioContextServiceImpl(
              userProfileRepository: gh<_i139.UserProfileRepository>(),
              audioTrackRepository: gh<_i147.AudioTrackRepository>(),
              projectsRepository: gh<_i134.ProjectsRepository>(),
            ));
    gh.factory<_i178.AudioPlayerService>(() => _i178.AudioPlayerService(
          initializeAudioPlayerUseCase: gh<_i20.InitializeAudioPlayerUseCase>(),
          playAudioUseCase: gh<_i161.PlayAudioUseCase>(),
          playPlaylistUseCase: gh<_i162.PlayPlaylistUseCase>(),
          ...
          restorePlaybackStateUseCase: gh<_i167.RestorePlaybackStateUseCase>(),
          playbackService: gh<_i3.AudioPlaybackService>(),
        ));
    gh.factory<_i179.AuthBloc>(() => _i179.AuthBloc(
          signIn: gh<_i169.SignInUseCase>(),
          signUp: gh<_i120.SignUpUseCase>(),
          googleSignIn: gh<_i156.GoogleSignInUseCase>(),
        ));
    gh.lazySingleton<_i180.DeleteAudioCommentUseCase>(
        () => _i180.DeleteAudioCommentUseCase(
              gh<_i164.ProjectCommentService>(),
              gh<_i134.ProjectsRepository>(),
              gh<_i81.SessionStorage>(),
            ));
    gh.lazySingleton<_i181.DeleteAudioTrack>(() => _i181.DeleteAudioTrack(
          gh<_i81.SessionStorage>(),
          gh<_i134.ProjectsRepository>(),
          gh<_i165.ProjectTrackService>(),
        ));
    gh.lazySingleton<_i182.EditAudioTrackUseCase>(
        () => _i182.EditAudioTrackUseCase(
              gh<_i165.ProjectTrackService>(),
              gh<_i134.ProjectsRepository>(),
            ));
    gh.factory<_i183.LoadTrackContextUseCase>(
        () => _i183.LoadTrackContextUseCase(gh<_i176.AudioContextService>()));
    gh.factory<_i184.SessionService>(() => _i184.SessionService(
          checkAuthUseCase: gh<_i106.CheckAuthenticationStatusUseCase>(),
          getCurrentUserUseCase: gh<_i111.GetCurrentUserUseCase>(),
          onboardingUseCase: gh<_i116.OnboardingUseCase>(),
          profileUseCase: gh<_i150.CheckProfileCompletenessUseCase>(),
          signOutUseCase: gh<_i170.SignOutUseCase>(),
        ));
    gh.factory<_i185.AppBootstrap>(() => _i185.AppBootstrap(
          sessionService: gh<_i184.SessionService>(),
          performanceCollector: gh<_i38.PerformanceMetricsCollector>(),
          dynamicLinkService: gh<_i12.DynamicLinkService>(),
          databaseHealthMonitor: gh<_i68.DatabaseHealthMonitor>(),
        ));
    gh.factory<_i186.AppFlowBloc>(() => _i186.AppFlowBloc(
          appBootstrap: gh<_i185.AppBootstrap>(),
          backgroundSyncCoordinator: gh<_i131.BackgroundSyncCoordinator>(),
        ));
    gh.factory<_i187.AudioCommentBloc>(() => _i187.AudioCommentBloc(
          watchCommentsByTrackUseCase: gh<_i173.WatchCommentsByTrackUseCase>(),
          addAudioCommentUseCase: gh<_i175.AddAudioCommentUseCase>(),
          deleteAudioCommentUseCase: gh<_i180.DeleteAudioCommentUseCase>(),
          watchUserProfilesUseCase: gh<_i89.WatchUserProfilesUseCase>(),
        ));
    gh.factory<_i188.AudioContextBloc>(() => _i188.AudioContextBloc(
        loadTrackContextUseCase: gh<_i183.LoadTrackContextUseCase>()));
    gh.factory<_i189.AudioPlayerBloc>(() => _i189.AudioPlayerBloc(
        audioPlayerService: gh<_i178.AudioPlayerService>()));
    gh.factory<_i190.AudioTrackBloc>(() => _i190.AudioTrackBloc(
          watchAudioTracksByProject: gh<_i174.WatchTracksByProjectIdUseCase>(),
          deleteAudioTrack: gh<_i181.DeleteAudioTrack>(),
          uploadAudioTrackUseCase: gh<_i172.UploadAudioTrackUseCase>(),
          editAudioTrackUseCase: gh<_i182.EditAudioTrackUseCase>(),
        ));
    gh.factory<_i191.GetCurrentUserDataUseCase>(
        () => _i191.GetCurrentUserDataUseCase(gh<_i184.SessionService>()));
    gh.factory<_i192.UserProfileBloc>(() => _i192.UserProfileBloc(
          updateUserProfileUseCase: gh<_i171.UpdateUserProfileUseCase>(),
          watchUserProfileUseCase: gh<_i142.WatchUserProfileUseCase>(),
          checkProfileCompletenessUseCase:
              gh<_i150.CheckProfileCompletenessUseCase>(),
          getCurrentUserDataUseCase: gh<_i191.GetCurrentUserDataUseCase>(),
        ));
    return this;
  }
}
