...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i103.CollaboratorRepository>(
        () => _i104.CollaboratorRepositoryImpl(
    ...
    gh.lazySingleton<_i111.GoogleSignInUseCase>(
        () => _i111.GoogleSignInUseCase(gh<_i95.AuthRepository>()));
    gh.lazySingleton<_i112.JoinProjectWithIdUseCase>(
        () => _i112.JoinProjectWithIdUseCase(
              gh<_i35.ProjectsRepository>(),
              gh<_i103.CollaboratorRepository>(),
              gh<_i73.SessionStorage>(),
            ));
    ...
    gh.lazySingleton<_i115.OnboardingRepository>(() =>
        _i116.OnboardingRepositoryImpl(
            gh<_i71.OnboardingStateLocalDataSource>()));
    gh.lazySingleton<_i117.OnboardingUseCase>(() => _i117.OnboardingUseCase(
          gh<_i115.OnboardingRepository>(),
    ...
    gh.factory<_i124.RemovePlaylistCacheUseCase>(() =>
        _i124.RemovePlaylistCacheUseCase(gh<_i93.AudioStorageRepository>()));
    gh.factory<_i125.RemoveTrackCacheUseCase>(
        () => _i125.RemoveTrackCacheUseCase(gh<_i93.AudioStorageRepository>()));
    ...
    gh.lazySingleton<_i127.SignInUseCase>(
        () => _i127.SignInUseCase(gh<_i95.AuthRepository>()));
    gh.lazySingleton<_i128.SignOutUseCase>(
        () => _i128.SignOutUseCase(gh<_i95.AuthRepository>()));
    gh.lazySingleton<_i129.SignUpUseCase>(
        () => _i129.SignUpUseCase(gh<_i95.AuthRepository>()));
