...
import 'package:trackflow/core/app_flow/presentation/bloc/app_flow_bloc.dart'
    as _i132;
import 'package:trackflow/core/app_flow/services/app_bootstrap.dart' as _i79;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i17.GetCurrentUserDataUseCase>(
        () => _i17.GetCurrentUserDataUseCase(gh<InvalidType>()));
    ...
    gh.lazySingleton<_i30.PendingOperationsLocalDataSource>(
        () => _i30.IsarPendingOperationsLocalDataSource(gh<_i21.Isar>()));
    ...
    gh.lazySingleton<_i35.PlaylistLocalDataSource>(
        () => _i35.PlaylistLocalDataSourceImpl(gh<_i21.Isar>()));
    ...
    gh.lazySingleton<_i38.ProjectsLocalDataSource>(
        () => _i38.ProjectsLocalDataSourceImpl(gh<_i21.Isar>()));
    gh.lazySingleton<_i39.ResendMagicLinkUseCase>(
        () => _i39.ResendMagicLinkUseCase(gh<_i24.MagicLinkRepository>()));
    ...
    gh.lazySingleton<_i52.UserProfileLocalDataSource>(
        () => _i52.IsarUserProfileLocalDataSource(gh<_i21.Isar>()));
    ...
    gh.lazySingleton<_i54.ValidateMagicLinkUseCase>(
        () => _i54.ValidateMagicLinkUseCase(gh<_i24.MagicLinkRepository>()));
    gh.lazySingleton<_i55.AudioCommentLocalDataSource>(
        () => _i55.IsarAudioCommentLocalDataSource(gh<_i21.Isar>()));
    ...
    gh.lazySingleton<_i57.AudioTrackLocalDataSource>(
        () => _i57.IsarAudioTrackLocalDataSource(gh<_i21.Isar>()));
    ...
    gh.lazySingleton<_i59.CacheStorageLocalDataSource>(
        () => _i59.CacheStorageLocalDataSourceImpl(gh<_i21.Isar>()));
    ...
    gh.lazySingleton<_i61.ConsumeMagicLinkUseCase>(
        () => _i61.ConsumeMagicLinkUseCase(gh<_i24.MagicLinkRepository>()));
    gh.factory<_i62.DatabaseHealthMonitor>(
        () => _i62.DatabaseHealthMonitor(gh<_i21.Isar>()));
    gh.lazySingleton<_i63.GetMagicLinkStatusUseCase>(
        () => _i63.GetMagicLinkStatusUseCase(gh<_i24.MagicLinkRepository>()));
    gh.lazySingleton<_i64.GoogleAuthService>(() => _i64.GoogleAuthService(
    ...
    gh.factory<_i79.AppBootstrap>(() => _i79.AppBootstrap(
          sessionService: gh<InvalidType>(),
    ...
    gh.factory<_i80.AudioCommentOperationExecutor>(() =>
        _i80.AudioCommentOperationExecutor(
            gh<_i56.AudioCommentRemoteDataSource>()));
    gh.lazySingleton<_i81.AudioDownloadRepository>(() =>
        _i82.AudioDownloadRepositoryImpl(
            remoteDataSource: gh<_i60.CacheStorageRemoteDataSource>()));
    gh.lazySingleton<_i83.AudioStorageRepository>(() =>
        _i84.AudioStorageRepositoryImpl(
            localDataSource: gh<_i59.CacheStorageLocalDataSource>()));
    gh.lazySingleton<_i85.AudioTrackIncrementalSyncService>(
        () => _i85.AudioTrackIncrementalSyncService(
              gh<_i58.AudioTrackRemoteDataSource>(),
              gh<_i57.AudioTrackLocalDataSource>(),
              gh<_i37.ProjectRemoteDataSource>(),
            ));
    gh.factory<_i86.AudioTrackOperationExecutor>(() =>
        _i86.AudioTrackOperationExecutor(
            gh<_i58.AudioTrackRemoteDataSource>()));
    ...
    gh.lazySingleton<_i88.AuthRepository>(() => _i89.AuthRepositoryImpl(
          remote: gh<_i87.AuthRemoteDataSource>(),
    ...
    gh.factory<_i94.CacheTrackUseCase>(() => _i94.CacheTrackUseCase(
          gh<_i81.AudioDownloadRepository>(),
          gh<_i83.AudioStorageRepository>(),
        ));
    ...
    gh.factory<_i98.GetCachedTrackPathUseCase>(() =>
        _i98.GetCachedTrackPathUseCase(gh<_i83.AudioStorageRepository>()));
    ...
    gh.factory<_i101.GetPlaylistCacheStatusUseCase>(() =>
        _i101.GetPlaylistCacheStatusUseCase(gh<_i83.AudioStorageRepository>()));
    ...
    gh.factory<_i106.RemovePlaylistCacheUseCase>(() =>
        _i106.RemovePlaylistCacheUseCase(gh<_i83.AudioStorageRepository>()));
    gh.factory<_i107.RemoveTrackCacheUseCase>(
        () => _i107.RemoveTrackCacheUseCase(gh<_i83.AudioStorageRepository>()));
    ...
    gh.lazySingleton<_i109.SyncAudioTracksUsingSimpleServiceUseCase>(
        () => _i109.SyncAudioTracksUsingSimpleServiceUseCase(
              gh<_i85.AudioTrackIncrementalSyncService>(),
              gh<_i70.SessionStorage>(),
            ));
    ...
    gh.factory<_i111.WatchTrackCacheStatusUseCase>(() =>
        _i111.WatchTrackCacheStatusUseCase(gh<_i83.AudioStorageRepository>()));
    ...
    gh.factory<_i115.OnboardingBloc>(() => _i115.OnboardingBloc(
          ...
          getCurrentUserIdUseCase: gh<InvalidType>(),
        ));
    ...
    gh.factory<_i132.AppFlowBloc>(() => _i132.AppFlowBloc(
          appBootstrap: gh<_i79.AppBootstrap>(),
          backgroundSyncCoordinator: gh<_i119.BackgroundSyncCoordinator>(),
        ));
    ...
    gh.lazySingleton<_i141.GetProjectByIdUseCase>(
        () => _i141.GetProjectByIdUseCase(gh<_i122.ProjectsRepository>()));
    ...
    gh.factory<_i147.PlayAudioUseCase>(() => _i147.PlayAudioUseCase(
          ...
          audioStorageRepository: gh<_i83.AudioStorageRepository>(),
          playbackService: gh<_i3.AudioPlaybackService>(),
        ));
    ...
    gh.factory<_i154.SessionService>(() => _i154.SessionService(
          checkAuthUseCase: gh<InvalidType>(),
          getCurrentUserUseCase: gh<InvalidType>(),
          onboardingUseCase: gh<_i104.OnboardingUseCase>(),
          profileUseCase: gh<_i138.CheckProfileCompletenessUseCase>(),
          signOutUseCase: gh<InvalidType>(),
        ));
    gh.lazySingleton<_i155.SignInUseCase>(() => _i155.SignInUseCase(
          gh<_i88.AuthRepository>(),
          gh<_i127.UserProfileRepository>(),
        ));
    gh.lazySingleton<_i156.SignOutUseCase>(() => _i156.SignOutUseCase(
          gh<_i88.AuthRepository>(),
          gh<_i127.UserProfileRepository>(),
        ));
    gh.factory<_i157.UpdateUserProfileUseCase>(
        () => _i157.UpdateUserProfileUseCase(
              gh<_i127.UserProfileRepository>(),
              gh<_i70.SessionStorage>(),
            ));
    gh.lazySingleton<_i158.UploadAudioTrackUseCase>(
        () => _i158.UploadAudioTrackUseCase(
              gh<_i151.ProjectTrackService>(),
              gh<_i122.ProjectsRepository>(),
              gh<_i70.SessionStorage>(),
            ));
    gh.factory<_i159.UserProfileBloc>(() => _i159.UserProfileBloc(
          updateUserProfileUseCase: gh<_i157.UpdateUserProfileUseCase>(),
          ...
          getCurrentUserDataUseCase: gh<_i17.GetCurrentUserDataUseCase>(),
        ));
    gh.lazySingleton<_i160.WatchCommentsByTrackUseCase>(() =>
        _i160.WatchCommentsByTrackUseCase(gh<_i150.ProjectCommentService>()));
    gh.lazySingleton<_i161.WatchTracksByProjectIdUseCase>(() =>
        _i161.WatchTracksByProjectIdUseCase(gh<_i135.AudioTrackRepository>()));
    gh.lazySingleton<_i162.AddAudioCommentUseCase>(
        () => _i162.AddAudioCommentUseCase(
              gh<_i150.ProjectCommentService>(),
              gh<_i122.ProjectsRepository>(),
              gh<_i70.SessionStorage>(),
            ));
    gh.lazySingleton<_i163.AudioContextService>(
        () => _i164.AudioContextServiceImpl(
              userProfileRepository: gh<_i127.UserProfileRepository>(),
              audioTrackRepository: gh<_i135.AudioTrackRepository>(),
              projectsRepository: gh<_i122.ProjectsRepository>(),
            ));
    gh.factory<_i165.AudioPlayerService>(() => _i165.AudioPlayerService(
    ...
    gh.factory<_i166.AuthBloc>(() => _i166.AuthBloc(
          signIn: gh<_i155.SignInUseCase>(),
          signUp: gh<_i108.SignUpUseCase>(),
          googleSignIn: gh<_i142.GoogleSignInUseCase>(),
        ));
    gh.lazySingleton<_i167.DeleteAudioCommentUseCase>(
        () => _i167.DeleteAudioCommentUseCase(
              gh<_i150.ProjectCommentService>(),
              gh<_i122.ProjectsRepository>(),
              gh<_i70.SessionStorage>(),
            ));
    gh.lazySingleton<_i168.DeleteAudioTrack>(() => _i168.DeleteAudioTrack(
          gh<_i70.SessionStorage>(),
          gh<_i122.ProjectsRepository>(),
          gh<_i151.ProjectTrackService>(),
        ));
    gh.lazySingleton<_i169.EditAudioTrackUseCase>(
        () => _i169.EditAudioTrackUseCase(
              gh<_i151.ProjectTrackService>(),
              gh<_i122.ProjectsRepository>(),
            ));
    gh.factory<_i170.LoadTrackContextUseCase>(
        () => _i170.LoadTrackContextUseCase(gh<_i163.AudioContextService>()));
    gh.factory<_i171.AudioCommentBloc>(() => _i171.AudioCommentBloc(
          watchCommentsByTrackUseCase: gh<_i160.WatchCommentsByTrackUseCase>(),
          addAudioCommentUseCase: gh<_i162.AddAudioCommentUseCase>(),
          deleteAudioCommentUseCase: gh<_i167.DeleteAudioCommentUseCase>(),
          watchUserProfilesUseCase: gh<_i78.WatchUserProfilesUseCase>(),
        ));
    gh.factory<_i172.AudioContextBloc>(() => _i172.AudioContextBloc(
        loadTrackContextUseCase: gh<_i170.LoadTrackContextUseCase>()));
    gh.factory<_i173.AudioPlayerBloc>(() => _i173.AudioPlayerBloc(
        audioPlayerService: gh<_i165.AudioPlayerService>()));
    gh.factory<_i174.AudioTrackBloc>(() => _i174.AudioTrackBloc(
          watchAudioTracksByProject: gh<_i161.WatchTracksByProjectIdUseCase>(),
          deleteAudioTrack: gh<_i168.DeleteAudioTrack>(),
          uploadAudioTrackUseCase: gh<_i158.UploadAudioTrackUseCase>(),
          editAudioTrackUseCase: gh<_i169.EditAudioTrackUseCase>(),
        ));
    return this;
  }
}
