...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i70.ProjectCommentService>(
        () => _i70.ProjectCommentService(gh<_i57.AudioCommentRepository>()));
    gh.lazySingleton<_i71.SessionStorage>(
        () => _i71.SessionStorage(prefs: gh<_i43.SharedPreferences>()));
    ...
    gh.lazySingleton<_i84.WatchTracksByProjectIdUseCase>(() =>
        _i84.WatchTracksByProjectIdUseCase(gh<_i61.AudioTrackRepository>()));
    ...
    gh.lazySingleton<_i87.WelcomeScreenRepository>(() =>
        _i88.WelcomeScreenRepositoryImpl(
    ...
    gh.lazySingleton<_i110.GetAuthStateUseCase>(
        () => _i110.GetAuthStateUseCase(gh<_i97.AuthRepository>()));
    gh.factory<_i111.GetCachedTrackPathUseCase>(() =>
        _i111.GetCachedTrackPathUseCase(gh<_i95.AudioStorageRepository>()));
    ...
    gh.lazySingleton<_i120.OnboardingUseCase>(() => _i120.OnboardingUseCase(
          ...
          gh<_i87.WelcomeScreenRepository>(),
        ));
    ...
    gh.factory<_i136.WatchTrackCacheStatusUseCase>(() =>
        _i136.WatchTrackCacheStatusUseCase(gh<_i95.AudioStorageRepository>()));
    ...
    gh.factory<_i142.AudioWaveformBloc>(() => _i142.AudioWaveformBloc(
          ...
          getCachedTrackPathUseCase: gh<_i111.GetCachedTrackPathUseCase>(),
        ));
    ...
    gh.factory<_i146.ManageCollaboratorsBloc>(() =>
        _i146.ManageCollaboratorsBloc(
          addCollaboratorUseCase: gh<_i90.AddCollaboratorToProjectUseCase>(),
