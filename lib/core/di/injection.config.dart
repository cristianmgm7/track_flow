...
import 'package:trackflow/core/app_flow/presentation/bloc/app_flow_bloc.dart'
    as _i206;
import 'package:trackflow/core/di/app_module.dart' as _i225;
...
import 'package:trackflow/core/services/performance_metrics_collector.dart'
    as _i40;
import 'package:trackflow/core/session/current_user_service.dart' as _i121;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i59.ToggleShuffleUseCase>(() => _i59.ToggleShuffleUseCase(
        playbackService: gh<_i5.AudioPlaybackService>()));
    gh.lazySingleton<_i60.UserProfileLocalDataSource>(
        () => _i60.IsarUserProfileLocalDataSource(gh<_i23.Isar>()));
    gh.lazySingleton<_i61.UserProfileRemoteDataSource>(
        () => _i61.UserProfileRemoteDataSourceImpl(
              gh<_i16.FirebaseFirestore>(),
              gh<_i17.FirebaseStorage>(),
            ));
    gh.lazySingleton<_i62.ValidateMagicLinkUseCase>(
        () => _i62.ValidateMagicLinkUseCase(gh<_i26.MagicLinkRepository>()));
    gh.factory<_i63.WaveformGeneratorService>(() =>
        _i64.JustWaveformGeneratorService(cacheDir: gh<_i12.Directory>()));
    gh.factory<_i65.WaveformLocalDataSource>(
        () => _i65.WaveformLocalDataSourceImpl(isar: gh<_i23.Isar>()));
    gh.lazySingleton<_i66.WaveformRemoteDataSource>(() =>
        _i66.FirebaseStorageWaveformRemoteDataSource(
            gh<_i17.FirebaseStorage>()));
    gh.factory<_i67.WaveformRepository>(() => _i68.WaveformRepositoryImpl(
          localDataSource: gh<_i65.WaveformLocalDataSource>(),
          remoteDataSource: gh<_i66.WaveformRemoteDataSource>(),
          generatorService: gh<_i63.WaveformGeneratorService>(),
        ));
    ...
    gh.lazySingleton<_i73.AudioTrackRemoteDataSource>(
        () => _i73.AudioTrackRemoteDataSourceImpl(
              gh<_i16.FirebaseFirestore>(),
              gh<_i17.FirebaseStorage>(),
            ));
    ...
    gh.factory<_i81.GetOrGenerateWaveform>(
        () => _i81.GetOrGenerateWaveform(gh<_i67.WaveformRepository>()));
    ...
    gh.factory<_i84.InvalidateWaveform>(
        () => _i84.InvalidateWaveform(gh<_i67.WaveformRepository>()));
    ...
    gh.lazySingleton<_i100.SyncProjectsUsingSimpleServiceUseCase>(
        () => _i100.SyncProjectsUsingSimpleServiceUseCase(
              gh<_i95.ProjectIncrementalSyncService>(),
              gh<_i97.SessionStorage>(),
            ));
    gh.lazySingleton<_i101.SyncUserProfileUseCase>(
        () => _i101.SyncUserProfileUseCase(
              gh<_i61.UserProfileRemoteDataSource>(),
              gh<_i60.UserProfileLocalDataSource>(),
              gh<_i97.SessionStorage>(),
            ));
    gh.lazySingleton<_i102.UserProfileCacheRepository>(
        () => _i103.UserProfileCacheRepositoryImpl(
              gh<_i61.UserProfileRemoteDataSource>(),
              gh<_i60.UserProfileLocalDataSource>(),
              gh<_i29.NetworkStateManager>(),
            ));
    gh.factory<_i104.UserProfileOperationExecutor>(() =>
        _i104.UserProfileOperationExecutor(
            gh<_i61.UserProfileRemoteDataSource>()));
    gh.lazySingleton<_i105.WatchTrackUploadStatusUseCase>(() =>
        _i105.WatchTrackUploadStatusUseCase(
            gh<_i93.PendingOperationsManager>()));
    gh.lazySingleton<_i106.WatchUserProfilesUseCase>(() =>
        _i106.WatchUserProfilesUseCase(gh<_i102.UserProfileCacheRepository>()));
    gh.factory<_i107.AudioCommentOperationExecutor>(() =>
        _i107.AudioCommentOperationExecutor(
            gh<_i71.AudioCommentRemoteDataSource>()));
    gh.lazySingleton<_i108.AudioDownloadRepository>(
        () => _i109.AudioDownloadRepositoryImpl(
              remoteDataSource: gh<_i75.CacheStorageRemoteDataSource>(),
              localDataSource: gh<_i74.CacheStorageLocalDataSource>(),
            ));
    gh.lazySingleton<_i110.AudioStorageRepository>(() =>
        _i111.AudioStorageRepositoryImpl(
            localDataSource: gh<_i74.CacheStorageLocalDataSource>()));
    gh.lazySingleton<_i112.AudioTrackIncrementalSyncService>(
        () => _i112.AudioTrackIncrementalSyncService(
              gh<_i73.AudioTrackRemoteDataSource>(),
    ...
    gh.lazySingleton<_i115.AuthRepository>(() => _i116.AuthRepositoryImpl(
          remote: gh<_i114.AuthRemoteDataSource>(),
    ...
    gh.lazySingleton<_i117.CacheManagementLocalDataSource>(() =>
        _i117.CacheManagementLocalDataSourceImpl(
            local: gh<_i74.CacheStorageLocalDataSource>()));
    gh.factory<_i118.CacheTrackUseCase>(() => _i118.CacheTrackUseCase(
          gh<_i108.AudioDownloadRepository>(),
          gh<_i110.AudioStorageRepository>(),
        ));
    gh.lazySingleton<_i119.CancelInvitationUseCase>(
        () => _i119.CancelInvitationUseCase(gh<_i86.InvitationRepository>()));
    gh.factory<_i120.CheckAuthenticationStatusUseCase>(() =>
        _i120.CheckAuthenticationStatusUseCase(gh<_i115.AuthRepository>()));
    gh.factory<_i121.CurrentUserService>(
        () => _i121.CurrentUserService(gh<_i97.SessionStorage>()));
    gh.factory<_i122.DeleteCachedAudioUseCase>(() =>
        _i122.DeleteCachedAudioUseCase(gh<_i110.AudioStorageRepository>()));
    gh.lazySingleton<_i123.GenerateMagicLinkUseCase>(
        () => _i123.GenerateMagicLinkUseCase(
              gh<_i26.MagicLinkRepository>(),
              gh<_i115.AuthRepository>(),
            ));
    gh.lazySingleton<_i124.GetAuthStateUseCase>(
        () => _i124.GetAuthStateUseCase(gh<_i115.AuthRepository>()));
    gh.factory<_i125.GetCachedTrackPathUseCase>(() =>
        _i125.GetCachedTrackPathUseCase(gh<_i110.AudioStorageRepository>()));
    gh.factory<_i126.GetCurrentUserUseCase>(
        () => _i126.GetCurrentUserUseCase(gh<_i115.AuthRepository>()));
    gh.lazySingleton<_i127.GetPendingInvitationsCountUseCase>(() =>
        _i127.GetPendingInvitationsCountUseCase(
    ...
    gh.factory<_i128.MarkAllNotificationsAsReadUseCase>(
        () => _i128.MarkAllNotificationsAsReadUseCase(
              ...
              currentUserService: gh<_i121.CurrentUserService>(),
            ));
    ...
    gh.factory<_i135.RemoveTrackCacheUseCase>(() =>
        _i135.RemoveTrackCacheUseCase(gh<_i110.AudioStorageRepository>()));
    gh.lazySingleton<_i136.SignOutUseCase>(
        () => _i136.SignOutUseCase(gh<_i115.AuthRepository>()));
    gh.lazySingleton<_i137.SignUpUseCase>(
        () => _i137.SignUpUseCase(gh<_i115.AuthRepository>()));
    gh.lazySingleton<_i138.SyncAudioTracksUsingSimpleServiceUseCase>(
        () => _i138.SyncAudioTracksUsingSimpleServiceUseCase(
              gh<_i112.AudioTrackIncrementalSyncService>(),
              gh<_i97.SessionStorage>(),
            ));
    gh.lazySingleton<_i139.SyncUserProfileCollaboratorsUseCase>(
        () => _i139.SyncUserProfileCollaboratorsUseCase(
              gh<_i46.ProjectsLocalDataSource>(),
              gh<_i102.UserProfileCacheRepository>(),
            ));
    gh.factory<_i140.TrackUploadStatusCubit>(() => _i140.TrackUploadStatusCubit(
        gh<_i105.WatchTrackUploadStatusUseCase>()));
    gh.factory<_i141.WatchCachedAudiosUseCase>(() =>
        _i141.WatchCachedAudiosUseCase(gh<_i110.AudioStorageRepository>()));
    gh.factory<_i142.WatchStorageUsageUseCase>(() =>
        _i142.WatchStorageUsageUseCase(gh<_i110.AudioStorageRepository>()));
    gh.factory<_i143.WatchTrackCacheStatusUseCase>(() =>
        _i143.WatchTrackCacheStatusUseCase(gh<_i110.AudioStorageRepository>()));
    gh.factory<_i144.WaveformBloc>(() => _i144.WaveformBloc(
          waveformRepository: gh<_i67.WaveformRepository>(),
          audioPlaybackService: gh<_i5.AudioPlaybackService>(),
          getOrGenerate: gh<_i81.GetOrGenerateWaveform>(),
          getCachedTrackPathUseCase: gh<_i125.GetCachedTrackPathUseCase>(),
        ));
    gh.lazySingleton<_i145.AppleSignInUseCase>(
        () => _i145.AppleSignInUseCase(gh<_i115.AuthRepository>()));
    gh.factory<_i146.AudioSourceResolver>(() => _i147.AudioSourceResolverImpl(
          gh<_i110.AudioStorageRepository>(),
          gh<_i108.AudioDownloadRepository>(),
        ));
    gh.lazySingleton<_i148.CacheMaintenanceService>(() =>
        _i149.CacheMaintenanceServiceImpl(
            gh<_i117.CacheManagementLocalDataSource>()));
    gh.factory<_i150.CleanupCacheUseCase>(
        () => _i150.CleanupCacheUseCase(gh<_i148.CacheMaintenanceService>()));
    gh.factory<_i151.GetCacheStorageStatsUseCase>(() =>
        _i151.GetCacheStorageStatsUseCase(gh<_i148.CacheMaintenanceService>()));
    gh.factory<_i152.OnboardingBloc>(() => _i152.OnboardingBloc(
          onboardingUseCase: gh<_i133.OnboardingUseCase>(),
          getCurrentUserUseCase: gh<_i126.GetCurrentUserUseCase>(),
        ));
    gh.factory<_i153.SyncDataManager>(() => _i153.SyncDataManager(
          syncProjects: gh<_i100.SyncProjectsUsingSimpleServiceUseCase>(),
          syncAudioTracks: gh<_i138.SyncAudioTracksUsingSimpleServiceUseCase>(),
          syncAudioComments: gh<_i98.SyncAudioCommentsUseCase>(),
          syncUserProfile: gh<_i101.SyncUserProfileUseCase>(),
          syncUserProfileCollaborators:
              gh<_i139.SyncUserProfileCollaboratorsUseCase>(),
          syncNotifications: gh<_i99.SyncNotificationsUseCase>(),
        ));
    gh.factory<_i154.SyncStatusProvider>(() => _i154.SyncStatusProvider(
          syncDataManager: gh<_i153.SyncDataManager>(),
          pendingOperationsManager: gh<_i93.PendingOperationsManager>(),
        ));
    gh.factory<_i155.TrackCacheBloc>(() => _i155.TrackCacheBloc(
          cacheTrackUseCase: gh<_i118.CacheTrackUseCase>(),
    ...
    gh.lazySingleton<_i156.BackgroundSyncCoordinator>(
        () => _i156.BackgroundSyncCoordinator(
              gh<_i29.NetworkStateManager>(),
              gh<_i153.SyncDataManager>(),
              gh<_i93.PendingOperationsManager>(),
            ));
    gh.lazySingleton<_i157.PlaylistRepository>(
        () => _i158.PlaylistRepositoryImpl(
              localDataSource: gh<_i43.PlaylistLocalDataSource>(),
              backgroundSyncCoordinator: gh<_i156.BackgroundSyncCoordinator>(),
              pendingOperationsManager: gh<_i93.PendingOperationsManager>(),
            ));
    gh.lazySingleton<_i159.ProjectsRepository>(
        () => _i160.ProjectsRepositoryImpl(
              localDataSource: gh<_i46.ProjectsLocalDataSource>(),
              backgroundSyncCoordinator: gh<_i156.BackgroundSyncCoordinator>(),
              pendingOperationsManager: gh<_i93.PendingOperationsManager>(),
            ));
    gh.lazySingleton<_i161.RemoveCollaboratorUseCase>(
        () => _i161.RemoveCollaboratorUseCase(
              gh<_i159.ProjectsRepository>(),
              gh<_i97.SessionStorage>(),
            ));
    gh.lazySingleton<_i162.TriggerUpstreamSyncUseCase>(() =>
        _i162.TriggerUpstreamSyncUseCase(
            gh<_i156.BackgroundSyncCoordinator>()));
    ...
    gh.lazySingleton<_i165.UserProfileRepository>(
        () => _i166.UserProfileRepositoryImpl(
              localDataSource: gh<_i60.UserProfileLocalDataSource>(),
              remoteDataSource: gh<_i61.UserProfileRemoteDataSource>(),
              networkStateManager: gh<_i29.NetworkStateManager>(),
              backgroundSyncCoordinator: gh<_i156.BackgroundSyncCoordinator>(),
              pendingOperationsManager: gh<_i93.PendingOperationsManager>(),
              firestore: gh<_i16.FirebaseFirestore>(),
    ...
    gh.lazySingleton<_i168.WatchCollaboratorsBundleUseCase>(
        () => _i168.WatchCollaboratorsBundleUseCase(
              gh<_i159.ProjectsRepository>(),
              gh<_i106.WatchUserProfilesUseCase>(),
            ));
    ...
    gh.lazySingleton<_i170.AcceptInvitationUseCase>(
        () => _i170.AcceptInvitationUseCase(
              invitationRepository: gh<_i86.InvitationRepository>(),
              projectRepository: gh<_i159.ProjectsRepository>(),
    ...
    gh.lazySingleton<_i172.AudioCommentRepository>(
        () => _i173.AudioCommentRepositoryImpl(
    ...
    gh.lazySingleton<_i174.AudioTrackRepository>(
        () => _i175.AudioTrackRepositoryImpl(
              gh<_i72.AudioTrackLocalDataSource>(),
              gh<_i156.BackgroundSyncCoordinator>(),
              gh<_i93.PendingOperationsManager>(),
            ));
    gh.factory<_i176.CheckProfileCompletenessUseCase>(() =>
        _i176.CheckProfileCompletenessUseCase(
            gh<_i165.UserProfileRepository>()));
    gh.lazySingleton<_i177.CreateProjectUseCase>(
        () => _i177.CreateProjectUseCase(
              gh<_i159.ProjectsRepository>(),
              gh<_i97.SessionStorage>(),
            ));
    gh.factory<_i178.CreateUserProfileUseCase>(
        () => _i178.CreateUserProfileUseCase(
              gh<_i165.UserProfileRepository>(),
              gh<_i97.SessionStorage>(),
            ));
    gh.lazySingleton<_i179.DeclineInvitationUseCase>(
        () => _i179.DeclineInvitationUseCase(
              invitationRepository: gh<_i86.InvitationRepository>(),
              projectRepository: gh<_i159.ProjectsRepository>(),
              userProfileRepository: gh<_i165.UserProfileRepository>(),
              notificationService: gh<_i34.NotificationService>(),
            ));
    gh.lazySingleton<_i180.FindUserByEmailUseCase>(
        () => _i180.FindUserByEmailUseCase(gh<_i165.UserProfileRepository>()));
    gh.lazySingleton<_i181.GetProjectByIdUseCase>(
        () => _i181.GetProjectByIdUseCase(gh<_i159.ProjectsRepository>()));
    gh.lazySingleton<_i182.GoogleSignInUseCase>(() => _i182.GoogleSignInUseCase(
          gh<_i115.AuthRepository>(),
          gh<_i165.UserProfileRepository>(),
        ));
    ...
    gh.lazySingleton<_i184.LeaveProjectUseCase>(() => _i184.LeaveProjectUseCase(
          gh<_i159.ProjectsRepository>(),
          gh<_i97.SessionStorage>(),
        ));
    gh.factory<_i185.MagicLinkBloc>(() => _i185.MagicLinkBloc(
          generateMagicLink: gh<_i123.GenerateMagicLinkUseCase>(),
          validateMagicLink: gh<_i62.ValidateMagicLinkUseCase>(),
          ...
          authRepository: gh<_i115.AuthRepository>(),
        ));
    gh.factory<_i186.PlayAudioUseCase>(() => _i186.PlayAudioUseCase(
          audioTrackRepository: gh<_i174.AudioTrackRepository>(),
          audioStorageRepository: gh<_i110.AudioStorageRepository>(),
          playbackService: gh<_i5.AudioPlaybackService>(),
        ));
    gh.factory<_i187.PlayPlaylistUseCase>(() => _i187.PlayPlaylistUseCase(
    ...
    gh.lazySingleton<_i188.ProjectCommentService>(
        () => _i188.ProjectCommentService(gh<_i172.AudioCommentRepository>()));
    gh.lazySingleton<_i189.ProjectTrackService>(() => _i189.ProjectTrackService(
          gh<_i174.AudioTrackRepository>(),
          gh<_i110.AudioStorageRepository>(),
        ));
    gh.factory<_i190.RestorePlaybackStateUseCase>(
        () => _i190.RestorePlaybackStateUseCase(
              persistenceRepository: gh<_i41.PlaybackPersistenceRepository>(),
              audioTrackRepository: gh<_i174.AudioTrackRepository>(),
              audioStorageRepository: gh<_i110.AudioStorageRepository>(),
              playbackService: gh<_i5.AudioPlaybackService>(),
            ));
    gh.lazySingleton<_i191.SendInvitationUseCase>(
        () => _i191.SendInvitationUseCase(
              invitationRepository: gh<_i86.InvitationRepository>(),
              notificationService: gh<_i34.NotificationService>(),
              findUserByEmail: gh<_i180.FindUserByEmailUseCase>(),
              magicLinkRepository: gh<_i26.MagicLinkRepository>(),
              currentUserService: gh<_i121.CurrentUserService>(),
            ));
    gh.factory<_i192.SessionCleanupService>(() => _i192.SessionCleanupService(
          userProfileRepository: gh<_i165.UserProfileRepository>(),
          projectsRepository: gh<_i159.ProjectsRepository>(),
          audioTrackRepository: gh<_i174.AudioTrackRepository>(),
          audioCommentRepository: gh<_i172.AudioCommentRepository>(),
          invitationRepository: gh<_i86.InvitationRepository>(),
    ...
    gh.factory<_i193.SessionService>(() => _i193.SessionService(
          checkAuthUseCase: gh<_i120.CheckAuthenticationStatusUseCase>(),
          getCurrentUserUseCase: gh<_i126.GetCurrentUserUseCase>(),
          onboardingUseCase: gh<_i133.OnboardingUseCase>(),
          profileUseCase: gh<_i176.CheckProfileCompletenessUseCase>(),
        ));
    gh.lazySingleton<_i194.SignInUseCase>(() => _i194.SignInUseCase(
          gh<_i115.AuthRepository>(),
          gh<_i165.UserProfileRepository>(),
        ));
    gh.factory<_i195.SyncStatusCubit>(() => _i195.SyncStatusCubit(
          gh<_i154.SyncStatusProvider>(),
          gh<_i93.PendingOperationsManager>(),
          gh<_i162.TriggerUpstreamSyncUseCase>(),
        ));
    gh.factory<_i196.UpdateUserProfileUseCase>(
        () => _i196.UpdateUserProfileUseCase(
              gh<_i165.UserProfileRepository>(),
              gh<_i97.SessionStorage>(),
            ));
    gh.lazySingleton<_i197.UploadAudioTrackUseCase>(
        () => _i197.UploadAudioTrackUseCase(
    ...
    gh.factory<_i198.UserProfileBloc>(() => _i198.UserProfileBloc(
          ...
          createUserProfileUseCase: gh<_i178.CreateUserProfileUseCase>(),
          watchUserProfileUseCase: gh<_i169.WatchUserProfileUseCase>(),
          checkProfileCompletenessUseCase:
              gh<_i176.CheckProfileCompletenessUseCase>(),
          getCurrentUserUseCase: gh<_i126.GetCurrentUserUseCase>(),
        ));
    gh.lazySingleton<_i199.WatchAudioCommentsBundleUseCase>(
        () => _i199.WatchAudioCommentsBundleUseCase(
              gh<_i174.AudioTrackRepository>(),
              gh<_i172.AudioCommentRepository>(),
              gh<_i102.UserProfileCacheRepository>(),
            ));
    gh.factory<_i200.WatchCachedTrackBundlesUseCase>(
        () => _i200.WatchCachedTrackBundlesUseCase(
              gh<_i148.CacheMaintenanceService>(),
              gh<_i174.AudioTrackRepository>(),
              gh<_i165.UserProfileRepository>(),
              gh<_i159.ProjectsRepository>(),
            ));
    ...
    gh.lazySingleton<_i202.WatchTracksByProjectIdUseCase>(() =>
        _i202.WatchTracksByProjectIdUseCase(gh<_i174.AudioTrackRepository>()));
    ...
    gh.factory<_i206.AppFlowBloc>(() => _i206.AppFlowBloc(
          ...
          backgroundSyncCoordinator: gh<_i156.BackgroundSyncCoordinator>(),
          getAuthStateUseCase: gh<_i124.GetAuthStateUseCase>(),
          sessionCleanupService: gh<_i192.SessionCleanupService>(),
        ));
    ...
    gh.factory<_i209.AudioPlayerService>(() => _i209.AudioPlayerService(
          ...
          playAudioUseCase: gh<_i186.PlayAudioUseCase>(),
          playPlaylistUseCase: gh<_i187.PlayPlaylistUseCase>(),
          ...
          restorePlaybackStateUseCase: gh<_i190.RestorePlaybackStateUseCase>(),
          playbackService: gh<_i5.AudioPlaybackService>(),
        ));
    gh.factory<_i210.AuthBloc>(() => _i210.AuthBloc(
          signIn: gh<_i194.SignInUseCase>(),
          signUp: gh<_i137.SignUpUseCase>(),
          googleSignIn: gh<_i182.GoogleSignInUseCase>(),
          appleSignIn: gh<_i145.AppleSignInUseCase>(),
          signOut: gh<_i136.SignOutUseCase>(),
        ));
    gh.factory<_i211.CacheManagementBloc>(() => _i211.CacheManagementBloc(
          deleteOne: gh<_i122.DeleteCachedAudioUseCase>(),
          watchUsage: gh<_i142.WatchStorageUsageUseCase>(),
          getStats: gh<_i151.GetCacheStorageStatsUseCase>(),
          cleanup: gh<_i150.CleanupCacheUseCase>(),
          watchBundles: gh<_i200.WatchCachedTrackBundlesUseCase>(),
        ));
    ...
    gh.lazySingleton<_i214.DeleteProjectUseCase>(
        () => _i214.DeleteProjectUseCase(
              gh<_i159.ProjectsRepository>(),
              gh<_i97.SessionStorage>(),
              gh<_i189.ProjectTrackService>(),
            ));
    gh.lazySingleton<_i215.EditAudioTrackUseCase>(
        () => _i215.EditAudioTrackUseCase(
              gh<_i189.ProjectTrackService>(),
              gh<_i159.ProjectsRepository>(),
            ));
    gh.factory<_i216.LoadTrackContextUseCase>(
        () => _i216.LoadTrackContextUseCase(gh<_i207.AudioContextService>()));
    gh.factory<_i217.ManageCollaboratorsBloc>(
        () => _i217.ManageCollaboratorsBloc(
              removeCollaboratorUseCase: gh<_i161.RemoveCollaboratorUseCase>(),
              updateCollaboratorRoleUseCase:
                  gh<_i163.UpdateCollaboratorRoleUseCase>(),
              leaveProjectUseCase: gh<_i184.LeaveProjectUseCase>(),
              findUserByEmailUseCase: gh<_i180.FindUserByEmailUseCase>(),
              addCollaboratorByEmailUseCase:
                  gh<_i204.AddCollaboratorByEmailUseCase>(),
              watchCollaboratorsBundleUseCase:
                  gh<_i168.WatchCollaboratorsBundleUseCase>(),
            ));
    gh.factory<_i218.ProjectDetailBloc>(() => _i218.ProjectDetailBloc(
        watchProjectDetail: gh<_i201.WatchProjectDetailUseCase>()));
    gh.factory<_i219.ProjectInvitationActorBloc>(
        () => _i219.ProjectInvitationActorBloc(
              sendInvitationUseCase: gh<_i191.SendInvitationUseCase>(),
              acceptInvitationUseCase: gh<_i170.AcceptInvitationUseCase>(),
              declineInvitationUseCase: gh<_i179.DeclineInvitationUseCase>(),
              cancelInvitationUseCase: gh<_i119.CancelInvitationUseCase>(),
              findUserByEmailUseCase: gh<_i180.FindUserByEmailUseCase>(),
            ));
    gh.factory<_i220.ProjectsBloc>(() => _i220.ProjectsBloc(
          createProject: gh<_i177.CreateProjectUseCase>(),
          updateProject: gh<_i164.UpdateProjectUseCase>(),
          deleteProject: gh<_i214.DeleteProjectUseCase>(),
          watchAllProjects: gh<_i167.WatchAllProjectsUseCase>(),
        ));
    gh.factory<_i221.AudioCommentBloc>(() => _i221.AudioCommentBloc(
          ...
          watchAudioCommentsBundleUseCase:
              gh<_i199.WatchAudioCommentsBundleUseCase>(),
        ));
    gh.factory<_i222.AudioContextBloc>(() => _i222.AudioContextBloc(
        loadTrackContextUseCase: gh<_i216.LoadTrackContextUseCase>()));
    gh.factory<_i223.AudioPlayerBloc>(() => _i223.AudioPlayerBloc(
        audioPlayerService: gh<_i209.AudioPlayerService>()));
    gh.factory<_i224.AudioTrackBloc>(() => _i224.AudioTrackBloc(
          watchAudioTracksByProject: gh<_i202.WatchTracksByProjectIdUseCase>(),
          deleteAudioTrack: gh<_i213.DeleteAudioTrack>(),
          uploadAudioTrackUseCase: gh<_i197.UploadAudioTrackUseCase>(),
          editAudioTrackUseCase: gh<_i215.EditAudioTrackUseCase>(),
        ));
    return this;
  }
}
