...
import 'package:trackflow/core/sync/domain/services/sync_status_provider.dart'
    as _i106;
import 'package:trackflow/core/sync/domain/services/sync_trigger.dart' as _i211;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i18.IncrementalSyncService<_i86.AudioTrackDTO>>(
        () => _i87.AudioTrackIncrementalSyncService(
    ...
    gh.lazySingleton<_i18.IncrementalSyncService<_i90.TrackVersionDTO>>(
        () => _i91.TrackVersionIncrementalSyncService(
    ...
    gh.lazySingleton<_i221.WatchTracksByProjectIdUseCase>(() =>
        _i221.WatchTracksByProjectIdUseCase(gh<_i175.AudioTrackRepository>()));
