...
import 'package:trackflow/core/app_flow/data/session_storage.dart' as _i88;
...
import 'package:trackflow/core/notifications/presentation/blocs/watcher/notification_watcher_bloc.dart'
    as _i124;
import 'package:trackflow/core/services/database_health_monitor.dart' as _i71;
...
import 'package:trackflow/core/services/performance_metrics_collector.dart'
    as _i40;
import 'package:trackflow/core/session/current_user_service.dart' as _i115;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i22.InvitationRemoteDataSource>(() =>
        _i22.FirestoreInvitationRemoteDataSource(gh<_i15.FirebaseFirestore>()));
    ...
    gh.factory<_i50.SeekAudioUseCase>(() =>
        _i50.SeekAudioUseCase(playbackService: gh<_i3.AudioPlaybackService>()));
    gh.factory<_i51.SetPlaybackSpeedUseCase>(() => _i51.SetPlaybackSpeedUseCase(
        playbackService: gh<_i3.AudioPlaybackService>()));
    gh.factory<_i52.SetVolumeUseCase>(() =>
        _i52.SetVolumeUseCase(playbackService: gh<_i3.AudioPlaybackService>()));
    ...
    gh.factory<_i56.StopAudioUseCase>(() =>
        _i56.StopAudioUseCase(playbackService: gh<_i3.AudioPlaybackService>()));
    ...
    gh.lazySingleton<_i63.AudioCommentLocalDataSource>(
        () => _i63.IsarAudioCommentLocalDataSource(gh<_i23.Isar>()));
    gh.lazySingleton<_i64.AudioCommentRemoteDataSource>(() =>
        _i64.FirebaseAudioCommentRemoteDataSource(
            gh<_i15.FirebaseFirestore>()));
    gh.lazySingleton<_i65.AudioTrackLocalDataSource>(
        () => _i65.IsarAudioTrackLocalDataSource(gh<_i23.Isar>()));
    gh.lazySingleton<_i66.AudioTrackRemoteDataSource>(
        () => _i66.AudioTrackRemoteDataSourceImpl(
              gh<_i15.FirebaseFirestore>(),
              gh<_i16.FirebaseStorage>(),
            ));
    gh.lazySingleton<_i67.CacheStorageLocalDataSource>(
        () => _i67.CacheStorageLocalDataSourceImpl(gh<_i23.Isar>()));
    gh.lazySingleton<_i68.CacheStorageRemoteDataSource>(() =>
        _i68.CacheStorageRemoteDataSourceImpl(gh<_i16.FirebaseStorage>()));
    gh.lazySingleton<_i69.ConsumeMagicLinkUseCase>(
        () => _i69.ConsumeMagicLinkUseCase(gh<_i26.MagicLinkRepository>()));
    gh.factory<_i70.CreateNotificationUseCase>(() =>
        _i70.CreateNotificationUseCase(gh<_i32.NotificationRepository>()));
    gh.factory<_i71.DatabaseHealthMonitor>(
        () => _i71.DatabaseHealthMonitor(gh<_i23.Isar>()));
    gh.factory<_i72.DeleteNotificationUseCase>(() =>
        _i72.DeleteNotificationUseCase(gh<_i32.NotificationRepository>()));
    gh.lazySingleton<_i73.GetMagicLinkStatusUseCase>(
        () => _i73.GetMagicLinkStatusUseCase(gh<_i26.MagicLinkRepository>()));
    gh.lazySingleton<_i74.GetUnreadNotificationsCountUseCase>(() =>
        _i74.GetUnreadNotificationsCountUseCase(
            gh<_i32.NotificationRepository>()));
    gh.lazySingleton<_i75.GoogleAuthService>(() => _i75.GoogleAuthService(
          gh<_i18.GoogleSignIn>(),
          gh<_i14.FirebaseAuth>(),
        ));
    gh.lazySingleton<_i76.InvitationLocalDataSource>(
        () => _i76.IsarInvitationLocalDataSource(gh<_i23.Isar>()));
    gh.lazySingleton<_i77.InvitationRepository>(
        () => _i78.InvitationRepositoryImpl(
              localDataSource: gh<_i76.InvitationLocalDataSource>(),
              remoteDataSource: gh<_i22.InvitationRemoteDataSource>(),
              networkStateManager: gh<_i29.NetworkStateManager>(),
            ));
    gh.factory<_i79.MarkAsUnreadUseCase>(
        () => _i79.MarkAsUnreadUseCase(gh<_i32.NotificationRepository>()));
    gh.lazySingleton<_i80.MarkNotificationAsReadUseCase>(() =>
        _i80.MarkNotificationAsReadUseCase(gh<_i32.NotificationRepository>()));
    gh.lazySingleton<_i81.ObservePendingInvitationsUseCase>(() =>
        _i81.ObservePendingInvitationsUseCase(gh<_i77.InvitationRepository>()));
    gh.lazySingleton<_i82.ObserveSentInvitationsUseCase>(() =>
        _i82.ObserveSentInvitationsUseCase(gh<_i77.InvitationRepository>()));
    gh.lazySingleton<_i83.OnboardingStateLocalDataSource>(() =>
        _i83.OnboardingStateLocalDataSourceImpl(gh<_i53.SharedPreferences>()));
    gh.lazySingleton<_i84.PendingOperationsManager>(
        () => _i84.PendingOperationsManager(
              gh<_i39.PendingOperationsRepository>(),
              gh<_i29.NetworkStateManager>(),
              gh<_i36.OperationExecutorFactory>(),
            ));
    gh.factory<_i85.PlaylistOperationExecutor>(() =>
        _i85.PlaylistOperationExecutor(gh<_i44.PlaylistRemoteDataSource>()));
    gh.lazySingleton<_i86.ProjectIncrementalSyncService>(
        () => _i86.ProjectIncrementalSyncService(
              gh<_i45.ProjectRemoteDataSource>(),
              gh<_i46.ProjectsLocalDataSource>(),
            ));
    gh.factory<_i87.ProjectOperationExecutor>(() =>
        _i87.ProjectOperationExecutor(gh<_i45.ProjectRemoteDataSource>()));
    gh.lazySingleton<_i88.SessionStorage>(
        () => _i88.SessionStorageImpl(prefs: gh<_i53.SharedPreferences>()));
    gh.lazySingleton<_i89.SyncAudioCommentsUseCase>(
        () => _i89.SyncAudioCommentsUseCase(
              gh<_i64.AudioCommentRemoteDataSource>(),
              gh<_i63.AudioCommentLocalDataSource>(),
              gh<_i45.ProjectRemoteDataSource>(),
              gh<_i88.SessionStorage>(),
              gh<_i66.AudioTrackRemoteDataSource>(),
            ));
    gh.lazySingleton<_i90.SyncNotificationsUseCase>(
        () => _i90.SyncNotificationsUseCase(
              gh<_i32.NotificationRepository>(),
              gh<_i88.SessionStorage>(),
            ));
    gh.lazySingleton<_i91.SyncProjectsUsingSimpleServiceUseCase>(
        () => _i91.SyncProjectsUsingSimpleServiceUseCase(
              gh<_i86.ProjectIncrementalSyncService>(),
              gh<_i88.SessionStorage>(),
            ));
    gh.lazySingleton<_i92.SyncUserProfileUseCase>(
        () => _i92.SyncUserProfileUseCase(
              gh<_i61.UserProfileRemoteDataSource>(),
              gh<_i60.UserProfileLocalDataSource>(),
              gh<_i88.SessionStorage>(),
            ));
    gh.lazySingleton<_i93.UserProfileCacheRepository>(
        () => _i94.UserProfileCacheRepositoryImpl(
              gh<_i61.UserProfileRemoteDataSource>(),
              gh<_i60.UserProfileLocalDataSource>(),
              gh<_i29.NetworkStateManager>(),
            ));
    gh.factory<_i95.UserProfileOperationExecutor>(() =>
        _i95.UserProfileOperationExecutor(
            gh<_i61.UserProfileRemoteDataSource>()));
    gh.lazySingleton<_i96.WatchProjectDetailUseCase>(
        () => _i96.WatchProjectDetailUseCase(
              gh<_i65.AudioTrackLocalDataSource>(),
              gh<_i60.UserProfileLocalDataSource>(),
              gh<_i63.AudioCommentLocalDataSource>(),
            ));
    gh.lazySingleton<_i97.WatchUserProfilesUseCase>(() =>
        _i97.WatchUserProfilesUseCase(gh<_i93.UserProfileCacheRepository>()));
    gh.factory<_i98.AudioCommentOperationExecutor>(() =>
        _i98.AudioCommentOperationExecutor(
            gh<_i64.AudioCommentRemoteDataSource>()));
    gh.lazySingleton<_i99.AudioDownloadRepository>(() =>
        _i100.AudioDownloadRepositoryImpl(
            remoteDataSource: gh<_i68.CacheStorageRemoteDataSource>()));
    gh.lazySingleton<_i101.AudioStorageRepository>(() =>
        _i102.AudioStorageRepositoryImpl(
            localDataSource: gh<_i67.CacheStorageLocalDataSource>()));
    gh.lazySingleton<_i103.AudioTrackIncrementalSyncService>(
        () => _i103.AudioTrackIncrementalSyncService(
              gh<_i66.AudioTrackRemoteDataSource>(),
              gh<_i65.AudioTrackLocalDataSource>(),
              gh<_i45.ProjectRemoteDataSource>(),
            ));
    gh.factory<_i104.AudioTrackOperationExecutor>(() =>
        _i104.AudioTrackOperationExecutor(
            gh<_i66.AudioTrackRemoteDataSource>()));
    gh.lazySingleton<_i105.AuthRemoteDataSource>(
        () => _i105.AuthRemoteDataSourceImpl(
              gh<_i14.FirebaseAuth>(),
              gh<_i75.GoogleAuthService>(),
            ));
    gh.lazySingleton<_i106.AuthRepository>(() => _i107.AuthRepositoryImpl(
          remote: gh<_i105.AuthRemoteDataSource>(),
          sessionStorage: gh<_i88.SessionStorage>(),
          networkStateManager: gh<_i29.NetworkStateManager>(),
          googleAuthService: gh<_i75.GoogleAuthService>(),
        ));
    gh.lazySingleton<_i108.CacheKeyRepository>(() =>
        _i109.CacheKeyRepositoryImpl(
            localDataSource: gh<_i67.CacheStorageLocalDataSource>()));
    gh.lazySingleton<_i110.CacheMaintenanceRepository>(() =>
        _i111.CacheMaintenanceRepositoryImpl(
            localDataSource: gh<_i67.CacheStorageLocalDataSource>()));
    gh.factory<_i112.CacheTrackUseCase>(() => _i112.CacheTrackUseCase(
          gh<_i99.AudioDownloadRepository>(),
          gh<_i101.AudioStorageRepository>(),
        ));
    gh.lazySingleton<_i113.CancelInvitationUseCase>(
        () => _i113.CancelInvitationUseCase(gh<_i77.InvitationRepository>()));
    gh.factory<_i114.CheckAuthenticationStatusUseCase>(() =>
        _i114.CheckAuthenticationStatusUseCase(gh<_i106.AuthRepository>()));
    gh.factory<_i115.CurrentUserService>(
        () => _i115.CurrentUserService(gh<_i88.SessionStorage>()));
    gh.lazySingleton<_i116.GenerateMagicLinkUseCase>(
        () => _i116.GenerateMagicLinkUseCase(
              gh<_i26.MagicLinkRepository>(),
              gh<_i106.AuthRepository>(),
            ));
    gh.lazySingleton<_i117.GetAuthStateUseCase>(
        () => _i117.GetAuthStateUseCase(gh<_i106.AuthRepository>()));
    gh.factory<_i118.GetCachedTrackPathUseCase>(() =>
        _i118.GetCachedTrackPathUseCase(gh<_i101.AudioStorageRepository>()));
    gh.factory<_i119.GetCurrentUserUseCase>(
        () => _i119.GetCurrentUserUseCase(gh<_i106.AuthRepository>()));
    gh.lazySingleton<_i120.GetPendingInvitationsCountUseCase>(() =>
        _i120.GetPendingInvitationsCountUseCase(
            gh<_i77.InvitationRepository>()));
    ...
    gh.factory<_i122.MarkAllNotificationsAsReadUseCase>(
        () => _i122.MarkAllNotificationsAsReadUseCase(
              ...
              currentUserService: gh<_i115.CurrentUserService>(),
            ));
    gh.factory<_i123.NotificationActorBloc>(() => _i123.NotificationActorBloc(
          createNotificationUseCase: gh<_i70.CreateNotificationUseCase>(),
          markAsReadUseCase: gh<_i80.MarkNotificationAsReadUseCase>(),
          markAsUnreadUseCase: gh<_i79.MarkAsUnreadUseCase>(),
          markAllAsReadUseCase: gh<_i122.MarkAllNotificationsAsReadUseCase>(),
          deleteNotificationUseCase: gh<_i72.DeleteNotificationUseCase>(),
        ));
    ...
    gh.lazySingleton<_i125.OnboardingRepository>(() =>
        _i126.OnboardingRepositoryImpl(
            gh<_i83.OnboardingStateLocalDataSource>()));
    ...
    gh.factory<_i138.AudioWaveformBloc>(() => _i138.AudioWaveformBloc(
          ...
          getCachedTrackPathUseCase: gh<_i118.GetCachedTrackPathUseCase>(),
        ));
    ...
    gh.factory<_i140.SyncDataManager>(() => _i140.SyncDataManager(
          syncProjects: gh<_i91.SyncProjectsUsingSimpleServiceUseCase>(),
          syncAudioTracks: gh<_i133.SyncAudioTracksUsingSimpleServiceUseCase>(),
          syncAudioComments: gh<_i89.SyncAudioCommentsUseCase>(),
          syncUserProfile: gh<_i92.SyncUserProfileUseCase>(),
          syncUserProfileCollaborators:
              gh<_i134.SyncUserProfileCollaboratorsUseCase>(),
          syncNotifications: gh<_i90.SyncNotificationsUseCase>(),
        ));
    gh.factory<_i141.SyncStatusProvider>(() => _i141.SyncStatusProvider(
          syncDataManager: gh<_i140.SyncDataManager>(),
          pendingOperationsManager: gh<_i84.PendingOperationsManager>(),
        ));
    gh.factory<_i142.TrackCacheBloc>(() => _i142.TrackCacheBloc(
          cacheTrackUseCase: gh<_i112.CacheTrackUseCase>(),
    ...
    gh.lazySingleton<_i143.BackgroundSyncCoordinator>(
        () => _i143.BackgroundSyncCoordinator(
              ...
              gh<_i84.PendingOperationsManager>(),
            ));
    ...
    gh.lazySingleton<_i157.AudioCommentRepository>(
        () => _i158.AudioCommentRepositoryImpl(
              remoteDataSource: gh<_i64.AudioCommentRemoteDataSource>(),
              localDataSource: gh<_i63.AudioCommentLocalDataSource>(),
              networkStateManager: gh<_i29.NetworkStateManager>(),
              backgroundSyncCoordinator: gh<_i143.BackgroundSyncCoordinator>(),
              pendingOperationsManager: gh<_i84.PendingOperationsManager>(),
            ));
    ...
    gh.factory<_i171.MagicLinkBloc>(() => _i171.MagicLinkBloc(
          generateMagicLink: gh<_i116.GenerateMagicLinkUseCase>(),
    ...
    gh.factory<_i172.PlayAudioUseCase>(() => _i172.PlayAudioUseCase(
          ...
          audioStorageRepository: gh<_i101.AudioStorageRepository>(),
          playbackService: gh<_i3.AudioPlaybackService>(),
        ));
    ...
    gh.factory<_i180.SessionCleanupService>(() => _i180.SessionCleanupService(
          userProfileRepository: gh<_i151.UserProfileRepository>(),
          projectsRepository: gh<_i146.ProjectsRepository>(),
          audioTrackRepository: gh<_i159.AudioTrackRepository>(),
          audioCommentRepository: gh<_i157.AudioCommentRepository>(),
          invitationRepository: gh<_i77.InvitationRepository>(),
    ...
    gh.factory<_i181.SessionService>(() => _i181.SessionService(
          checkAuthUseCase: gh<_i114.CheckAuthenticationStatusUseCase>(),
          getCurrentUserUseCase: gh<_i119.GetCurrentUserUseCase>(),
          onboardingUseCase: gh<_i127.OnboardingUseCase>(),
          profileUseCase: gh<_i162.CheckProfileCompletenessUseCase>(),
        ));
    gh.lazySingleton<_i182.SignInUseCase>(() => _i182.SignInUseCase(
          gh<_i106.AuthRepository>(),
          gh<_i151.UserProfileRepository>(),
        ));
    gh.lazySingleton<_i183.SignOutUseCase>(() => _i183.SignOutUseCase(
          gh<_i106.AuthRepository>(),
          gh<_i180.SessionCleanupService>(),
        ));
    gh.factory<_i184.UpdateUserProfileUseCase>(
        () => _i184.UpdateUserProfileUseCase(
              gh<_i151.UserProfileRepository>(),
              gh<_i88.SessionStorage>(),
            ));
    gh.lazySingleton<_i185.UploadAudioTrackUseCase>(
        () => _i185.UploadAudioTrackUseCase(
              gh<_i176.ProjectTrackService>(),
              gh<_i146.ProjectsRepository>(),
              gh<_i88.SessionStorage>(),
            ));
    gh.factory<_i186.UserProfileBloc>(() => _i186.UserProfileBloc(
          updateUserProfileUseCase: gh<_i184.UpdateUserProfileUseCase>(),
    ...
    gh.lazySingleton<_i187.WatchCommentsByTrackUseCase>(() =>
        _i187.WatchCommentsByTrackUseCase(gh<_i175.ProjectCommentService>()));
    gh.lazySingleton<_i188.WatchTracksByProjectIdUseCase>(() =>
        _i188.WatchTracksByProjectIdUseCase(gh<_i159.AudioTrackRepository>()));
    gh.lazySingleton<_i189.AddAudioCommentUseCase>(
        () => _i189.AddAudioCommentUseCase(
              gh<_i175.ProjectCommentService>(),
              gh<_i146.ProjectsRepository>(),
              gh<_i88.SessionStorage>(),
            ));
    gh.lazySingleton<_i190.AddCollaboratorByEmailUseCase>(
        () => _i190.AddCollaboratorByEmailUseCase(
              gh<_i166.FindUserByEmailUseCase>(),
              gh<_i156.AddCollaboratorToProjectUseCase>(),
              gh<_i34.NotificationService>(),
            ));
    gh.factory<_i191.AppBootstrap>(() => _i191.AppBootstrap(
          ...
          databaseHealthMonitor: gh<_i71.DatabaseHealthMonitor>(),
        ));
    gh.factory<_i192.AppFlowBloc>(() => _i192.AppFlowBloc(
          appBootstrap: gh<_i191.AppBootstrap>(),
          backgroundSyncCoordinator: gh<_i143.BackgroundSyncCoordinator>(),
          getAuthStateUseCase: gh<_i117.GetAuthStateUseCase>(),
          sessionCleanupService: gh<_i180.SessionCleanupService>(),
        ));
    gh.lazySingleton<_i193.AudioContextService>(
        () => _i194.AudioContextServiceImpl(
              userProfileRepository: gh<_i151.UserProfileRepository>(),
              audioTrackRepository: gh<_i159.AudioTrackRepository>(),
              projectsRepository: gh<_i146.ProjectsRepository>(),
            ));
    gh.factory<_i195.AudioPlayerService>(() => _i195.AudioPlayerService(
    ...
    gh.factory<_i196.AuthBloc>(() => _i196.AuthBloc(
          signIn: gh<_i182.SignInUseCase>(),
          signUp: gh<_i132.SignUpUseCase>(),
          googleSignIn: gh<_i168.GoogleSignInUseCase>(),
          signOut: gh<_i183.SignOutUseCase>(),
        ));
    gh.lazySingleton<_i197.DeleteAudioCommentUseCase>(
        () => _i197.DeleteAudioCommentUseCase(
              gh<_i175.ProjectCommentService>(),
              gh<_i146.ProjectsRepository>(),
              gh<_i88.SessionStorage>(),
            ));
    gh.lazySingleton<_i198.DeleteAudioTrack>(() => _i198.DeleteAudioTrack(
          gh<_i88.SessionStorage>(),
          gh<_i146.ProjectsRepository>(),
          gh<_i176.ProjectTrackService>(),
        ));
    gh.lazySingleton<_i199.EditAudioTrackUseCase>(
        () => _i199.EditAudioTrackUseCase(
              gh<_i176.ProjectTrackService>(),
              gh<_i146.ProjectsRepository>(),
            ));
    gh.factory<_i200.LoadTrackContextUseCase>(
        () => _i200.LoadTrackContextUseCase(gh<_i193.AudioContextService>()));
    gh.factory<_i201.ManageCollaboratorsBloc>(() =>
        _i201.ManageCollaboratorsBloc(
          ...
          watchUserProfilesUseCase: gh<_i97.WatchUserProfilesUseCase>(),
          findUserByEmailUseCase: gh<_i166.FindUserByEmailUseCase>(),
          addCollaboratorByEmailUseCase:
              gh<_i190.AddCollaboratorByEmailUseCase>(),
        ));
    gh.factory<_i202.ProjectInvitationActorBloc>(
        () => _i202.ProjectInvitationActorBloc(
              ...
              cancelInvitationUseCase: gh<_i113.CancelInvitationUseCase>(),
              findUserByEmailUseCase: gh<_i166.FindUserByEmailUseCase>(),
            ));
    gh.factory<_i203.AudioCommentBloc>(() => _i203.AudioCommentBloc(
          watchCommentsByTrackUseCase: gh<_i187.WatchCommentsByTrackUseCase>(),
          addAudioCommentUseCase: gh<_i189.AddAudioCommentUseCase>(),
          deleteAudioCommentUseCase: gh<_i197.DeleteAudioCommentUseCase>(),
          watchUserProfilesUseCase: gh<_i97.WatchUserProfilesUseCase>(),
        ));
    gh.factory<_i204.AudioContextBloc>(() => _i204.AudioContextBloc(
        loadTrackContextUseCase: gh<_i200.LoadTrackContextUseCase>()));
    gh.factory<_i205.AudioPlayerBloc>(() => _i205.AudioPlayerBloc(
        audioPlayerService: gh<_i195.AudioPlayerService>()));
    gh.factory<_i206.AudioTrackBloc>(() => _i206.AudioTrackBloc(
          watchAudioTracksByProject: gh<_i188.WatchTracksByProjectIdUseCase>(),
          deleteAudioTrack: gh<_i198.DeleteAudioTrack>(),
          uploadAudioTrackUseCase: gh<_i185.UploadAudioTrackUseCase>(),
          editAudioTrackUseCase: gh<_i199.EditAudioTrackUseCase>(),
        ));
    return this;
  }
}
