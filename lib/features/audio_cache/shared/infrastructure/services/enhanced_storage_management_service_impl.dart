...
// Supporting classes that would need to be defined
...
// Other supporting classes would be defined similarly...
class CorruptionCleanupResult {
...
class AutoCleanupPolicy {
  static const conservative = AutoCleanupPolicy._('conservative');
  static const aggressive = AutoCleanupPolicy._('aggressive');
  static const disabled = AutoCleanupPolicy._('disabled');

  final String _value;
  const AutoCleanupPolicy._(this._value);
...
class CacheSearchCriteria {
  // Would define search criteria
}

class CacheRemovalCandidate {
  // Would define removal candidate structure
}

class CacheFilterOptions {
  // Would define filter options
}